...
test "L_Ui_C: Zig passes to C" {
    ...
    try testing.expectEqual(c.assert_L_Ui_C(.{ .v1 = 22229, .v2 = 18392, .v3 = 0 }), 3);
...
test "L_Ui_I: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_L_Ui_I(.{ .v1 = 18807, .v2 = 29443, .v3 = 0 }), 3);
...
test "L_Ui_L: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_L_Ui_L(.{ .v1 = 30784, .v2 = 20862, .v3 = 0 }), 3);
...
test "L_Ui_S: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_L_Ui_S(.{ .v1 = 854, .v2 = 17586, .v3 = 0 }), 3);
...
test "L_Ui_Uc: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_L_Ui_Uc(.{ .v1 = 3456, .v2 = 23186, .v3 = 0 }), 3);
...
test "L_Ui_Ui: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_L_Ui_Ui(.{ .v1 = 32273, .v2 = 8038, .v3 = 0 }), 3);
...
test "L_Ui_Ul: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_L_Ui_Ul(.{ .v1 = 8766, .v2 = 5102, .v3 = 0 }), 3);
...
test "L_Ui_Us: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_L_Ui_Us(.{ .v1 = 9990, .v2 = 27090, .v3 = 0 }), 3);
...
test "L_Ul: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_L_Ul(.{ .v1 = 17256, .v2 = 0 }), 2);
...
test "L_Ul_C: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_L_Ul_C(.{ .v1 = 11968, .v2 = 8997, .v3 = 0 }), 3);
...
test "L_Ul_I: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_L_Ul_I(.{ .v1 = 21587, .v2 = 3617, .v3 = 0 }), 3);
...
test "L_Ul_L: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_L_Ul_L(.{ .v1 = 29152, .v2 = 21630, .v3 = 0 }), 3);
...
test "L_Ul_S: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_L_Ul_S(.{ .v1 = 9311, .v2 = 669, .v3 = 0 }), 3);
...
test "L_Ul_Uc: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_L_Ul_Uc(.{ .v1 = 23049, .v2 = 12157, .v3 = 0 }), 3);
...
test "L_Ul_Ui: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_L_Ul_Ui(.{ .v1 = 20457, .v2 = 8644, .v3 = 0 }), 3);
...
test "L_Ul_Ul: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_L_Ul_Ul(.{ .v1 = 18808, .v2 = 30770, .v3 = 0 }), 3);
...
test "L_Ul_Us: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_L_Ul_Us(.{ .v1 = 19157, .v2 = 2550, .v3 = 0 }), 3);
...
test "L_Us: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_L_Us(.{ .v1 = 5907, .v2 = 0 }), 2);
...
test "L_Us_C: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_L_Us_C(.{ .v1 = 28519, .v2 = 1409, .v3 = 0 }), 3);
...
test "L_Us_I: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_L_Us_I(.{ .v1 = 29179, .v2 = 29384, .v3 = 0 }), 3);
...
test "L_Us_L: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_L_Us_L(.{ .v1 = 16528, .v2 = 20020, .v3 = 0 }), 3);
...
test "L_Us_S: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_L_Us_S(.{ .v1 = 23024, .v2 = 26739, .v3 = 0 }), 3);
...
test "L_Us_Uc: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_L_Us_Uc(.{ .v1 = 8423, .v2 = 26054, .v3 = 0 }), 3);
...
test "L_Us_Ui: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_L_Us_Ui(.{ .v1 = 8434, .v2 = 21731, .v3 = 0 }), 3);
...
test "L_Us_Ul: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_L_Us_Ul(.{ .v1 = 28279, .v2 = 29535, .v3 = 0 }), 3);
...
test "L_Us_Us: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_L_Us_Us(.{ .v1 = 2582, .v2 = 26820, .v3 = 0 }), 3);
...
test "L_Vp_C: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_L_Vp_C(.{ .v1 = 18374, .v2 = null, .v3 = 0 }), 3);
...
test "L_Vp_I: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_L_Vp_I(.{ .v1 = 7437, .v2 = null, .v3 = 0 }), 3);
...
test "L_Vp_L: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_L_Vp_L(.{ .v1 = 26762, .v2 = null, .v3 = 0 }), 3);
...
test "L_Vp_S: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_L_Vp_S(.{ .v1 = 32517, .v2 = null, .v3 = 0 }), 3);
...
test "L_Vp_Uc: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_L_Vp_Uc(.{ .v1 = 20175, .v2 = null, .v3 = 0 }), 3);
...
test "L_Vp_Ui: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_L_Vp_Ui(.{ .v1 = 9705, .v2 = null, .v3 = 0 }), 3);
...
test "L_Vp_Ul: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_L_Vp_Ul(.{ .v1 = 2235, .v2 = null, .v3 = 0 }), 3);
...
test "L_Vp_Us: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_L_Vp_Us(.{ .v1 = 24213, .v2 = null, .v3 = 0 }), 3);
...
test "S: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S(.{ .v1 = 0 }), 1);
...
test "S_C: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_C(.{ .v1 = 13593, .v2 = 0 }), 2);
...
test "S_C_C: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_C_C(.{ .v1 = 2444, .v2 = 93, .v3 = 0 }), 3);
...
test "S_C_I: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_C_I(.{ .v1 = 18200, .v2 = 26, .v3 = 0 }), 3);
...
test "S_C_L: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_C_L(.{ .v1 = 23527, .v2 = 35, .v3 = 0 }), 3);
...
test "S_C_S: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_C_S(.{ .v1 = 18343, .v2 = 109, .v3 = 0 }), 3);
...
test "S_C_Uc: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_C_Uc(.{ .v1 = 14516, .v2 = 18, .v3 = 0 }), 3);
...
test "S_C_Ui: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_C_Ui(.{ .v1 = 17804, .v2 = 18, .v3 = 0 }), 3);
...
test "S_C_Ul: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_C_Ul(.{ .v1 = 24230, .v2 = 27, .v3 = 0 }), 3);
...
test "S_C_Us: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_C_Us(.{ .v1 = 13745, .v2 = 61, .v3 = 0 }), 3);
...
test "S_D_C: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_D_C(.{ .v1 = 24907, .v2 = 7.0, .v3 = 0 }), 3);
...
test "S_D_I: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_D_I(.{ .v1 = 8248, .v2 = -2.125, .v3 = 0 }), 3);
...
test "S_D_L: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_D_L(.{ .v1 = 16019, .v2 = 4.5, .v3 = 0 }), 3);
...
test "S_D_S: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_D_S(.{ .v1 = 19770, .v2 = 0.875, .v3 = 0 }), 3);
...
test "S_D_Uc: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_D_Uc(.{ .v1 = 18628, .v2 = -2.125, .v3 = 0 }), 3);
...
test "S_D_Ui: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_D_Ui(.{ .v1 = 2017, .v2 = 4.5, .v3 = 0 }), 3);
...
test "S_D_Ul: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_D_Ul(.{ .v1 = 26647, .v2 = 7.0, .v3 = 0 }), 3);
...
test "S_D_Us: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_D_Us(.{ .v1 = 10915, .v2 = -0.25, .v3 = 0 }), 3);
...
test "S_F_C: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_F_C(.{ .v1 = 8723, .v2 = -0.25, .v3 = 0 }), 3);
...
test "S_F_I: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_F_I(.{ .v1 = 21641, .v2 = 1.0, .v3 = 0 }), 3);
...
test "S_F_L: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_F_L(.{ .v1 = 29613, .v2 = 7.0, .v3 = 0 }), 3);
...
test "S_F_S: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_F_S(.{ .v1 = 5493, .v2 = 1.0, .v3 = 0 }), 3);
...
test "S_F_Uc: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_F_Uc(.{ .v1 = 16127, .v2 = 0.5, .v3 = 0 }), 3);
...
test "S_F_Ui: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_F_Ui(.{ .v1 = 24945, .v2 = 7.0, .v3 = 0 }), 3);
...
test "S_F_Ul: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_F_Ul(.{ .v1 = 6677, .v2 = 0.875, .v3 = 0 }), 3);
...
test "S_F_Us: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_F_Us(.{ .v1 = 8511, .v2 = 0.5, .v3 = 0 }), 3);
...
test "S_I: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_I(.{ .v1 = 2897, .v2 = 0 }), 2);
...
test "S_I_C: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_I_C(.{ .v1 = 8966, .v2 = 235, .v3 = 0 }), 3);
...
test "S_I_I: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_I_I(.{ .v1 = 5966, .v2 = 11791, .v3 = 0 }), 3);
...
test "S_I_L: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_I_L(.{ .v1 = 9496, .v2 = 6304, .v3 = 0 }), 3);
...
test "S_I_S: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_I_S(.{ .v1 = 5209, .v2 = 18809, .v3 = 0 }), 3);
...
test "S_I_Uc: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_I_Uc(.{ .v1 = 14755, .v2 = 22762, .v3 = 0 }), 3);
...
test "S_I_Ui: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_I_Ui(.{ .v1 = 28377, .v2 = 8192, .v3 = 0 }), 3);
...
test "S_I_Ul: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_I_Ul(.{ .v1 = 24955, .v2 = 2544, .v3 = 0 }), 3);
...
test "S_I_Us: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_I_Us(.{ .v1 = 26409, .v2 = 6684, .v3 = 0 }), 3);
...
test "S_Ip_C: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_Ip_C(.{ .v1 = 13013, .v2 = null, .v3 = 0 }), 3);
...
test "S_Ip_I: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_Ip_I(.{ .v1 = 12399, .v2 = null, .v3 = 0 }), 3);
...
test "S_Ip_L: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_Ip_L(.{ .v1 = 20259, .v2 = null, .v3 = 0 }), 3);
...
test "S_Ip_S: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_Ip_S(.{ .v1 = 14829, .v2 = null, .v3 = 0 }), 3);
...
test "S_Ip_Uc: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_Ip_Uc(.{ .v1 = 6340, .v2 = null, .v3 = 0 }), 3);
...
test "S_Ip_Ui: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_Ip_Ui(.{ .v1 = 11335, .v2 = null, .v3 = 0 }), 3);
...
test "S_Ip_Ul: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_Ip_Ul(.{ .v1 = 8170, .v2 = null, .v3 = 0 }), 3);
...
test "S_Ip_Us: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_Ip_Us(.{ .v1 = 3739, .v2 = null, .v3 = 0 }), 3);
...
test "S_L: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_L(.{ .v1 = 13312, .v2 = 0 }), 2);
...
test "S_L_C: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_L_C(.{ .v1 = 10505, .v2 = 16042, .v3 = 0 }), 3);
...
test "S_L_I: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_L_I(.{ .v1 = 9621, .v2 = 7334, .v3 = 0 }), 3);
...
test "S_L_L: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_L_L(.{ .v1 = 20472, .v2 = 32042, .v3 = 0 }), 3);
...
test "S_L_S: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_L_S(.{ .v1 = 24980, .v2 = 13189, .v3 = 0 }), 3);
...
test "S_L_Uc: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_L_Uc(.{ .v1 = 25895, .v2 = 31666, .v3 = 0 }), 3);
...
test "S_L_Ui: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_L_Ui(.{ .v1 = 25332, .v2 = 32427, .v3 = 0 }), 3);
...
test "S_L_Ul: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_L_Ul(.{ .v1 = 13547, .v2 = 22029, .v3 = 0 }), 3);
...
test "S_L_Us: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_L_Us(.{ .v1 = 20443, .v2 = 12563, .v3 = 0 }), 3);
...
test "S_S: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_S(.{ .v1 = 11096, .v2 = 0 }), 2);
...
test "S_S_C: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_S_C(.{ .v1 = 5329, .v2 = 19856, .v3 = 0 }), 3);
...
test "S_S_I: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_S_I(.{ .v1 = 21322, .v2 = 10630, .v3 = 0 }), 3);
...
test "S_S_L: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_S_L(.{ .v1 = 11004, .v2 = 11972, .v3 = 0 }), 3);
...
test "S_S_S: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_S_S(.{ .v1 = 704, .v2 = 11304, .v3 = 0 }), 3);
...
test "S_S_Uc: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_S_Uc(.{ .v1 = 10132, .v2 = 23348, .v3 = 0 }), 3);
...
test "S_S_Ui: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_S_Ui(.{ .v1 = 10920, .v2 = 21755, .v3 = 0 }), 3);
...
test "S_S_Ul: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_S_Ul(.{ .v1 = 634, .v2 = 947, .v3 = 0 }), 3);
...
test "S_S_Us: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_S_Us(.{ .v1 = 236, .v2 = 22850, .v3 = 0 }), 3);
...
test "S_Uc: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_Uc(.{ .v1 = 3861, .v2 = 0 }), 2);
...
test "S_Uc_C: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_Uc_C(.{ .v1 = 10425, .v2 = 80, .v3 = 0 }), 3);
...
test "S_Uc_I: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_Uc_I(.{ .v1 = 17362, .v2 = 100, .v3 = 0 }), 3);
...
test "S_Uc_L: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_Uc_L(.{ .v1 = 32250, .v2 = 63, .v3 = 0 }), 3);
...
test "S_Uc_S: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_Uc_S(.{ .v1 = 24741, .v2 = 1, .v3 = 0 }), 3);
...
test "S_Uc_Uc: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_Uc_Uc(.{ .v1 = 10761, .v2 = 91, .v3 = 0 }), 3);
...
test "S_Uc_Ui: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_Uc_Ui(.{ .v1 = 20164, .v2 = 73, .v3 = 0 }), 3);
...
test "S_Uc_Ul: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_Uc_Ul(.{ .v1 = 26412, .v2 = 74, .v3 = 0 }), 3);
...
test "S_Uc_Us: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_Uc_Us(.{ .v1 = 29060, .v2 = 68, .v3 = 0 }), 3);
...
test "S_Ui: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_Ui(.{ .v1 = 22316, .v2 = 0 }), 2);
...
test "S_Ui_C: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_Ui_C(.{ .v1 = 27010, .v2 = 4867, .v3 = 0 }), 3);
...
test "S_Ui_I: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_Ui_I(.{ .v1 = 14762, .v2 = 27633, .v3 = 0 }), 3);
...
test "S_Ui_L: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_Ui_L(.{ .v1 = 25625, .v2 = 21589, .v3 = 0 }), 3);
...
test "S_Ui_S: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_Ui_S(.{ .v1 = 29152, .v2 = 15405, .v3 = 0 }), 3);
...
test "S_Ui_Uc: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_Ui_Uc(.{ .v1 = 16333, .v2 = 28670, .v3 = 0 }), 3);
...
test "S_Ui_Ui: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_Ui_Ui(.{ .v1 = 22899, .v2 = 29265, .v3 = 0 }), 3);
...
test "S_Ui_Ul: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_Ui_Ul(.{ .v1 = 4262, .v2 = 10146, .v3 = 0 }), 3);
...
test "S_Ui_Us: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_Ui_Us(.{ .v1 = 14948, .v2 = 19472, .v3 = 0 }), 3);
...
test "S_Ul: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_Ul(.{ .v1 = 23494, .v2 = 0 }), 2);
...
test "S_Ul_C: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_Ul_C(.{ .v1 = 8646, .v2 = 19716, .v3 = 0 }), 3);
...
test "S_Ul_I: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_Ul_I(.{ .v1 = 11746, .v2 = 13702, .v3 = 0 }), 3);
...
test "S_Ul_L: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_Ul_L(.{ .v1 = 27882, .v2 = 18288, .v3 = 0 }), 3);
...
test "S_Ul_S: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_Ul_S(.{ .v1 = 32530, .v2 = 29265, .v3 = 0 }), 3);
...
test "S_Ul_Uc: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_Ul_Uc(.{ .v1 = 6982, .v2 = 10576, .v3 = 0 }), 3);
...
test "S_Ul_Ui: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_Ul_Ui(.{ .v1 = 30721, .v2 = 4703, .v3 = 0 }), 3);
...
test "S_Ul_Ul: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_Ul_Ul(.{ .v1 = 17537, .v2 = 32132, .v3 = 0 }), 3);
...
test "S_Ul_Us: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_Ul_Us(.{ .v1 = 10662, .v2 = 30069, .v3 = 0 }), 3);
...
test "S_Us: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_Us(.{ .v1 = 13811, .v2 = 0 }), 2);
...
test "S_Us_C: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_Us_C(.{ .v1 = 31159, .v2 = 23983, .v3 = 0 }), 3);
...
test "S_Us_I: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_Us_I(.{ .v1 = 15784, .v2 = 1905, .v3 = 0 }), 3);
...
test "S_Us_L: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_Us_L(.{ .v1 = 27652, .v2 = 8858, .v3 = 0 }), 3);
...
test "S_Us_S: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_Us_S(.{ .v1 = 264, .v2 = 9355, .v3 = 0 }), 3);
...
test "S_Us_Uc: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_Us_Uc(.{ .v1 = 15177, .v2 = 27331, .v3 = 0 }), 3);
...
test "S_Us_Ui: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_Us_Ui(.{ .v1 = 3392, .v2 = 15735, .v3 = 0 }), 3);
...
test "S_Us_Ul: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_Us_Ul(.{ .v1 = 3461, .v2 = 17416, .v3 = 0 }), 3);
...
test "S_Us_Us: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_Us_Us(.{ .v1 = 32304, .v2 = 27609, .v3 = 0 }), 3);
...
test "S_Vp_C: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_Vp_C(.{ .v1 = 25479, .v2 = null, .v3 = 0 }), 3);
...
test "S_Vp_I: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_Vp_I(.{ .v1 = 26287, .v2 = null, .v3 = 0 }), 3);
...
test "S_Vp_L: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_Vp_L(.{ .v1 = 26484, .v2 = null, .v3 = 0 }), 3);
...
test "S_Vp_S: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_Vp_S(.{ .v1 = 12233, .v2 = null, .v3 = 0 }), 3);
...
test "S_Vp_Uc: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_Vp_Uc(.{ .v1 = 9581, .v2 = null, .v3 = 0 }), 3);
...
test "S_Vp_Ui: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_Vp_Ui(.{ .v1 = 9149, .v2 = null, .v3 = 0 }), 3);
...
test "S_Vp_Ul: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_Vp_Ul(.{ .v1 = 32074, .v2 = null, .v3 = 0 }), 3);
...
test "S_Vp_Us: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_S_Vp_Us(.{ .v1 = 4352, .v2 = null, .v3 = 0 }), 3);
...
test "Uc: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_Uc(.{ .v1 = 0 }), 1);
...
test "Uc_C: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_Uc_C(.{ .v1 = 120, .v2 = 0 }), 2);
...
test "Uc_C_C: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_Uc_C_C(.{ .v1 = 46, .v2 = 6, .v3 = 0 }), 3);
...
test "Uc_C_I: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_Uc_C_I(.{ .v1 = 6, .v2 = 59, .v3 = 0 }), 3);
...
test "Uc_C_L: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_Uc_C_L(.{ .v1 = 99, .v2 = 14, .v3 = 0 }), 3);
...
test "Uc_C_S: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_Uc_C_S(.{ .v1 = 114, .v2 = 99, .v3 = 0 }), 3);
...
test "Uc_C_Uc: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_Uc_C_Uc(.{ .v1 = 50, .v2 = 55, .v3 = 0 }), 3);
...
test "Uc_C_Ui: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_Uc_C_Ui(.{ .v1 = 125, .v2 = 48, .v3 = 0 }), 3);
...
test "Uc_C_Ul: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_Uc_C_Ul(.{ .v1 = 1, .v2 = 86, .v3 = 0 }), 3);
...
test "Uc_C_Us: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    try testing.expectEqual(c.assert_Uc_C_Us(.{ .v1 = 59, .v2 = 21, .v3 = 0 }), 3);
