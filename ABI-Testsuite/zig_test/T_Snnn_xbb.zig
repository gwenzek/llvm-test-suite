...
test "Ul_C: Zig passes to C" {
    ...
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_C(.{ .v1 = 17226, .v2 = 3 }), outcome);
}
...
test "Ul_C: C passes to Zig" {
    ...
    try testing.expectOutcome(c.send_Ul_C(), outcome);
}
...
test "Ul_C_C: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_C_C(.{ .v1 = 31250, .v2 = 54, .v3 = 2 }), outcome);
}
...
test "Ul_C_C: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_C_C(), outcome);
}
...
test "Ul_C_D: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_C_D(.{ .v1 = 32764, .v2 = 48, .v3 = 7.0 }), outcome);
}
...
test "Ul_C_D: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_C_D(), outcome);
}
...
test "Ul_C_F: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_C_F(.{ .v1 = 26431, .v2 = 0, .v3 = 0.5 }), outcome);
}
...
test "Ul_C_F: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_C_F(), outcome);
}
...
test "Ul_C_I: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_C_I(.{ .v1 = 28045, .v2 = 93, .v3 = 27716 }), outcome);
}
...
test "Ul_C_I: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_C_I(), outcome);
}
...
test "Ul_C_Ip: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_C_Ip(.{ .v1 = 26155, .v2 = 27, .v3 = null }), outcome);
}
...
test "Ul_C_Ip: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_C_Ip(), outcome);
}
...
test "Ul_C_L: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_C_L(.{ .v1 = 12487, .v2 = 95, .v3 = 31393 }), outcome);
}
...
test "Ul_C_L: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_C_L(), outcome);
}
...
test "Ul_C_S: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_C_S(.{ .v1 = 14961, .v2 = 23, .v3 = 31866 }), outcome);
}
...
test "Ul_C_S: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_C_S(), outcome);
}
...
test "Ul_C_Uc: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_C_Uc(.{ .v1 = 20515, .v2 = 44, .v3 = 0 }), outcome);
}
...
test "Ul_C_Uc: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_C_Uc(), outcome);
}
...
test "Ul_C_Ui: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_C_Ui(.{ .v1 = 7205, .v2 = 105, .v3 = 26514 }), outcome);
}
...
test "Ul_C_Ui: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_C_Ui(), outcome);
}
...
test "Ul_C_Ul: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_C_Ul(.{ .v1 = 2127, .v2 = 88, .v3 = 18212 }), outcome);
}
...
test "Ul_C_Ul: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_C_Ul(), outcome);
}
...
test "Ul_C_Us: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_C_Us(.{ .v1 = 6233, .v2 = 70, .v3 = 1747 }), outcome);
}
...
test "Ul_C_Us: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_C_Us(), outcome);
}
...
test "Ul_C_Vp: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_C_Vp(.{ .v1 = 32602, .v2 = 34, .v3 = null }), outcome);
}
...
test "Ul_C_Vp: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_C_Vp(), outcome);
}
...
test "Ul_D: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_D(.{ .v1 = 10715, .v2 = 4.5 }), outcome);
}
...
test "Ul_D: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_D(), outcome);
}
...
test "Ul_D_C: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_D_C(.{ .v1 = 25643, .v2 = 4.5, .v3 = 22 }), outcome);
}
...
test "Ul_D_C: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_D_C(), outcome);
}
...
test "Ul_D_D: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_D_D(.{ .v1 = 621, .v2 = -0.25, .v3 = -0.25 }), outcome);
}
...
test "Ul_D_D: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_D_D(), outcome);
}
...
test "Ul_D_F: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_D_F(.{ .v1 = 11575, .v2 = -2.125, .v3 = -2.125 }), outcome);
}
...
test "Ul_D_F: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_D_F(), outcome);
}
...
test "Ul_D_I: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_D_I(.{ .v1 = 23336, .v2 = -2.125, .v3 = 8615 }), outcome);
}
...
test "Ul_D_I: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_D_I(), outcome);
}
...
test "Ul_D_Ip: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_D_Ip(.{ .v1 = 30759, .v2 = 1.0, .v3 = null }), outcome);
}
...
test "Ul_D_Ip: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_D_Ip(), outcome);
}
...
test "Ul_D_L: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_D_L(.{ .v1 = 16615, .v2 = 7.0, .v3 = 23672 }), outcome);
}
...
test "Ul_D_L: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_D_L(), outcome);
}
...
test "Ul_D_S: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_D_S(.{ .v1 = 6119, .v2 = 1.0, .v3 = 20846 }), outcome);
}
...
test "Ul_D_S: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_D_S(), outcome);
}
...
test "Ul_D_Uc: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_D_Uc(.{ .v1 = 8747, .v2 = -2.125, .v3 = 71 }), outcome);
}
...
test "Ul_D_Uc: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_D_Uc(), outcome);
}
...
test "Ul_D_Ui: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_D_Ui(.{ .v1 = 12376, .v2 = 1.0, .v3 = 7325 }), outcome);
}
...
test "Ul_D_Ui: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_D_Ui(), outcome);
}
...
test "Ul_D_Ul: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_D_Ul(.{ .v1 = 8264, .v2 = 1.0, .v3 = 2350 }), outcome);
}
...
test "Ul_D_Ul: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_D_Ul(), outcome);
}
...
test "Ul_D_Us: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_D_Us(.{ .v1 = 14812, .v2 = 4.5, .v3 = 7431 }), outcome);
}
...
test "Ul_D_Us: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_D_Us(), outcome);
}
...
test "Ul_D_Vp: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_D_Vp(.{ .v1 = 16222, .v2 = 0.5, .v3 = null }), outcome);
}
...
test "Ul_D_Vp: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_D_Vp(), outcome);
}
...
test "Ul_F: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_F(.{ .v1 = 20297, .v2 = 0.5 }), outcome);
}
...
test "Ul_F: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_F(), outcome);
}
...
test "Ul_F_C: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_F_C(.{ .v1 = 5068, .v2 = -0.25, .v3 = 32 }), outcome);
}
...
test "Ul_F_C: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_F_C(), outcome);
}
...
test "Ul_F_D: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_F_D(.{ .v1 = 23787, .v2 = -2.125, .v3 = 0.5 }), outcome);
}
...
test "Ul_F_D: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_F_D(), outcome);
}
...
test "Ul_F_F: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_F_F(.{ .v1 = 4545, .v2 = 1.0, .v3 = 0.875 }), outcome);
}
...
test "Ul_F_F: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_F_F(), outcome);
}
...
test "Ul_F_I: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_F_I(.{ .v1 = 11, .v2 = 1.0, .v3 = 28962 }), outcome);
}
...
test "Ul_F_I: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_F_I(), outcome);
}
...
test "Ul_F_Ip: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_F_Ip(.{ .v1 = 10728, .v2 = 1.0, .v3 = null }), outcome);
}
...
test "Ul_F_Ip: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_F_Ip(), outcome);
}
...
test "Ul_F_L: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_F_L(.{ .v1 = 29862, .v2 = 1.0, .v3 = 30894 }), outcome);
}
...
test "Ul_F_L: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_F_L(), outcome);
}
...
test "Ul_F_S: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_F_S(.{ .v1 = 16621, .v2 = 7.0, .v3 = 19094 }), outcome);
}
...
test "Ul_F_S: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_F_S(), outcome);
}
...
test "Ul_F_Uc: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_F_Uc(.{ .v1 = 5394, .v2 = 7.0, .v3 = 26 }), outcome);
}
...
test "Ul_F_Uc: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_F_Uc(), outcome);
}
...
test "Ul_F_Ui: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_F_Ui(.{ .v1 = 18558, .v2 = 0.875, .v3 = 23737 }), outcome);
}
...
test "Ul_F_Ui: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_F_Ui(), outcome);
}
...
test "Ul_F_Ul: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_F_Ul(.{ .v1 = 19145, .v2 = 0.875, .v3 = 26272 }), outcome);
}
...
test "Ul_F_Ul: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_F_Ul(), outcome);
}
...
test "Ul_F_Us: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_F_Us(.{ .v1 = 12786, .v2 = 4.5, .v3 = 32561 }), outcome);
}
...
test "Ul_F_Us: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_F_Us(), outcome);
}
...
test "Ul_F_Vp: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_F_Vp(.{ .v1 = 8407, .v2 = 1.0, .v3 = null }), outcome);
}
...
test "Ul_F_Vp: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_F_Vp(), outcome);
}
...
test "Ul_I: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_I(.{ .v1 = 9001, .v2 = 14566 }), outcome);
}
...
test "Ul_I: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_I(), outcome);
}
...
test "Ul_I_C: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_I_C(.{ .v1 = 26130, .v2 = 8317, .v3 = 100 }), outcome);
}
...
test "Ul_I_C: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_I_C(), outcome);
}
...
test "Ul_I_D: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_I_D(.{ .v1 = 16377, .v2 = 29653, .v3 = 0.5 }), outcome);
}
...
test "Ul_I_D: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_I_D(), outcome);
}
...
test "Ul_I_F: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_I_F(.{ .v1 = 6558, .v2 = 14172, .v3 = 0.875 }), outcome);
}
...
test "Ul_I_F: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_I_F(), outcome);
}
...
test "Ul_I_I: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_I_I(.{ .v1 = 21186, .v2 = 27875, .v3 = 12292 }), outcome);
}
...
test "Ul_I_I: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_I_I(), outcome);
}
...
test "Ul_I_Ip: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_I_Ip(.{ .v1 = 19268, .v2 = 7953, .v3 = null }), outcome);
}
...
test "Ul_I_Ip: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_I_Ip(), outcome);
}
...
test "Ul_I_L: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_I_L(.{ .v1 = 1812, .v2 = 15113, .v3 = 12160 }), outcome);
}
...
test "Ul_I_L: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_I_L(), outcome);
}
...
test "Ul_I_S: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_I_S(.{ .v1 = 24576, .v2 = 10804, .v3 = 566 }), outcome);
}
...
test "Ul_I_S: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_I_S(), outcome);
}
...
test "Ul_I_Uc: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_I_Uc(.{ .v1 = 4343, .v2 = 4509, .v3 = 97 }), outcome);
}
...
test "Ul_I_Uc: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_I_Uc(), outcome);
}
...
test "Ul_I_Ui: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_I_Ui(.{ .v1 = 22220, .v2 = 2803, .v3 = 31274 }), outcome);
}
...
test "Ul_I_Ui: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_I_Ui(), outcome);
}
...
test "Ul_I_Ul: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_I_Ul(.{ .v1 = 23345, .v2 = 16816, .v3 = 1382 }), outcome);
}
...
test "Ul_I_Ul: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_I_Ul(), outcome);
}
...
test "Ul_I_Us: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_I_Us(.{ .v1 = 26785, .v2 = 19005, .v3 = 25704 }), outcome);
}
...
test "Ul_I_Us: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_I_Us(), outcome);
}
...
test "Ul_I_Vp: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_I_Vp(.{ .v1 = 15755, .v2 = 32345, .v3 = null }), outcome);
}
...
test "Ul_I_Vp: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_I_Vp(), outcome);
}
...
test "Ul_Ip: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_Ip(.{ .v1 = 26902, .v2 = null }), outcome);
}
...
test "Ul_Ip: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_Ip(), outcome);
}
...
test "Ul_Ip_C: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_Ip_C(.{ .v1 = 11062, .v2 = null, .v3 = 31 }), outcome);
}
...
test "Ul_Ip_C: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_Ip_C(), outcome);
}
...
test "Ul_Ip_D: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_Ip_D(.{ .v1 = 3475, .v2 = null, .v3 = 0.875 }), outcome);
}
...
test "Ul_Ip_D: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_Ip_D(), outcome);
}
...
test "Ul_Ip_F: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_Ip_F(.{ .v1 = 6436, .v2 = null, .v3 = 4.5 }), outcome);
}
...
test "Ul_Ip_F: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_Ip_F(), outcome);
}
...
test "Ul_Ip_I: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_Ip_I(.{ .v1 = 9802, .v2 = null, .v3 = 30741 }), outcome);
}
...
test "Ul_Ip_I: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_Ip_I(), outcome);
}
...
test "Ul_Ip_Ip: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_Ip_Ip(.{ .v1 = 1518, .v2 = null, .v3 = null }), outcome);
}
...
test "Ul_Ip_Ip: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_Ip_Ip(), outcome);
}
...
test "Ul_Ip_L: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_Ip_L(.{ .v1 = 31264, .v2 = null, .v3 = 30076 }), outcome);
}
...
test "Ul_Ip_L: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_Ip_L(), outcome);
}
...
test "Ul_Ip_S: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_Ip_S(.{ .v1 = 22879, .v2 = null, .v3 = 23485 }), outcome);
}
...
test "Ul_Ip_S: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_Ip_S(), outcome);
}
...
test "Ul_Ip_Uc: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_Ip_Uc(.{ .v1 = 14255, .v2 = null, .v3 = 118 }), outcome);
}
...
test "Ul_Ip_Uc: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_Ip_Uc(), outcome);
}
...
test "Ul_Ip_Ui: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_Ip_Ui(.{ .v1 = 5959, .v2 = null, .v3 = 12355 }), outcome);
}
...
test "Ul_Ip_Ui: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_Ip_Ui(), outcome);
}
...
test "Ul_Ip_Ul: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_Ip_Ul(.{ .v1 = 8777, .v2 = null, .v3 = 760 }), outcome);
}
...
test "Ul_Ip_Ul: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_Ip_Ul(), outcome);
}
...
test "Ul_Ip_Us: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_Ip_Us(.{ .v1 = 16734, .v2 = null, .v3 = 28745 }), outcome);
}
...
test "Ul_Ip_Us: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_Ip_Us(), outcome);
}
...
test "Ul_Ip_Vp: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_Ip_Vp(.{ .v1 = 21721, .v2 = null, .v3 = null }), outcome);
}
...
test "Ul_Ip_Vp: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_Ip_Vp(), outcome);
}
...
test "Ul_L: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_L(.{ .v1 = 15343, .v2 = 30563 }), outcome);
}
...
test "Ul_L: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_L(), outcome);
}
...
test "Ul_L_C: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_L_C(.{ .v1 = 28130, .v2 = 18916, .v3 = 10 }), outcome);
}
...
test "Ul_L_C: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_L_C(), outcome);
}
...
test "Ul_L_D: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_L_D(.{ .v1 = 13861, .v2 = 9151, .v3 = 0.5 }), outcome);
}
...
test "Ul_L_D: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_L_D(), outcome);
}
...
test "Ul_L_F: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_L_F(.{ .v1 = 22003, .v2 = 10595, .v3 = 7.0 }), outcome);
}
...
test "Ul_L_F: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_L_F(), outcome);
}
...
test "Ul_L_I: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_L_I(.{ .v1 = 24399, .v2 = 7327, .v3 = 24391 }), outcome);
}
...
test "Ul_L_I: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_L_I(), outcome);
}
...
test "Ul_L_Ip: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_L_Ip(.{ .v1 = 29353, .v2 = 291, .v3 = null }), outcome);
}
...
test "Ul_L_Ip: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_L_Ip(), outcome);
}
...
test "Ul_L_L: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_L_L(.{ .v1 = 31991, .v2 = 20178, .v3 = 30846 }), outcome);
}
...
test "Ul_L_L: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_L_L(), outcome);
}
...
test "Ul_L_S: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_L_S(.{ .v1 = 538, .v2 = 31083, .v3 = 25880 }), outcome);
}
...
test "Ul_L_S: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_L_S(), outcome);
}
...
test "Ul_L_Uc: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_L_Uc(.{ .v1 = 28879, .v2 = 7459, .v3 = 12 }), outcome);
}
...
test "Ul_L_Uc: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_L_Uc(), outcome);
}
...
test "Ul_L_Ui: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_L_Ui(.{ .v1 = 26709, .v2 = 19269, .v3 = 24646 }), outcome);
}
...
test "Ul_L_Ui: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_L_Ui(), outcome);
}
...
test "Ul_L_Ul: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_L_Ul(.{ .v1 = 20313, .v2 = 27484, .v3 = 30103 }), outcome);
}
...
test "Ul_L_Ul: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_L_Ul(), outcome);
}
...
test "Ul_L_Us: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_L_Us(.{ .v1 = 5364, .v2 = 21504, .v3 = 1770 }), outcome);
}
...
test "Ul_L_Us: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_L_Us(), outcome);
}
...
test "Ul_L_Vp: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_L_Vp(.{ .v1 = 4315, .v2 = 13921, .v3 = null }), outcome);
}
...
test "Ul_L_Vp: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_L_Vp(), outcome);
}
...
test "Ul_S: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_S(.{ .v1 = 15495, .v2 = 24354 }), outcome);
}
...
test "Ul_S: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_S(), outcome);
}
...
test "Ul_S_C: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_S_C(.{ .v1 = 20311, .v2 = 15701, .v3 = 45 }), outcome);
}
...
test "Ul_S_C: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_S_C(), outcome);
}
...
test "Ul_S_D: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_S_D(.{ .v1 = 2529, .v2 = 28822, .v3 = 0.875 }), outcome);
}
...
test "Ul_S_D: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_S_D(), outcome);
}
...
test "Ul_S_F: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_S_F(.{ .v1 = 17877, .v2 = 24298, .v3 = 0.5 }), outcome);
}
...
test "Ul_S_F: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_S_F(), outcome);
}
...
test "Ul_S_I: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_S_I(.{ .v1 = 19761, .v2 = 8492, .v3 = 4769 }), outcome);
}
...
test "Ul_S_I: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_S_I(), outcome);
}
...
test "Ul_S_Ip: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_S_Ip(.{ .v1 = 21285, .v2 = 6075, .v3 = null }), outcome);
}
...
test "Ul_S_Ip: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_S_Ip(), outcome);
}
...
test "Ul_S_L: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_S_L(.{ .v1 = 4325, .v2 = 4313, .v3 = 14475 }), outcome);
}
...
test "Ul_S_L: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_S_L(), outcome);
}
...
test "Ul_S_S: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_S_S(.{ .v1 = 28758, .v2 = 1479, .v3 = 15299 }), outcome);
}
...
test "Ul_S_S: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_S_S(), outcome);
}
...
test "Ul_S_Uc: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_S_Uc(.{ .v1 = 23482, .v2 = 14404, .v3 = 62 }), outcome);
}
...
test "Ul_S_Uc: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_S_Uc(), outcome);
}
...
test "Ul_S_Ui: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_S_Ui(.{ .v1 = 14460, .v2 = 21505, .v3 = 10097 }), outcome);
}
...
test "Ul_S_Ui: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_S_Ui(), outcome);
}
...
test "Ul_S_Ul: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_S_Ul(.{ .v1 = 1815, .v2 = 29350, .v3 = 3622 }), outcome);
}
...
test "Ul_S_Ul: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_S_Ul(), outcome);
}
...
test "Ul_S_Us: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_S_Us(.{ .v1 = 25777, .v2 = 20180, .v3 = 7276 }), outcome);
}
...
test "Ul_S_Us: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_S_Us(), outcome);
}
...
test "Ul_S_Vp: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_S_Vp(.{ .v1 = 28974, .v2 = 28956, .v3 = null }), outcome);
}
...
test "Ul_S_Vp: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_S_Vp(), outcome);
}
...
test "Ul_Uc: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_Uc(.{ .v1 = 9532, .v2 = 30 }), outcome);
}
...
test "Ul_Uc: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_Uc(), outcome);
}
...
test "Ul_Uc_C: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_Uc_C(.{ .v1 = 28644, .v2 = 23, .v3 = 64 }), outcome);
}
...
test "Ul_Uc_C: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_Uc_C(), outcome);
}
...
test "Ul_Uc_D: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_Uc_D(.{ .v1 = 27342, .v2 = 53, .v3 = 7.0 }), outcome);
}
...
test "Ul_Uc_D: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_Uc_D(), outcome);
}
...
test "Ul_Uc_F: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_Uc_F(.{ .v1 = 357, .v2 = 83, .v3 = 1.0 }), outcome);
}
...
test "Ul_Uc_F: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_Uc_F(), outcome);
}
...
test "Ul_Uc_I: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_Uc_I(.{ .v1 = 9936, .v2 = 95, .v3 = 31107 }), outcome);
}
...
test "Ul_Uc_I: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_Uc_I(), outcome);
}
...
test "Ul_Uc_Ip: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_Uc_Ip(.{ .v1 = 28094, .v2 = 9, .v3 = null }), outcome);
}
...
test "Ul_Uc_Ip: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_Uc_Ip(), outcome);
}
...
test "Ul_Uc_L: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_Uc_L(.{ .v1 = 15634, .v2 = 17, .v3 = 1241 }), outcome);
}
...
test "Ul_Uc_L: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_Uc_L(), outcome);
}
...
test "Ul_Uc_S: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_Uc_S(.{ .v1 = 30415, .v2 = 26, .v3 = 12477 }), outcome);
}
...
test "Ul_Uc_S: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_Uc_S(), outcome);
}
...
test "Ul_Uc_Uc: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_Uc_Uc(.{ .v1 = 17391, .v2 = 91, .v3 = 22 }), outcome);
}
...
test "Ul_Uc_Uc: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_Uc_Uc(), outcome);
}
...
test "Ul_Uc_Ui: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_Uc_Ui(.{ .v1 = 20042, .v2 = 52, .v3 = 19522 }), outcome);
}
...
test "Ul_Uc_Ui: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_Uc_Ui(), outcome);
}
...
test "Ul_Uc_Ul: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_Uc_Ul(.{ .v1 = 18223, .v2 = 65, .v3 = 26245 }), outcome);
}
...
test "Ul_Uc_Ul: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_Uc_Ul(), outcome);
}
...
test "Ul_Uc_Us: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_Uc_Us(.{ .v1 = 13507, .v2 = 81, .v3 = 16987 }), outcome);
}
...
test "Ul_Uc_Us: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_Uc_Us(), outcome);
}
...
test "Ul_Uc_Vp: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_Uc_Vp(.{ .v1 = 4951, .v2 = 65, .v3 = null }), outcome);
}
...
test "Ul_Uc_Vp: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_Uc_Vp(), outcome);
}
...
test "Ul_Ui: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_Ui(.{ .v1 = 7789, .v2 = 28185 }), outcome);
}
...
test "Ul_Ui: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_Ui(), outcome);
}
...
test "Ul_Ui_C: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_Ui_C(.{ .v1 = 3948, .v2 = 28420, .v3 = 79 }), outcome);
}
...
test "Ul_Ui_C: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_Ui_C(), outcome);
}
...
test "Ul_Ui_D: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_Ui_D(.{ .v1 = 1908, .v2 = 4685, .v3 = 7.0 }), outcome);
}
...
test "Ul_Ui_D: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_Ui_D(), outcome);
}
...
test "Ul_Ui_F: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_Ui_F(.{ .v1 = 24351, .v2 = 12662, .v3 = 4.5 }), outcome);
}
...
test "Ul_Ui_F: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_Ui_F(), outcome);
}
...
test "Ul_Ui_I: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_Ui_I(.{ .v1 = 2857, .v2 = 5187, .v3 = 24559 }), outcome);
}
...
test "Ul_Ui_I: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_Ui_I(), outcome);
}
...
test "Ul_Ui_Ip: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_Ui_Ip(.{ .v1 = 2720, .v2 = 966, .v3 = null }), outcome);
}
...
test "Ul_Ui_Ip: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_Ui_Ip(), outcome);
}
...
test "Ul_Ui_L: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_Ui_L(.{ .v1 = 6968, .v2 = 31951, .v3 = 7933 }), outcome);
}
...
test "Ul_Ui_L: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_Ui_L(), outcome);
}
...
test "Ul_Ui_S: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_Ui_S(.{ .v1 = 28303, .v2 = 27593, .v3 = 32181 }), outcome);
}
...
test "Ul_Ui_S: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_Ui_S(), outcome);
}
...
test "Ul_Ui_Uc: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_Ui_Uc(.{ .v1 = 2033, .v2 = 2860, .v3 = 81 }), outcome);
}
...
test "Ul_Ui_Uc: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_Ui_Uc(), outcome);
}
...
test "Ul_Ui_Ui: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_Ui_Ui(.{ .v1 = 3618, .v2 = 21646, .v3 = 30807 }), outcome);
}
...
test "Ul_Ui_Ui: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_Ui_Ui(), outcome);
}
...
test "Ul_Ui_Ul: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_Ui_Ul(.{ .v1 = 20561, .v2 = 27761, .v3 = 14975 }), outcome);
}
...
test "Ul_Ui_Ul: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_Ui_Ul(), outcome);
}
...
test "Ul_Ui_Us: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_Ui_Us(.{ .v1 = 32483, .v2 = 13395, .v3 = 8916 }), outcome);
}
...
test "Ul_Ui_Us: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_Ui_Us(), outcome);
}
...
test "Ul_Ui_Vp: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_Ui_Vp(.{ .v1 = 21478, .v2 = 4637, .v3 = null }), outcome);
}
...
test "Ul_Ui_Vp: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_Ui_Vp(), outcome);
}
...
test "Ul_Ul: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_Ul(.{ .v1 = 21329, .v2 = 8885 }), outcome);
}
...
test "Ul_Ul: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_Ul(), outcome);
}
...
test "Ul_Ul_C: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_Ul_C(.{ .v1 = 24860, .v2 = 9133, .v3 = 90 }), outcome);
}
...
test "Ul_Ul_C: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_Ul_C(), outcome);
}
...
test "Ul_Ul_D: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_Ul_D(.{ .v1 = 16601, .v2 = 13026, .v3 = -0.25 }), outcome);
}
...
test "Ul_Ul_D: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_Ul_D(), outcome);
}
...
test "Ul_Ul_F: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_Ul_F(.{ .v1 = 30369, .v2 = 8873, .v3 = -0.25 }), outcome);
}
...
test "Ul_Ul_F: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_Ul_F(), outcome);
}
...
test "Ul_Ul_I: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_Ul_I(.{ .v1 = 12703, .v2 = 15563, .v3 = 26532 }), outcome);
}
...
test "Ul_Ul_I: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_Ul_I(), outcome);
}
...
test "Ul_Ul_Ip: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_Ul_Ip(.{ .v1 = 18635, .v2 = 1782, .v3 = null }), outcome);
}
...
test "Ul_Ul_Ip: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_Ul_Ip(), outcome);
}
...
test "Ul_Ul_L: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_Ul_L(.{ .v1 = 4753, .v2 = 14056, .v3 = 2292 }), outcome);
}
...
test "Ul_Ul_L: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_Ul_L(), outcome);
}
...
test "Ul_Ul_S: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_Ul_S(.{ .v1 = 13277, .v2 = 14126, .v3 = 24506 }), outcome);
}
...
test "Ul_Ul_S: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_Ul_S(), outcome);
}
...
test "Ul_Ul_Uc: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_Ul_Uc(.{ .v1 = 28837, .v2 = 22666, .v3 = 112 }), outcome);
}
...
test "Ul_Ul_Uc: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_Ul_Uc(), outcome);
}
...
test "Ul_Ul_Ui: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_Ul_Ui(.{ .v1 = 1478, .v2 = 21614, .v3 = 19239 }), outcome);
}
...
test "Ul_Ul_Ui: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_Ul_Ui(), outcome);
}
...
test "Ul_Ul_Ul: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_Ul_Ul(.{ .v1 = 3139, .v2 = 24472, .v3 = 2247 }), outcome);
}
...
test "Ul_Ul_Ul: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_Ul_Ul(), outcome);
}
...
test "Ul_Ul_Us: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_Ul_Us(.{ .v1 = 27076, .v2 = 8474, .v3 = 9430 }), outcome);
}
...
test "Ul_Ul_Us: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_Ul_Us(), outcome);
}
...
test "Ul_Ul_Vp: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_Ul_Vp(.{ .v1 = 7942, .v2 = 18058, .v3 = null }), outcome);
}
...
test "Ul_Ul_Vp: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_Ul_Vp(), outcome);
}
...
test "Ul_Us: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_Us(.{ .v1 = 2643, .v2 = 28366 }), outcome);
}
...
test "Ul_Us: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_Us(), outcome);
}
...
test "Ul_Us_C: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_Us_C(.{ .v1 = 3725, .v2 = 2617, .v3 = 120 }), outcome);
}
...
test "Ul_Us_C: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_Us_C(), outcome);
}
...
test "Ul_Us_D: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_Us_D(.{ .v1 = 18843, .v2 = 22623, .v3 = 0.875 }), outcome);
}
...
test "Ul_Us_D: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_Us_D(), outcome);
}
...
test "Ul_Us_F: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_Us_F(.{ .v1 = 28743, .v2 = 16957, .v3 = 1.0 }), outcome);
}
...
test "Ul_Us_F: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_Us_F(), outcome);
}
...
test "Ul_Us_I: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_Us_I(.{ .v1 = 740, .v2 = 5377, .v3 = 29762 }), outcome);
}
...
test "Ul_Us_I: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_Us_I(), outcome);
}
...
test "Ul_Us_Ip: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_Us_Ip(.{ .v1 = 3105, .v2 = 17049, .v3 = null }), outcome);
}
...
test "Ul_Us_Ip: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_Us_Ip(), outcome);
}
...
test "Ul_Us_L: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_Us_L(.{ .v1 = 26785, .v2 = 14066, .v3 = 4067 }), outcome);
}
...
test "Ul_Us_L: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_Us_L(), outcome);
}
...
test "Ul_Us_S: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_Us_S(.{ .v1 = 16835, .v2 = 29577, .v3 = 24424 }), outcome);
}
...
test "Ul_Us_S: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_Us_S(), outcome);
}
...
test "Ul_Us_Uc: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_Us_Uc(.{ .v1 = 11719, .v2 = 12708, .v3 = 67 }), outcome);
}
...
test "Ul_Us_Uc: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_Us_Uc(), outcome);
}
...
test "Ul_Us_Ui: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_Us_Ui(.{ .v1 = 26605, .v2 = 10106, .v3 = 23753 }), outcome);
}
...
test "Ul_Us_Ui: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_Us_Ui(), outcome);
}
...
test "Ul_Us_Ul: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_Us_Ul(.{ .v1 = 1091, .v2 = 31951, .v3 = 2537 }), outcome);
}
...
test "Ul_Us_Ul: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_Us_Ul(), outcome);
}
...
test "Ul_Us_Us: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_Us_Us(.{ .v1 = 6339, .v2 = 31142, .v3 = 16115 }), outcome);
}
...
test "Ul_Us_Us: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_Us_Us(), outcome);
}
...
test "Ul_Us_Vp: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_Us_Vp(.{ .v1 = 18681, .v2 = 2174, .v3 = null }), outcome);
}
...
test "Ul_Us_Vp: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_Us_Vp(), outcome);
}
...
test "Ul_Vp: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_Vp(.{ .v1 = 7138, .v2 = null }), outcome);
}
...
test "Ul_Vp: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_Vp(), outcome);
}
...
test "Ul_Vp_C: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_Vp_C(.{ .v1 = 12084, .v2 = null, .v3 = 77 }), outcome);
}
...
test "Ul_Vp_C: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_Vp_C(), outcome);
}
...
test "Ul_Vp_D: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_Vp_D(.{ .v1 = 26067, .v2 = null, .v3 = -2.125 }), outcome);
}
...
test "Ul_Vp_D: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_Vp_D(), outcome);
}
...
test "Ul_Vp_F: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_Vp_F(.{ .v1 = 14892, .v2 = null, .v3 = 0.5 }), outcome);
}
...
test "Ul_Vp_F: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_Vp_F(), outcome);
}
...
test "Ul_Vp_I: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_Vp_I(.{ .v1 = 7902, .v2 = null, .v3 = 16411 }), outcome);
}
...
test "Ul_Vp_I: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_Vp_I(), outcome);
}
...
test "Ul_Vp_Ip: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_Vp_Ip(.{ .v1 = 3098, .v2 = null, .v3 = null }), outcome);
}
...
test "Ul_Vp_Ip: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_Vp_Ip(), outcome);
}
...
test "Ul_Vp_L: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_Vp_L(.{ .v1 = 10634, .v2 = null, .v3 = 13712 }), outcome);
}
...
test "Ul_Vp_L: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_Vp_L(), outcome);
}
...
test "Ul_Vp_S: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_Vp_S(.{ .v1 = 13103, .v2 = null, .v3 = 26544 }), outcome);
}
...
test "Ul_Vp_S: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_Vp_S(), outcome);
}
...
test "Ul_Vp_Uc: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_Vp_Uc(.{ .v1 = 7202, .v2 = null, .v3 = 80 }), outcome);
}
...
test "Ul_Vp_Uc: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_Vp_Uc(), outcome);
}
...
test "Ul_Vp_Ui: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_Vp_Ui(.{ .v1 = 22663, .v2 = null, .v3 = 1363 }), outcome);
}
...
test "Ul_Vp_Ui: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_Vp_Ui(), outcome);
}
...
test "Ul_Vp_Ul: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_Vp_Ul(.{ .v1 = 18470, .v2 = null, .v3 = 9482 }), outcome);
}
...
test "Ul_Vp_Ul: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_Vp_Ul(), outcome);
}
...
test "Ul_Vp_Us: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_Vp_Us(.{ .v1 = 28776, .v2 = null, .v3 = 16723 }), outcome);
}
...
test "Ul_Vp_Us: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_Vp_Us(), outcome);
}
...
test "Ul_Vp_Vp: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Ul_Vp_Vp(.{ .v1 = 25197, .v2 = null, .v3 = null }), outcome);
}
...
test "Ul_Vp_Vp: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Ul_Vp_Vp(), outcome);
}
...
test "Us: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us(.{ .v1 = 8994 }), outcome);
}
...
test "Us: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us(), outcome);
}
...
test "Us_C: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_C(.{ .v1 = 16644, .v2 = 68 }), outcome);
}
...
test "Us_C: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_C(), outcome);
}
...
test "Us_C_C: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_C_C(.{ .v1 = 2512, .v2 = 99, .v3 = 60 }), outcome);
}
...
test "Us_C_C: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_C_C(), outcome);
}
...
test "Us_C_D: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_C_D(.{ .v1 = 21959, .v2 = 16, .v3 = 4.5 }), outcome);
}
...
test "Us_C_D: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_C_D(), outcome);
}
...
test "Us_C_F: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_C_F(.{ .v1 = 2567, .v2 = 34, .v3 = 4.5 }), outcome);
}
...
test "Us_C_F: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_C_F(), outcome);
}
...
test "Us_C_I: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_C_I(.{ .v1 = 15462, .v2 = 25, .v3 = 9740 }), outcome);
}
...
test "Us_C_I: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_C_I(), outcome);
}
...
test "Us_C_Ip: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_C_Ip(.{ .v1 = 21044, .v2 = 85, .v3 = null }), outcome);
}
...
test "Us_C_Ip: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_C_Ip(), outcome);
}
...
test "Us_C_L: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_C_L(.{ .v1 = 15192, .v2 = 103, .v3 = 19299 }), outcome);
}
...
test "Us_C_L: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_C_L(), outcome);
}
...
test "Us_C_S: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_C_S(.{ .v1 = 23346, .v2 = 103, .v3 = 22139 }), outcome);
}
...
test "Us_C_S: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_C_S(), outcome);
}
...
test "Us_C_Uc: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_C_Uc(.{ .v1 = 3179, .v2 = 4, .v3 = 73 }), outcome);
}
...
test "Us_C_Uc: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_C_Uc(), outcome);
}
...
test "Us_C_Ui: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_C_Ui(.{ .v1 = 19277, .v2 = 98, .v3 = 28789 }), outcome);
}
...
test "Us_C_Ui: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_C_Ui(), outcome);
}
...
test "Us_C_Ul: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_C_Ul(.{ .v1 = 24703, .v2 = 76, .v3 = 15589 }), outcome);
}
...
test "Us_C_Ul: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_C_Ul(), outcome);
}
...
test "Us_C_Us: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_C_Us(.{ .v1 = 12247, .v2 = 66, .v3 = 10022 }), outcome);
}
...
test "Us_C_Us: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_C_Us(), outcome);
}
...
test "Us_C_Vp: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_C_Vp(.{ .v1 = 5932, .v2 = 39, .v3 = null }), outcome);
}
...
test "Us_C_Vp: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_C_Vp(), outcome);
}
...
test "Us_D: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_D(.{ .v1 = 18580, .v2 = -2.125 }), outcome);
}
...
test "Us_D: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_D(), outcome);
}
...
test "Us_D_C: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_D_C(.{ .v1 = 11240, .v2 = 4.5, .v3 = 72 }), outcome);
}
...
test "Us_D_C: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_D_C(), outcome);
}
...
test "Us_D_D: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_D_D(.{ .v1 = 11524, .v2 = 1.0, .v3 = 0.875 }), outcome);
}
...
test "Us_D_D: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_D_D(), outcome);
}
...
test "Us_D_F: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_D_F(.{ .v1 = 6365, .v2 = 7.0, .v3 = 7.0 }), outcome);
}
...
test "Us_D_F: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_D_F(), outcome);
}
...
test "Us_D_I: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_D_I(.{ .v1 = 29281, .v2 = -2.125, .v3 = 22252 }), outcome);
}
...
test "Us_D_I: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_D_I(), outcome);
}
...
test "Us_D_Ip: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_D_Ip(.{ .v1 = 23514, .v2 = 1.0, .v3 = null }), outcome);
}
...
test "Us_D_Ip: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_D_Ip(), outcome);
}
...
test "Us_D_L: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_D_L(.{ .v1 = 19759, .v2 = -0.25, .v3 = 511 }), outcome);
}
...
test "Us_D_L: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_D_L(), outcome);
}
...
test "Us_D_S: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_D_S(.{ .v1 = 9683, .v2 = -0.25, .v3 = 7749 }), outcome);
}
...
test "Us_D_S: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_D_S(), outcome);
}
...
test "Us_D_Uc: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_D_Uc(.{ .v1 = 29022, .v2 = -2.125, .v3 = 20 }), outcome);
}
...
test "Us_D_Uc: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_D_Uc(), outcome);
}
...
test "Us_D_Ui: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_D_Ui(.{ .v1 = 32591, .v2 = 0.5, .v3 = 30269 }), outcome);
}
...
test "Us_D_Ui: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_D_Ui(), outcome);
}
...
test "Us_D_Ul: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_D_Ul(.{ .v1 = 4318, .v2 = 7.0, .v3 = 28610 }), outcome);
}
...
test "Us_D_Ul: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_D_Ul(), outcome);
}
...
test "Us_D_Us: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_D_Us(.{ .v1 = 30198, .v2 = 4.5, .v3 = 22443 }), outcome);
}
...
test "Us_D_Us: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_D_Us(), outcome);
}
...
test "Us_D_Vp: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_D_Vp(.{ .v1 = 1904, .v2 = 1.0, .v3 = null }), outcome);
}
...
test "Us_D_Vp: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_D_Vp(), outcome);
}
...
test "Us_F: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_F(.{ .v1 = 26991, .v2 = 0.5 }), outcome);
}
...
test "Us_F: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_F(), outcome);
}
...
test "Us_F_C: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_F_C(.{ .v1 = 27059, .v2 = 7.0, .v3 = 87 }), outcome);
}
...
test "Us_F_C: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_F_C(), outcome);
}
...
test "Us_F_D: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_F_D(.{ .v1 = 18964, .v2 = 7.0, .v3 = 1.0 }), outcome);
}
...
test "Us_F_D: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_F_D(), outcome);
}
...
test "Us_F_F: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_F_F(.{ .v1 = 18550, .v2 = 7.0, .v3 = 1.0 }), outcome);
}
...
test "Us_F_F: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_F_F(), outcome);
}
...
test "Us_F_I: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_F_I(.{ .v1 = 22098, .v2 = -2.125, .v3 = 5743 }), outcome);
}
...
test "Us_F_I: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_F_I(), outcome);
}
...
test "Us_F_Ip: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_F_Ip(.{ .v1 = 5299, .v2 = -0.25, .v3 = null }), outcome);
}
...
test "Us_F_Ip: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_F_Ip(), outcome);
}
...
test "Us_F_L: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_F_L(.{ .v1 = 27576, .v2 = 0.875, .v3 = 12334 }), outcome);
}
...
test "Us_F_L: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_F_L(), outcome);
}
...
test "Us_F_S: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_F_S(.{ .v1 = 1064, .v2 = -2.125, .v3 = 21363 }), outcome);
}
...
test "Us_F_S: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_F_S(), outcome);
}
...
test "Us_F_Uc: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_F_Uc(.{ .v1 = 7692, .v2 = 4.5, .v3 = 76 }), outcome);
}
...
test "Us_F_Uc: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_F_Uc(), outcome);
}
...
test "Us_F_Ui: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_F_Ui(.{ .v1 = 26868, .v2 = -0.25, .v3 = 26494 }), outcome);
}
...
test "Us_F_Ui: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_F_Ui(), outcome);
}
...
test "Us_F_Ul: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_F_Ul(.{ .v1 = 19238, .v2 = 7.0, .v3 = 27012 }), outcome);
}
...
test "Us_F_Ul: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_F_Ul(), outcome);
}
...
test "Us_F_Us: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_F_Us(.{ .v1 = 24992, .v2 = 7.0, .v3 = 6846 }), outcome);
}
...
test "Us_F_Us: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_F_Us(), outcome);
}
...
test "Us_F_Vp: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_F_Vp(.{ .v1 = 17908, .v2 = -0.25, .v3 = null }), outcome);
}
...
test "Us_F_Vp: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_F_Vp(), outcome);
}
...
test "Us_I: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_I(.{ .v1 = 30600, .v2 = 1719 }), outcome);
}
...
test "Us_I: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_I(), outcome);
}
...
test "Us_I_C: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_I_C(.{ .v1 = 13661, .v2 = 5376, .v3 = 111 }), outcome);
}
...
test "Us_I_C: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_I_C(), outcome);
}
...
test "Us_I_D: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_I_D(.{ .v1 = 8903, .v2 = 26042, .v3 = -2.125 }), outcome);
}
...
test "Us_I_D: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_I_D(), outcome);
}
...
test "Us_I_F: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_I_F(.{ .v1 = 20027, .v2 = 12274, .v3 = 0.875 }), outcome);
}
...
test "Us_I_F: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_I_F(), outcome);
}
...
test "Us_I_I: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_I_I(.{ .v1 = 16614, .v2 = 20431, .v3 = 2793 }), outcome);
}
...
test "Us_I_I: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_I_I(), outcome);
}
...
test "Us_I_Ip: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_I_Ip(.{ .v1 = 28542, .v2 = 11599, .v3 = null }), outcome);
}
...
test "Us_I_Ip: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_I_Ip(), outcome);
}
...
test "Us_I_L: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_I_L(.{ .v1 = 10367, .v2 = 14385, .v3 = 15994 }), outcome);
}
...
test "Us_I_L: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_I_L(), outcome);
}
...
test "Us_I_S: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_I_S(.{ .v1 = 11579, .v2 = 6917, .v3 = 7261 }), outcome);
}
...
test "Us_I_S: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_I_S(), outcome);
}
...
test "Us_I_Uc: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_I_Uc(.{ .v1 = 26644, .v2 = 29019, .v3 = 82 }), outcome);
}
...
test "Us_I_Uc: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_I_Uc(), outcome);
}
...
test "Us_I_Ui: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_I_Ui(.{ .v1 = 19361, .v2 = 28469, .v3 = 7208 }), outcome);
}
...
test "Us_I_Ui: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_I_Ui(), outcome);
}
...
test "Us_I_Ul: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_I_Ul(.{ .v1 = 28076, .v2 = 27483, .v3 = 30933 }), outcome);
}
...
test "Us_I_Ul: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_I_Ul(), outcome);
}
...
test "Us_I_Us: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_I_Us(.{ .v1 = 15877, .v2 = 5090, .v3 = 1580 }), outcome);
}
...
test "Us_I_Us: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_I_Us(), outcome);
}
...
test "Us_I_Vp: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_I_Vp(.{ .v1 = 1804, .v2 = 13795, .v3 = null }), outcome);
}
...
test "Us_I_Vp: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_I_Vp(), outcome);
}
...
test "Us_Ip: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_Ip(.{ .v1 = 28828, .v2 = null }), outcome);
}
...
test "Us_Ip: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_Ip(), outcome);
}
...
test "Us_Ip_C: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_Ip_C(.{ .v1 = 11358, .v2 = null, .v3 = 95 }), outcome);
}
...
test "Us_Ip_C: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_Ip_C(), outcome);
}
...
test "Us_Ip_D: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_Ip_D(.{ .v1 = 32334, .v2 = null, .v3 = 4.5 }), outcome);
}
...
test "Us_Ip_D: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_Ip_D(), outcome);
}
...
test "Us_Ip_F: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_Ip_F(.{ .v1 = 19476, .v2 = null, .v3 = -2.125 }), outcome);
}
...
test "Us_Ip_F: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_Ip_F(), outcome);
}
...
test "Us_Ip_I: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_Ip_I(.{ .v1 = 14363, .v2 = null, .v3 = 12277 }), outcome);
}
...
test "Us_Ip_I: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_Ip_I(), outcome);
}
...
test "Us_Ip_Ip: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_Ip_Ip(.{ .v1 = 27094, .v2 = null, .v3 = null }), outcome);
}
...
test "Us_Ip_Ip: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_Ip_Ip(), outcome);
}
...
test "Us_Ip_L: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_Ip_L(.{ .v1 = 7648, .v2 = null, .v3 = 28696 }), outcome);
}
...
test "Us_Ip_L: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_Ip_L(), outcome);
}
...
test "Us_Ip_S: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_Ip_S(.{ .v1 = 15817, .v2 = null, .v3 = 7907 }), outcome);
}
...
test "Us_Ip_S: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_Ip_S(), outcome);
}
...
test "Us_Ip_Uc: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_Ip_Uc(.{ .v1 = 3074, .v2 = null, .v3 = 5 }), outcome);
}
...
test "Us_Ip_Uc: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_Ip_Uc(), outcome);
}
...
test "Us_Ip_Ui: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_Ip_Ui(.{ .v1 = 1622, .v2 = null, .v3 = 7385 }), outcome);
}
...
test "Us_Ip_Ui: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_Ip_Ui(), outcome);
}
...
test "Us_Ip_Ul: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_Ip_Ul(.{ .v1 = 4903, .v2 = null, .v3 = 12817 }), outcome);
}
...
test "Us_Ip_Ul: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_Ip_Ul(), outcome);
}
...
test "Us_Ip_Us: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_Ip_Us(.{ .v1 = 13416, .v2 = null, .v3 = 15710 }), outcome);
}
...
test "Us_Ip_Us: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_Ip_Us(), outcome);
}
...
test "Us_Ip_Vp: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_Ip_Vp(.{ .v1 = 24100, .v2 = null, .v3 = null }), outcome);
}
...
test "Us_Ip_Vp: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_Ip_Vp(), outcome);
}
...
test "Us_L: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_L(.{ .v1 = 24913, .v2 = 9960 }), outcome);
}
...
test "Us_L: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_L(), outcome);
}
...
test "Us_L_C: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_L_C(.{ .v1 = 10232, .v2 = 9213, .v3 = 44 }), outcome);
}
...
test "Us_L_C: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_L_C(), outcome);
}
...
test "Us_L_D: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_L_D(.{ .v1 = 23248, .v2 = 22734, .v3 = -0.25 }), outcome);
}
...
test "Us_L_D: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_L_D(), outcome);
}
...
test "Us_L_F: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_L_F(.{ .v1 = 24117, .v2 = 9201, .v3 = -0.25 }), outcome);
}
...
test "Us_L_F: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_L_F(), outcome);
}
...
test "Us_L_I: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_L_I(.{ .v1 = 3504, .v2 = 11336, .v3 = 24471 }), outcome);
}
...
test "Us_L_I: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_L_I(), outcome);
}
...
test "Us_L_Ip: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_L_Ip(.{ .v1 = 21042, .v2 = 20614, .v3 = null }), outcome);
}
...
test "Us_L_Ip: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_L_Ip(), outcome);
}
...
test "Us_L_L: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_L_L(.{ .v1 = 1123, .v2 = 30030, .v3 = 14538 }), outcome);
}
...
test "Us_L_L: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_L_L(), outcome);
}
...
test "Us_L_S: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_L_S(.{ .v1 = 22132, .v2 = 25058, .v3 = 25622 }), outcome);
}
...
test "Us_L_S: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_L_S(), outcome);
}
...
test "Us_L_Uc: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_L_Uc(.{ .v1 = 18839, .v2 = 17575, .v3 = 11 }), outcome);
}
...
test "Us_L_Uc: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_L_Uc(), outcome);
}
...
test "Us_L_Ui: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_L_Ui(.{ .v1 = 13426, .v2 = 7778, .v3 = 20282 }), outcome);
}
...
test "Us_L_Ui: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_L_Ui(), outcome);
}
...
test "Us_L_Ul: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_L_Ul(.{ .v1 = 8840, .v2 = 7536, .v3 = 11028 }), outcome);
}
...
test "Us_L_Ul: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_L_Ul(), outcome);
}
...
test "Us_L_Us: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_L_Us(.{ .v1 = 24633, .v2 = 16410, .v3 = 9161 }), outcome);
}
...
test "Us_L_Us: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_L_Us(), outcome);
}
...
test "Us_L_Vp: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_L_Vp(.{ .v1 = 21267, .v2 = 5661, .v3 = null }), outcome);
}
...
test "Us_L_Vp: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_L_Vp(), outcome);
}
...
test "Us_S: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_S(.{ .v1 = 24727, .v2 = 29166 }), outcome);
}
...
test "Us_S: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_S(), outcome);
}
...
test "Us_S_C: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_S_C(.{ .v1 = 10311, .v2 = 30465, .v3 = 91 }), outcome);
}
...
test "Us_S_C: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_S_C(), outcome);
}
...
test "Us_S_D: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_S_D(.{ .v1 = 23117, .v2 = 19592, .v3 = 0.875 }), outcome);
}
...
test "Us_S_D: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_S_D(), outcome);
}
...
test "Us_S_F: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_S_F(.{ .v1 = 15422, .v2 = 892, .v3 = -0.25 }), outcome);
}
...
test "Us_S_F: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_S_F(), outcome);
}
...
test "Us_S_I: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_S_I(.{ .v1 = 23242, .v2 = 26561, .v3 = 3363 }), outcome);
}
...
test "Us_S_I: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_S_I(), outcome);
}
...
test "Us_S_Ip: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_S_Ip(.{ .v1 = 20985, .v2 = 3457, .v3 = null }), outcome);
}
...
test "Us_S_Ip: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_S_Ip(), outcome);
}
...
test "Us_S_L: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_S_L(.{ .v1 = 18517, .v2 = 5247, .v3 = 15555 }), outcome);
}
...
test "Us_S_L: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_S_L(), outcome);
}
...
test "Us_S_S: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_S_S(.{ .v1 = 11754, .v2 = 6358, .v3 = 12603 }), outcome);
}
...
test "Us_S_S: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_S_S(), outcome);
}
...
test "Us_S_Uc: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_S_Uc(.{ .v1 = 21651, .v2 = 302, .v3 = 58 }), outcome);
}
...
test "Us_S_Uc: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_S_Uc(), outcome);
}
...
test "Us_S_Ui: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_S_Ui(.{ .v1 = 7044, .v2 = 24986, .v3 = 27224 }), outcome);
}
...
test "Us_S_Ui: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_S_Ui(), outcome);
}
...
test "Us_S_Ul: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_S_Ul(.{ .v1 = 26369, .v2 = 29978, .v3 = 8606 }), outcome);
}
...
test "Us_S_Ul: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_S_Ul(), outcome);
}
...
test "Us_S_Us: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_S_Us(.{ .v1 = 3928, .v2 = 25056, .v3 = 13273 }), outcome);
}
...
test "Us_S_Us: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_S_Us(), outcome);
}
...
test "Us_S_Vp: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_S_Vp(.{ .v1 = 10313, .v2 = 21627, .v3 = null }), outcome);
}
...
test "Us_S_Vp: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_S_Vp(), outcome);
}
...
test "Us_Uc: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_Uc(.{ .v1 = 10039, .v2 = 48 }), outcome);
}
...
test "Us_Uc: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_Uc(), outcome);
}
...
test "Us_Uc_C: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_Uc_C(.{ .v1 = 1784, .v2 = 122, .v3 = 9 }), outcome);
}
...
test "Us_Uc_C: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_Uc_C(), outcome);
}
...
test "Us_Uc_D: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_Uc_D(.{ .v1 = 21665, .v2 = 0, .v3 = -2.125 }), outcome);
}
...
test "Us_Uc_D: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_Uc_D(), outcome);
}
...
test "Us_Uc_F: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_Uc_F(.{ .v1 = 30089, .v2 = 102, .v3 = 1.0 }), outcome);
}
...
test "Us_Uc_F: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_Uc_F(), outcome);
}
...
test "Us_Uc_I: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_Uc_I(.{ .v1 = 32018, .v2 = 76, .v3 = 22674 }), outcome);
}
...
test "Us_Uc_I: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_Uc_I(), outcome);
}
...
test "Us_Uc_Ip: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_Uc_Ip(.{ .v1 = 5672, .v2 = 26, .v3 = null }), outcome);
}
...
test "Us_Uc_Ip: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_Uc_Ip(), outcome);
}
...
test "Us_Uc_L: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_Uc_L(.{ .v1 = 13171, .v2 = 48, .v3 = 11522 }), outcome);
}
...
test "Us_Uc_L: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_Uc_L(), outcome);
}
...
test "Us_Uc_S: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_Uc_S(.{ .v1 = 13689, .v2 = 78, .v3 = 3457 }), outcome);
}
...
test "Us_Uc_S: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_Uc_S(), outcome);
}
...
test "Us_Uc_Uc: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_Uc_Uc(.{ .v1 = 32576, .v2 = 114, .v3 = 6 }), outcome);
}
...
test "Us_Uc_Uc: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_Uc_Uc(), outcome);
}
...
test "Us_Uc_Ui: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_Uc_Ui(.{ .v1 = 8544, .v2 = 77, .v3 = 31566 }), outcome);
}
...
test "Us_Uc_Ui: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_Uc_Ui(), outcome);
}
...
test "Us_Uc_Ul: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_Uc_Ul(.{ .v1 = 30788, .v2 = 29, .v3 = 22665 }), outcome);
}
...
test "Us_Uc_Ul: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_Uc_Ul(), outcome);
}
...
test "Us_Uc_Us: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_Uc_Us(.{ .v1 = 28438, .v2 = 88, .v3 = 26894 }), outcome);
}
...
test "Us_Uc_Us: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_Uc_Us(), outcome);
}
...
test "Us_Uc_Vp: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_Uc_Vp(.{ .v1 = 19528, .v2 = 87, .v3 = null }), outcome);
}
...
test "Us_Uc_Vp: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_Uc_Vp(), outcome);
}
...
test "Us_Ui: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_Ui(.{ .v1 = 22821, .v2 = 31463 }), outcome);
}
...
test "Us_Ui: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_Ui(), outcome);
}
...
test "Us_Ui_C: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_Ui_C(.{ .v1 = 32462, .v2 = 8790, .v3 = 63 }), outcome);
}
...
test "Us_Ui_C: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_Ui_C(), outcome);
}
...
test "Us_Ui_D: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_Ui_D(.{ .v1 = 12024, .v2 = 26928, .v3 = -0.25 }), outcome);
}
...
test "Us_Ui_D: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_Ui_D(), outcome);
}
...
test "Us_Ui_F: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_Ui_F(.{ .v1 = 18149, .v2 = 22194, .v3 = -2.125 }), outcome);
}
...
test "Us_Ui_F: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_Ui_F(), outcome);
}
...
test "Us_Ui_I: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_Ui_I(.{ .v1 = 20073, .v2 = 9610, .v3 = 6587 }), outcome);
}
...
test "Us_Ui_I: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_Ui_I(), outcome);
}
...
test "Us_Ui_Ip: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_Ui_Ip(.{ .v1 = 5912, .v2 = 5511, .v3 = null }), outcome);
}
...
test "Us_Ui_Ip: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_Ui_Ip(), outcome);
}
...
test "Us_Ui_L: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_Ui_L(.{ .v1 = 3295, .v2 = 3241, .v3 = 591 }), outcome);
}
...
test "Us_Ui_L: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_Ui_L(), outcome);
}
...
test "Us_Ui_S: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_Ui_S(.{ .v1 = 190, .v2 = 10192, .v3 = 3934 }), outcome);
}
...
test "Us_Ui_S: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_Ui_S(), outcome);
}
...
test "Us_Ui_Uc: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_Ui_Uc(.{ .v1 = 27974, .v2 = 12257, .v3 = 100 }), outcome);
}
...
test "Us_Ui_Uc: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_Ui_Uc(), outcome);
}
...
test "Us_Ui_Ui: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_Ui_Ui(.{ .v1 = 3493, .v2 = 11093, .v3 = 28185 }), outcome);
}
...
test "Us_Ui_Ui: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_Ui_Ui(), outcome);
}
...
test "Us_Ui_Ul: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_Ui_Ul(.{ .v1 = 20393, .v2 = 2406, .v3 = 17503 }), outcome);
}
...
test "Us_Ui_Ul: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_Ui_Ul(), outcome);
}
...
test "Us_Ui_Us: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_Ui_Us(.{ .v1 = 14950, .v2 = 28030, .v3 = 26040 }), outcome);
}
...
test "Us_Ui_Us: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_Ui_Us(), outcome);
}
...
test "Us_Ui_Vp: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_Ui_Vp(.{ .v1 = 13015, .v2 = 7991, .v3 = null }), outcome);
}
...
test "Us_Ui_Vp: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_Ui_Vp(), outcome);
}
...
test "Us_Ul: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_Ul(.{ .v1 = 16401, .v2 = 4479 }), outcome);
}
...
test "Us_Ul: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_Ul(), outcome);
}
...
test "Us_Ul_C: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_Ul_C(.{ .v1 = 26329, .v2 = 27940, .v3 = 45 }), outcome);
}
...
test "Us_Ul_C: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_Ul_C(), outcome);
}
...
test "Us_Ul_D: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_Ul_D(.{ .v1 = 17927, .v2 = 8476, .v3 = 0.875 }), outcome);
}
...
test "Us_Ul_D: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_Ul_D(), outcome);
}
...
test "Us_Ul_F: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_Ul_F(.{ .v1 = 20120, .v2 = 14441, .v3 = -0.25 }), outcome);
}
...
test "Us_Ul_F: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_Ul_F(), outcome);
}
...
test "Us_Ul_I: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_Ul_I(.{ .v1 = 8727, .v2 = 14648, .v3 = 27507 }), outcome);
}
...
test "Us_Ul_I: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_Ul_I(), outcome);
}
...
test "Us_Ul_Ip: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_Ul_Ip(.{ .v1 = 24923, .v2 = 3980, .v3 = null }), outcome);
}
...
test "Us_Ul_Ip: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_Ul_Ip(), outcome);
}
...
test "Us_Ul_L: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_Ul_L(.{ .v1 = 14072, .v2 = 26693, .v3 = 704 }), outcome);
}
...
test "Us_Ul_L: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_Ul_L(), outcome);
}
...
test "Us_Ul_S: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_Ul_S(.{ .v1 = 29540, .v2 = 2724, .v3 = 23630 }), outcome);
}
...
test "Us_Ul_S: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_Ul_S(), outcome);
}
...
test "Us_Ul_Uc: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_Ul_Uc(.{ .v1 = 2843, .v2 = 9302, .v3 = 9 }), outcome);
}
...
test "Us_Ul_Uc: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_Ul_Uc(), outcome);
}
...
test "Us_Ul_Ui: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_Ul_Ui(.{ .v1 = 1936, .v2 = 23128, .v3 = 25427 }), outcome);
}
...
test "Us_Ul_Ui: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_Ul_Ui(), outcome);
}
...
test "Us_Ul_Ul: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_Ul_Ul(.{ .v1 = 21746, .v2 = 21824, .v3 = 14878 }), outcome);
}
...
test "Us_Ul_Ul: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_Ul_Ul(), outcome);
}
...
test "Us_Ul_Us: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_Ul_Us(.{ .v1 = 26984, .v2 = 13299, .v3 = 17140 }), outcome);
}
...
test "Us_Ul_Us: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_Ul_Us(), outcome);
}
...
test "Us_Ul_Vp: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_Ul_Vp(.{ .v1 = 30518, .v2 = 21741, .v3 = null }), outcome);
}
...
test "Us_Ul_Vp: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_Ul_Vp(), outcome);
}
...
test "Us_Us: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_Us(.{ .v1 = 22395, .v2 = 24860 }), outcome);
}
...
test "Us_Us: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_Us(), outcome);
}
...
test "Us_Us_C: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_Us_C(.{ .v1 = 29095, .v2 = 16896, .v3 = 12 }), outcome);
}
...
test "Us_Us_C: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_Us_C(), outcome);
}
...
test "Us_Us_D: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_Us_D(.{ .v1 = 32400, .v2 = 24920, .v3 = 7.0 }), outcome);
}
...
test "Us_Us_D: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_Us_D(), outcome);
}
...
test "Us_Us_F: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_Us_F(.{ .v1 = 27252, .v2 = 23171, .v3 = 7.0 }), outcome);
}
...
test "Us_Us_F: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_Us_F(), outcome);
}
...
test "Us_Us_I: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_Us_I(.{ .v1 = 30675, .v2 = 20018, .v3 = 11813 }), outcome);
}
...
test "Us_Us_I: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_Us_I(), outcome);
}
...
test "Us_Us_Ip: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_Us_Ip(.{ .v1 = 12267, .v2 = 8588, .v3 = null }), outcome);
}
...
test "Us_Us_Ip: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_Us_Ip(), outcome);
}
...
test "Us_Us_L: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_Us_L(.{ .v1 = 27707, .v2 = 22062, .v3 = 7550 }), outcome);
}
...
test "Us_Us_L: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_Us_L(), outcome);
}
...
test "Us_Us_S: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_Us_S(.{ .v1 = 26438, .v2 = 9267, .v3 = 12429 }), outcome);
}
...
test "Us_Us_S: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_Us_S(), outcome);
}
...
test "Us_Us_Uc: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_Us_Uc(.{ .v1 = 16024, .v2 = 16604, .v3 = 8 }), outcome);
}
...
test "Us_Us_Uc: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_Us_Uc(), outcome);
}
...
test "Us_Us_Ui: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_Us_Ui(.{ .v1 = 31707, .v2 = 32474, .v3 = 20286 }), outcome);
}
...
test "Us_Us_Ui: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_Us_Ui(), outcome);
}
...
test "Us_Us_Ul: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_Us_Ul(.{ .v1 = 23168, .v2 = 25230, .v3 = 32395 }), outcome);
}
...
test "Us_Us_Ul: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_Us_Ul(), outcome);
}
...
test "Us_Us_Us: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_Us_Us(.{ .v1 = 22020, .v2 = 15748, .v3 = 19041 }), outcome);
}
...
test "Us_Us_Us: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_Us_Us(), outcome);
}
...
test "Us_Us_Vp: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_Us_Vp(.{ .v1 = 2680, .v2 = 25163, .v3 = null }), outcome);
}
...
test "Us_Us_Vp: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_Us_Vp(), outcome);
}
...
test "Us_Vp: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_Vp(.{ .v1 = 27963, .v2 = null }), outcome);
}
...
test "Us_Vp: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_Vp(), outcome);
}
...
test "Us_Vp_C: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_Vp_C(.{ .v1 = 13429, .v2 = null, .v3 = 114 }), outcome);
}
...
test "Us_Vp_C: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_Vp_C(), outcome);
}
...
test "Us_Vp_D: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_Vp_D(.{ .v1 = 14615, .v2 = null, .v3 = 7.0 }), outcome);
}
...
test "Us_Vp_D: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_Vp_D(), outcome);
}
...
test "Us_Vp_F: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_Vp_F(.{ .v1 = 25809, .v2 = null, .v3 = -0.25 }), outcome);
}
...
test "Us_Vp_F: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_Vp_F(), outcome);
}
...
test "Us_Vp_I: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_Vp_I(.{ .v1 = 21154, .v2 = null, .v3 = 12034 }), outcome);
}
...
test "Us_Vp_I: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_Vp_I(), outcome);
}
...
test "Us_Vp_Ip: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_Vp_Ip(.{ .v1 = 1558, .v2 = null, .v3 = null }), outcome);
}
...
test "Us_Vp_Ip: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_Vp_Ip(), outcome);
}
...
test "Us_Vp_L: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_Vp_L(.{ .v1 = 3956, .v2 = null, .v3 = 28044 }), outcome);
}
...
test "Us_Vp_L: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_Vp_L(), outcome);
}
...
test "Us_Vp_S: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_Vp_S(.{ .v1 = 19785, .v2 = null, .v3 = 32420 }), outcome);
}
...
test "Us_Vp_S: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_Vp_S(), outcome);
}
...
test "Us_Vp_Uc: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_Vp_Uc(.{ .v1 = 12798, .v2 = null, .v3 = 106 }), outcome);
}
...
test "Us_Vp_Uc: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_Vp_Uc(), outcome);
}
...
test "Us_Vp_Ui: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_Vp_Ui(.{ .v1 = 18555, .v2 = null, .v3 = 25756 }), outcome);
}
...
test "Us_Vp_Ui: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_Vp_Ui(), outcome);
}
...
test "Us_Vp_Ul: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_Vp_Ul(.{ .v1 = 25009, .v2 = null, .v3 = 2138 }), outcome);
}
...
test "Us_Vp_Ul: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_Vp_Ul(), outcome);
}
...
test "Us_Vp_Us: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_Vp_Us(.{ .v1 = 32123, .v2 = null, .v3 = 5039 }), outcome);
}
...
test "Us_Vp_Us: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_Vp_Us(), outcome);
}
...
test "Us_Vp_Vp: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Us_Vp_Vp(.{ .v1 = 29460, .v2 = null, .v3 = null }), outcome);
}
...
test "Us_Vp_Vp: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Us_Vp_Vp(), outcome);
}
...
test "Vp: Zig passes to C" {
    if (comptime builtin.cpu.arch.isPPC()) return error.SkipZigTest;
    var outcome = true;
    try testing.expectOutcome(c.assert_Vp(.{ .v1 = null }), outcome);
}
...
test "Vp: C passes to Zig" {
    ...
    if (builtin.cpu.arch.isPPC()) outcome = false;
    try testing.expectOutcome(c.send_Vp(), outcome);
}
