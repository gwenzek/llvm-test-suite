...
test "Ul_C_D" {
    ...
    try testing.expectOk(c.recv_Ul_C_D(.{ .v1 = 32764, .v2 = 48, .v3 = 7160 }));
}
...
test "Ul_C_F" {
    ...
    try testing.expectOk(c.recv_Ul_C_F(.{ .v1 = 26431, .v2 = 0, .v3 = 0.993450 }));
}
...
test "Ul_D" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v1, 0);
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectOk(c.recv_Ul_D(.{ .v1 = 10715, .v2 = 5775 }));
}
...
test "Ul_D_C" {
    ...
    try testing.expectOk(c.recv_Ul_D_C(.{ .v1 = 25643, .v2 = 5883, .v3 = 96 }));
}
...
test "Ul_D_D" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 16);
    try testing.expectOk(c.recv_Ul_D_D(.{ .v1 = 621, .v2 = 10380, .v3 = 13118 }));
}
...
test "Ul_D_F" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 16);
    try testing.expectOk(c.recv_Ul_D_F(.{ .v1 = 11575, .v2 = 21899, .v3 = 0.926665 }));
}
...
test "Ul_D_I" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 16);
    try testing.expectOk(c.recv_Ul_D_I(.{ .v1 = 23336, .v2 = 8615, .v3 = 8068 }));
}
...
test "Ul_D_Ip" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 16);
    try testing.expectOk(c.recv_Ul_D_Ip(.{ .v1 = 30759, .v2 = 29198, .v3 = null }));
}
...
test "Ul_D_L" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 16);
    try testing.expectOk(c.recv_Ul_D_L(.{ .v1 = 16615, .v2 = 23672, .v3 = 2462 }));
}
...
test "Ul_D_S" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 16);
    try testing.expectOk(c.recv_Ul_D_S(.{ .v1 = 6119, .v2 = 27994, .v3 = 20846 }));
}
...
test "Ul_D_Uc" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 16);
    try testing.expectOk(c.recv_Ul_D_Uc(.{ .v1 = 8747, .v2 = 18363, .v3 = 1 }));
}
...
test "Ul_D_Ui" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 16);
    try testing.expectOk(c.recv_Ul_D_Ui(.{ .v1 = 12376, .v2 = 30444, .v3 = 7325 }));
}
...
test "Ul_D_Ul" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 16);
    try testing.expectOk(c.recv_Ul_D_Ul(.{ .v1 = 8264, .v2 = 25610, .v3 = 2350 }));
}
...
test "Ul_D_Us" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 16);
    try testing.expectOk(c.recv_Ul_D_Us(.{ .v1 = 14812, .v2 = 7431, .v3 = 15670 }));
}
...
test "Ul_D_Vp" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 16);
    try testing.expectOk(c.recv_Ul_D_Vp(.{ .v1 = 16222, .v2 = 18273, .v3 = null }));
}
...
test "Ul_F" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v1, 0);
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectOk(c.recv_Ul_F(.{ .v1 = 20297, .v2 = 0.340441 }));
}
...
test "Ul_F_C" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 12);
    try testing.expectOk(c.recv_Ul_F_C(.{ .v1 = 5068, .v2 = 0.183560, .v3 = 103 }));
}
...
test "Ul_F_D" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_Ul_F_D(.{ .v1 = 23787, .v2 = 0.533373, .v3 = 32 }));
}
...
test "Ul_F_F" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 12);
    try testing.expectOk(c.recv_Ul_F_F(.{ .v1 = 4545, .v2 = 0.380326, .v3 = 0.727791 }));
}
...
test "Ul_F_I" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 12);
    try testing.expectOk(c.recv_Ul_F_I(.{ .v1 = 11, .v2 = 0.420820, .v3 = 28962 }));
}
...
test "Ul_F_Ip" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_Ul_F_Ip(.{ .v1 = 10728, .v2 = 0.448228, .v3 = null }));
}
...
test "Ul_F_L" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_Ul_F_L(.{ .v1 = 29862, .v2 = 0.443401, .v3 = 30894 }));
}
...
test "Ul_F_S" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 12);
    try testing.expectOk(c.recv_Ul_F_S(.{ .v1 = 16621, .v2 = 0.752060, .v3 = 5619 }));
}
...
test "Ul_F_Uc" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 12);
    try testing.expectOk(c.recv_Ul_F_Uc(.{ .v1 = 5394, .v2 = 0.776680, .v3 = 26 }));
}
...
test "Ul_F_Ui" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 12);
    try testing.expectOk(c.recv_Ul_F_Ui(.{ .v1 = 18558, .v2 = 0.033781, .v3 = 23737 }));
}
...
test "Ul_F_Ul" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_Ul_F_Ul(.{ .v1 = 19145, .v2 = 0.096556, .v3 = 30196 }));
}
...
test "Ul_F_Us" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 12);
    try testing.expectOk(c.recv_Ul_F_Us(.{ .v1 = 12786, .v2 = 0.693158, .v3 = 32561 }));
}
...
test "Ul_F_Vp" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_Ul_F_Vp(.{ .v1 = 8407, .v2 = 0.481981, .v3 = null }));
}
...
test "Ul_I_D" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_Ul_I_D(.{ .v1 = 16377, .v2 = 29653, .v3 = 22099 }));
}
...
test "Ul_I_F" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 12);
    try testing.expectOk(c.recv_Ul_I_F(.{ .v1 = 6558, .v2 = 14172, .v3 = 0.104317 }));
}
...
test "Ul_Ip_D" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_Ul_Ip_D(.{ .v1 = 3475, .v2 = null, .v3 = 3979 }));
}
...
test "Ul_Ip_F" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_Ul_Ip_F(.{ .v1 = 6436, .v2 = null, .v3 = 0.661660 }));
}
...
test "Ul_L_D" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 16);
    try testing.expectOk(c.recv_Ul_L_D(.{ .v1 = 13861, .v2 = 9151, .v3 = 18009 }));
}
...
test "Ul_L_F" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 16);
    try testing.expectOk(c.recv_Ul_L_F(.{ .v1 = 22003, .v2 = 10595, .v3 = 0.870551 }));
}
...
test "Ul_S_D" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_Ul_S_D(.{ .v1 = 2529, .v2 = 28822, .v3 = 1323 }));
}
...
test "Ul_S_F" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 12);
    try testing.expectOk(c.recv_Ul_S_F(.{ .v1 = 17877, .v2 = 24298, .v3 = 0.324874 }));
}
...
test "Ul_Uc_D" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_Ul_Uc_D(.{ .v1 = 27342, .v2 = 53, .v3 = 8902 }));
}
...
test "Ul_Uc_F" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 12);
    try testing.expectOk(c.recv_Ul_Uc_F(.{ .v1 = 357, .v2 = 83, .v3 = 0.438763 }));
}
...
test "Ul_Ui_D" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_Ul_Ui_D(.{ .v1 = 1908, .v2 = 4685, .v3 = 25170 }));
}
...
test "Ul_Ui_F" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 12);
    try testing.expectOk(c.recv_Ul_Ui_F(.{ .v1 = 24351, .v2 = 12662, .v3 = 0.727794 }));
}
...
test "Ul_Ul_D" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 16);
    try testing.expectOk(c.recv_Ul_Ul_D(.{ .v1 = 16601, .v2 = 13026, .v3 = 13960 }));
}
...
test "Ul_Ul_F" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 16);
    try testing.expectOk(c.recv_Ul_Ul_F(.{ .v1 = 30369, .v2 = 8873, .v3 = 0.177201 }));
}
...
test "Ul_Us_D" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_Ul_Us_D(.{ .v1 = 18843, .v2 = 22623, .v3 = 6206 }));
}
...
test "Ul_Us_F" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 12);
    try testing.expectOk(c.recv_Ul_Us_F(.{ .v1 = 28743, .v2 = 16957, .v3 = 0.384014 }));
}
...
test "Ul_Vp_D" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_Ul_Vp_D(.{ .v1 = 26067, .v2 = null, .v3 = 16461 }));
}
...
test "Ul_Vp_F" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_Ul_Vp_F(.{ .v1 = 14892, .v2 = null, .v3 = 0.369717 }));
}
...
test "Us_C_D" {
    ...
    try testing.expectOk(c.recv_Us_C_D(.{ .v1 = 21959, .v2 = 16, .v3 = 15199 }));
}
...
test "Us_C_F" {
    ...
    try testing.expectOk(c.recv_Us_C_F(.{ .v1 = 2567, .v2 = 34, .v3 = 0.653443 }));
}
...
test "Us_D" {
    ...
    try testing.expectOk(c.recv_Us_D(.{ .v1 = 18580, .v2 = 3917 }));
}
...
test "Us_D_C" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, ABISELECT(8, 4));
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_Us_D_C(.{ .v1 = 11240, .v2 = 18530, .v3 = 114 }));
}
...
test "Us_D_D" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, ABISELECT(8, 4));
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_Us_D_D(.{ .v1 = 11524, .v2 = 30986, .v3 = 8044 }));
}
...
test "Us_D_F" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, ABISELECT(8, 4));
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_Us_D_F(.{ .v1 = 6365, .v2 = 25496, .v3 = 0.566007 }));
}
...
test "Us_D_I" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, ABISELECT(8, 4));
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_Us_D_I(.{ .v1 = 29281, .v2 = 22252, .v3 = 2756 }));
}
...
test "Us_D_Ip" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, ABISELECT(8, 4));
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_Us_D_Ip(.{ .v1 = 23514, .v2 = 25064, .v3 = null }));
}
...
test "Us_D_L" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, ABISELECT(8, 4));
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_Us_D_L(.{ .v1 = 19759, .v2 = 9746, .v3 = 511 }));
}
...
test "Us_D_S" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, ABISELECT(8, 4));
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_Us_D_S(.{ .v1 = 9683, .v2 = 14962, .v3 = 7749 }));
}
...
test "Us_D_Uc" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, ABISELECT(8, 4));
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_Us_D_Uc(.{ .v1 = 29022, .v2 = 5260, .v3 = 125 }));
}
...
test "Us_D_Ui" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, ABISELECT(8, 4));
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_Us_D_Ui(.{ .v1 = 32591, .v2 = 24209, .v3 = 30269 }));
}
...
test "Us_D_Ul" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, ABISELECT(8, 4));
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_Us_D_Ul(.{ .v1 = 4318, .v2 = 28610, .v3 = 11132 }));
}
...
test "Us_D_Us" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, ABISELECT(8, 4));
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_Us_D_Us(.{ .v1 = 30198, .v2 = 22443, .v3 = 1900 }));
}
...
test "Us_D_Vp" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, ABISELECT(8, 4));
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_Us_D_Vp(.{ .v1 = 1904, .v2 = 32725, .v3 = null }));
}
...
test "Us_F" {
    ...
    try testing.expectOk(c.recv_Us_F(.{ .v1 = 26991, .v2 = 0.276245 }));
}
...
test "Us_F_C" {
    ...
    try testing.expectOk(c.recv_Us_F_C(.{ .v1 = 27059, .v2 = 0.791260, .v3 = 109 }));
}
...
test "Us_F_D" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 4);
    try testing.expectFieldOffset(&lv, &lv.v3, 8);
    try testing.expectOk(c.recv_Us_F_D(.{ .v1 = 18964, .v2 = 0.856877, .v3 = 26197 }));
}
...
test "Us_F_F" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 4);
    try testing.expectFieldOffset(&lv, &lv.v3, 8);
    try testing.expectOk(c.recv_Us_F_F(.{ .v1 = 18550, .v2 = 0.751166, .v3 = 0.958302 }));
}
...
test "Us_F_I" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 4);
    try testing.expectFieldOffset(&lv, &lv.v3, 8);
    try testing.expectOk(c.recv_Us_F_I(.{ .v1 = 22098, .v2 = 0.598356, .v3 = 11177 }));
}
...
test "Us_F_Ip" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 4);
    try testing.expectFieldOffset(&lv, &lv.v3, 8);
    try testing.expectOk(c.recv_Us_F_Ip(.{ .v1 = 5299, .v2 = 0.232531, .v3 = null }));
}
...
test "Us_F_L" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 4);
    try testing.expectFieldOffset(&lv, &lv.v3, 8);
    try testing.expectOk(c.recv_Us_F_L(.{ .v1 = 27576, .v2 = 0.066208, .v3 = 15045 }));
}
...
test "Us_F_S" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 4);
    try testing.expectFieldOffset(&lv, &lv.v3, 8);
    try testing.expectOk(c.recv_Us_F_S(.{ .v1 = 1064, .v2 = 0.914765, .v3 = 21363 }));
}
...
test "Us_F_Uc" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 4);
    try testing.expectFieldOffset(&lv, &lv.v3, 8);
    try testing.expectOk(c.recv_Us_F_Uc(.{ .v1 = 7692, .v2 = 0.671857, .v3 = 76 }));
}
...
test "Us_F_Ui" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 4);
    try testing.expectFieldOffset(&lv, &lv.v3, 8);
    try testing.expectOk(c.recv_Us_F_Ui(.{ .v1 = 26868, .v2 = 0.177020, .v3 = 12244 }));
}
...
test "Us_F_Ul" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 4);
    try testing.expectFieldOffset(&lv, &lv.v3, 8);
    try testing.expectOk(c.recv_Us_F_Ul(.{ .v1 = 19238, .v2 = 0.859725, .v3 = 2095 }));
}
...
test "Us_F_Us" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 4);
    try testing.expectFieldOffset(&lv, &lv.v3, 8);
    try testing.expectOk(c.recv_Us_F_Us(.{ .v1 = 24992, .v2 = 0.757264, .v3 = 21045 }));
}
...
test "Us_F_Vp" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 4);
    try testing.expectFieldOffset(&lv, &lv.v3, 8);
    try testing.expectOk(c.recv_Us_F_Vp(.{ .v1 = 17908, .v2 = 0.237634, .v3 = null }));
}
...
test "Us_I_D" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 4);
    try testing.expectFieldOffset(&lv, &lv.v3, 8);
    try testing.expectOk(c.recv_Us_I_D(.{ .v1 = 8903, .v2 = 26042, .v3 = 5697 }));
}
...
test "Us_I_F" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 4);
    try testing.expectFieldOffset(&lv, &lv.v3, 8);
    try testing.expectOk(c.recv_Us_I_F(.{ .v1 = 20027, .v2 = 12274, .v3 = 0.008260 }));
}
...
test "Us_Ip_D" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, ABISELECT(8, 4));
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 8));
    try testing.expectOk(c.recv_Us_Ip_D(.{ .v1 = 32334, .v2 = null, .v3 = 14763 }));
}
...
test "Us_Ip_F" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, ABISELECT(8, 4));
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 8));
    try testing.expectOk(c.recv_Us_Ip_F(.{ .v1 = 19476, .v2 = null, .v3 = 0.966660 }));
}
...
test "Us_L_D" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, ABISELECT(8, 4));
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_Us_L_D(.{ .v1 = 23248, .v2 = 22734, .v3 = 10392 }));
}
...
test "Us_L_F" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, ABISELECT(8, 4));
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_Us_L_F(.{ .v1 = 24117, .v2 = 9201, .v3 = 0.231937 }));
}
...
test "Us_S_D" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 2);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(8, 4));
    try testing.expectOk(c.recv_Us_S_D(.{ .v1 = 23117, .v2 = 19592, .v3 = 2759 }));
}
...
test "Us_S_F" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 2);
    try testing.expectFieldOffset(&lv, &lv.v3, 4);
    try testing.expectOk(c.recv_Us_S_F(.{ .v1 = 15422, .v2 = 892, .v3 = 0.239607 }));
}
...
test "Us_Uc_D" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 2);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(8, 4));
    try testing.expectOk(c.recv_Us_Uc_D(.{ .v1 = 21665, .v2 = 0, .v3 = 16612 }));
}
...
test "Us_Uc_F" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 2);
    try testing.expectFieldOffset(&lv, &lv.v3, 4);
    try testing.expectOk(c.recv_Us_Uc_F(.{ .v1 = 30089, .v2 = 102, .v3 = 0.414114 }));
}
...
test "Us_Ui_D" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 4);
    try testing.expectFieldOffset(&lv, &lv.v3, 8);
    try testing.expectOk(c.recv_Us_Ui_D(.{ .v1 = 12024, .v2 = 26928, .v3 = 16062 }));
}
...
test "Us_Ui_F" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 4);
    try testing.expectFieldOffset(&lv, &lv.v3, 8);
    try testing.expectOk(c.recv_Us_Ui_F(.{ .v1 = 18149, .v2 = 22194, .v3 = 0.603340 }));
}
...
test "Us_Ul_D" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, ABISELECT(8, 4));
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_Us_Ul_D(.{ .v1 = 17927, .v2 = 8476, .v3 = 4996 }));
}
...
test "Us_Ul_F" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, ABISELECT(8, 4));
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_Us_Ul_F(.{ .v1 = 20120, .v2 = 14441, .v3 = 0.129207 }));
}
...
test "Us_Us_D" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 2);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(8, 4));
    try testing.expectOk(c.recv_Us_Us_D(.{ .v1 = 32400, .v2 = 24920, .v3 = 3975 }));
}
...
test "Us_Us_F" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 2);
    try testing.expectFieldOffset(&lv, &lv.v3, 4);
    try testing.expectOk(c.recv_Us_Us_F(.{ .v1 = 27252, .v2 = 23171, .v3 = 0.895366 }));
}
...
test "Us_Vp_D" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, ABISELECT(8, 4));
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 8));
    try testing.expectOk(c.recv_Us_Vp_D(.{ .v1 = 14615, .v2 = null, .v3 = 449 }));
}
...
test "Us_Vp_F" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, ABISELECT(8, 4));
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 8));
    try testing.expectOk(c.recv_Us_Vp_F(.{ .v1 = 25809, .v2 = null, .v3 = 0.186410 }));
}
