...
test "C_C_D" {
    ...
    try testing.expectOk(c.recv_C_C_D(.{ .v1 = 88, .v2 = 39, .v3 = 32308 }));
}
...
test "C_C_F" {
    ...
    try testing.expectOk(c.recv_C_C_F(.{ .v1 = 33, .v2 = 7, .v3 = 0.511624 }));
}
...
test "C_D" {
    ...
    try testing.expectOk(c.recv_C_D(.{ .v1 = 97, .v2 = 18101 }));
}
...
test "C_D_C" {
    ...
    try testing.expectOk(c.recv_C_D_C(.{ .v1 = 2, .v2 = 20702, .v3 = 100 }));
}
...
test "C_D_D" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, ABISELECT(8, 4));
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_C_D_D(.{ .v1 = 56, .v2 = 13293, .v3 = 21651 }));
}
...
test "C_D_F" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, ABISELECT(8, 4));
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_C_D_F(.{ .v1 = 127, .v2 = 10877, .v3 = 0.499996 }));
}
...
test "C_D_I" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, ABISELECT(8, 4));
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_C_D_I(.{ .v1 = 3, .v2 = 19706, .v3 = 15916 }));
}
...
test "C_D_Ip" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, ABISELECT(8, 4));
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_C_D_Ip(.{ .v1 = 9, .v2 = 4508, .v3 = null }));
}
...
test "C_D_L" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, ABISELECT(8, 4));
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_C_D_L(.{ .v1 = 78, .v2 = 23713, .v3 = 28909 }));
}
...
test "C_D_S" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, ABISELECT(8, 4));
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_C_D_S(.{ .v1 = 90, .v2 = 24730, .v3 = 1943 }));
}
...
test "C_D_Uc" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, ABISELECT(8, 4));
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_C_D_Uc(.{ .v1 = 75, .v2 = 8590, .v3 = 58 }));
}
...
test "C_D_Ui" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, ABISELECT(8, 4));
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_C_D_Ui(.{ .v1 = 77, .v2 = 28552, .v3 = 4531 }));
}
...
test "C_D_Ul" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, ABISELECT(8, 4));
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_C_D_Ul(.{ .v1 = 19, .v2 = 23467, .v3 = 9844 }));
}
...
test "C_D_Us" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, ABISELECT(8, 4));
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_C_D_Us(.{ .v1 = 103, .v2 = 5888, .v3 = 5008 }));
}
...
test "C_D_Vp" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, ABISELECT(8, 4));
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_C_D_Vp(.{ .v1 = 77, .v2 = 10706, .v3 = null }));
}
...
test "C_F" {
    ...
    try testing.expectOk(c.recv_C_F(.{ .v1 = 14, .v2 = 0.177833 }));
}
...
test "C_F_C" {
    ...
    try testing.expectOk(c.recv_C_F_C(.{ .v1 = 99, .v2 = 0.535278, .v3 = 40 }));
}
...
test "C_F_D" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 4);
    try testing.expectFieldOffset(&lv, &lv.v3, 8);
    try testing.expectOk(c.recv_C_F_D(.{ .v1 = 90, .v2 = 0.169041, .v3 = 9143 }));
}
...
test "C_F_F" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 4);
    try testing.expectFieldOffset(&lv, &lv.v3, 8);
    try testing.expectOk(c.recv_C_F_F(.{ .v1 = 39, .v2 = 0.040436, .v3 = 0.431444 }));
}
...
test "C_F_I" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 4);
    try testing.expectFieldOffset(&lv, &lv.v3, 8);
    try testing.expectOk(c.recv_C_F_I(.{ .v1 = 88, .v2 = 0.382923, .v3 = 18203 }));
}
...
test "C_F_Ip" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 4);
    try testing.expectFieldOffset(&lv, &lv.v3, 8);
    try testing.expectOk(c.recv_C_F_Ip(.{ .v1 = 2, .v2 = 0.230924, .v3 = null }));
}
...
test "C_F_L" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 4);
    try testing.expectFieldOffset(&lv, &lv.v3, 8);
    try testing.expectOk(c.recv_C_F_L(.{ .v1 = 125, .v2 = 0.166771, .v3 = 12277 }));
}
...
test "C_F_S" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 4);
    try testing.expectFieldOffset(&lv, &lv.v3, 8);
    try testing.expectOk(c.recv_C_F_S(.{ .v1 = 52, .v2 = 0.476667, .v3 = 13569 }));
}
...
test "C_F_Uc" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 4);
    try testing.expectFieldOffset(&lv, &lv.v3, 8);
    try testing.expectOk(c.recv_C_F_Uc(.{ .v1 = 115, .v2 = 0.323289, .v3 = 39 }));
}
...
test "C_F_Ui" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 4);
    try testing.expectFieldOffset(&lv, &lv.v3, 8);
    try testing.expectOk(c.recv_C_F_Ui(.{ .v1 = 11, .v2 = 0.092504, .v3 = 22476 }));
}
...
test "C_F_Ul" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 4);
    try testing.expectFieldOffset(&lv, &lv.v3, 8);
    try testing.expectOk(c.recv_C_F_Ul(.{ .v1 = 39, .v2 = 0.796463, .v3 = 10173 }));
}
...
test "C_F_Us" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 4);
    try testing.expectFieldOffset(&lv, &lv.v3, 8);
    try testing.expectOk(c.recv_C_F_Us(.{ .v1 = 89, .v2 = 0.385773, .v3 = 32571 }));
}
...
test "C_F_Vp" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 4);
    try testing.expectFieldOffset(&lv, &lv.v3, 8);
    try testing.expectOk(c.recv_C_F_Vp(.{ .v1 = 110, .v2 = 0.056370, .v3 = null }));
}
...
test "C_I_D" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 4);
    try testing.expectFieldOffset(&lv, &lv.v3, 8);
    try testing.expectOk(c.recv_C_I_D(.{ .v1 = 7, .v2 = 8195, .v3 = 21099 }));
}
...
test "C_I_F" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 4);
    try testing.expectFieldOffset(&lv, &lv.v3, 8);
    try testing.expectOk(c.recv_C_I_F(.{ .v1 = 26, .v2 = 19684, .v3 = 0.266619 }));
}
...
test "C_Ip_D" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, ABISELECT(8, 4));
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 8));
    try testing.expectOk(c.recv_C_Ip_D(.{ .v1 = 80, .v2 = null, .v3 = 2354 }));
}
...
test "C_Ip_F" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, ABISELECT(8, 4));
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 8));
    try testing.expectOk(c.recv_C_Ip_F(.{ .v1 = 52, .v2 = null, .v3 = 0.482881 }));
}
...
test "C_L_D" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, ABISELECT(8, 4));
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_C_L_D(.{ .v1 = 9, .v2 = 20523, .v3 = 12186 }));
}
...
test "C_L_F" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, ABISELECT(8, 4));
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_C_L_F(.{ .v1 = 9, .v2 = 8400, .v3 = 0.092918 }));
}
...
test "C_S_D" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 2);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(8, 4));
    try testing.expectOk(c.recv_C_S_D(.{ .v1 = 0, .v2 = 7071, .v3 = 1960 }));
}
...
test "C_S_F" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 2);
    try testing.expectFieldOffset(&lv, &lv.v3, 4);
    try testing.expectOk(c.recv_C_S_F(.{ .v1 = 26, .v2 = 17641, .v3 = 0.551370 }));
}
...
test "C_Uc_D" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 1);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(8, 4));
    try testing.expectOk(c.recv_C_Uc_D(.{ .v1 = 0, .v2 = 2, .v3 = 17658 }));
}
...
test "C_Uc_F" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 1);
    try testing.expectFieldOffset(&lv, &lv.v3, 4);
    try testing.expectOk(c.recv_C_Uc_F(.{ .v1 = 115, .v2 = 17, .v3 = 0.087453 }));
}
...
test "C_Ui_D" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 4);
    try testing.expectFieldOffset(&lv, &lv.v3, 8);
    try testing.expectOk(c.recv_C_Ui_D(.{ .v1 = 43, .v2 = 14137, .v3 = 51 }));
}
...
test "C_Ui_F" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 4);
    try testing.expectFieldOffset(&lv, &lv.v3, 8);
    try testing.expectOk(c.recv_C_Ui_F(.{ .v1 = 85, .v2 = 4041, .v3 = 0.406092 }));
}
...
test "C_Ul_D" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, ABISELECT(8, 4));
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_C_Ul_D(.{ .v1 = 87, .v2 = 21565, .v3 = 12992 }));
}
...
test "C_Ul_F" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, ABISELECT(8, 4));
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_C_Ul_F(.{ .v1 = 93, .v2 = 10370, .v3 = 0.409016 }));
}
...
test "C_Us_D" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 2);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(8, 4));
    try testing.expectOk(c.recv_C_Us_D(.{ .v1 = 79, .v2 = 16460, .v3 = 14173 }));
}
...
test "C_Us_F" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 2);
    try testing.expectFieldOffset(&lv, &lv.v3, 4);
    try testing.expectOk(c.recv_C_Us_F(.{ .v1 = 79, .v2 = 28080, .v3 = 0.214317 }));
}
...
test "C_Vp_D" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, ABISELECT(8, 4));
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 8));
    try testing.expectOk(c.recv_C_Vp_D(.{ .v1 = 8, .v2 = null, .v3 = 24459 }));
}
...
test "C_Vp_F" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, ABISELECT(8, 4));
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 8));
    try testing.expectOk(c.recv_C_Vp_F(.{ .v1 = 78, .v2 = null, .v3 = 0.324576 }));
}
...
test "D" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v1, 0);
    try testing.expectOk(c.recv_D(.{ .v1 = 5839 }));
}
...
test "D_C" {
    ...
    try testing.expectOk(c.recv_D_C(.{ .v1 = 9355, .v2 = 15 }));
}
...
test "D_C_C" {
    ...
    try testing.expectOk(c.recv_D_C_C(.{ .v1 = 12798, .v2 = 31, .v3 = 76 }));
}
...
test "D_C_D" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_D_C_D(.{ .v1 = 28891, .v2 = 98, .v3 = 20891 }));
}
...
test "D_C_F" {
    ...
    try testing.expectOk(c.recv_D_C_F(.{ .v1 = 21871, .v2 = 33, .v3 = 0.927364 }));
}
...
test "D_C_I" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 12);
    try testing.expectOk(c.recv_D_C_I(.{ .v1 = 6826, .v2 = 125, .v3 = 18046 }));
}
...
test "D_C_Ip" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_D_C_Ip(.{ .v1 = 18234, .v2 = 89, .v3 = null }));
}
...
test "D_C_L" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_D_C_L(.{ .v1 = 18181, .v2 = 119, .v3 = 22956 }));
}
...
test "D_C_S" {
    ...
    try testing.expectOk(c.recv_D_C_S(.{ .v1 = 21999, .v2 = 118, .v3 = 8349 }));
}
...
test "D_C_Uc" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 9);
    try testing.expectOk(c.recv_D_C_Uc(.{ .v1 = 14810, .v2 = 118, .v3 = 31 }));
}
...
test "D_C_Ui" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 12);
    try testing.expectOk(c.recv_D_C_Ui(.{ .v1 = 30089, .v2 = 17, .v3 = 10416 }));
}
...
test "D_C_Ul" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_D_C_Ul(.{ .v1 = 21401, .v2 = 66, .v3 = 2917 }));
}
...
test "D_C_Us" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 10);
    try testing.expectOk(c.recv_D_C_Us(.{ .v1 = 16306, .v2 = 98, .v3 = 19060 }));
}
...
test "D_C_Vp" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_D_C_Vp(.{ .v1 = 12837, .v2 = 16, .v3 = null }));
}
...
test "D_D" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v1, 0);
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectOk(c.recv_D_D(.{ .v1 = 26012, .v2 = 1296 }));
}
...
test "D_D_C" {
    ...
    try testing.expectOk(c.recv_D_D_C(.{ .v1 = 11779, .v2 = 20011, .v3 = 89 }));
}
...
test "D_D_D" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 16);
    try testing.expectOk(c.recv_D_D_D(.{ .v1 = 20543, .v2 = 469, .v3 = 27441 }));
}
...
test "D_D_F" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 16);
    try testing.expectOk(c.recv_D_D_F(.{ .v1 = 20616, .v2 = 9355, .v3 = 0.167530 }));
}
...
test "D_D_I" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 16);
    try testing.expectOk(c.recv_D_D_I(.{ .v1 = 12060, .v2 = 24331, .v3 = 2232 }));
}
...
test "D_D_Ip" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 16);
    try testing.expectOk(c.recv_D_D_Ip(.{ .v1 = 11747, .v2 = 1255, .v3 = null }));
}
...
test "D_D_L" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 16);
    try testing.expectOk(c.recv_D_D_L(.{ .v1 = 14076, .v2 = 25508, .v3 = 15942 }));
}
...
test "D_D_S" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 16);
    try testing.expectOk(c.recv_D_D_S(.{ .v1 = 19593, .v2 = 7177, .v3 = 12080 }));
}
...
test "D_D_Uc" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 16);
    try testing.expectOk(c.recv_D_D_Uc(.{ .v1 = 22341, .v2 = 4081, .v3 = 64 }));
}
...
test "D_D_Ui" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 16);
    try testing.expectOk(c.recv_D_D_Ui(.{ .v1 = 10449, .v2 = 12384, .v3 = 15554 }));
}
...
test "D_D_Ul" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 16);
    try testing.expectOk(c.recv_D_D_Ul(.{ .v1 = 11028, .v2 = 25509, .v3 = 23622 }));
}
...
test "D_D_Us" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 16);
    try testing.expectOk(c.recv_D_D_Us(.{ .v1 = 12415, .v2 = 6150, .v3 = 9732 }));
}
...
test "D_D_Vp" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 16);
    try testing.expectOk(c.recv_D_D_Vp(.{ .v1 = 27739, .v2 = 7911, .v3 = null }));
}
...
test "D_F" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v1, 0);
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectOk(c.recv_D_F(.{ .v1 = 7675, .v2 = 0.124116 }));
}
...
test "D_F_C" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 12);
    try testing.expectOk(c.recv_D_F_C(.{ .v1 = 13446, .v2 = 0.771217, .v3 = 36 }));
}
...
test "D_F_D" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_D_F_D(.{ .v1 = 6493, .v2 = 0.089876, .v3 = 31173 }));
}
...
test "D_F_F" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 12);
    try testing.expectOk(c.recv_D_F_F(.{ .v1 = 28235, .v2 = 0.722492, .v3 = 0.489337 }));
}
...
test "D_F_I" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 12);
    try testing.expectOk(c.recv_D_F_I(.{ .v1 = 28330, .v2 = 0.585788, .v3 = 23345 }));
}
...
test "D_F_Ip" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_D_F_Ip(.{ .v1 = 31113, .v2 = 0.105222, .v3 = null }));
}
...
test "D_F_L" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_D_F_L(.{ .v1 = 21541, .v2 = 0.758288, .v3 = 23080 }));
}
...
test "D_F_S" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 12);
    try testing.expectOk(c.recv_D_F_S(.{ .v1 = 4186, .v2 = 0.760959, .v3 = 20729 }));
}
...
test "D_F_Uc" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 12);
    try testing.expectOk(c.recv_D_F_Uc(.{ .v1 = 14213, .v2 = 0.456349, .v3 = 94 }));
}
...
test "D_F_Ui" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 12);
    try testing.expectOk(c.recv_D_F_Ui(.{ .v1 = 24934, .v2 = 0.978543, .v3 = 3927 }));
}
...
test "D_F_Ul" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_D_F_Ul(.{ .v1 = 8143, .v2 = 0.140109, .v3 = 13554 }));
}
...
test "D_F_Us" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 12);
    try testing.expectOk(c.recv_D_F_Us(.{ .v1 = 20824, .v2 = 0.053683, .v3 = 26232 }));
}
...
test "D_F_Vp" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_D_F_Vp(.{ .v1 = 26327, .v2 = 0.649073, .v3 = null }));
}
...
test "D_I" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v1, 0);
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectOk(c.recv_D_I(.{ .v1 = 18569, .v2 = 26277 }));
}
...
test "D_I_C" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 12);
    try testing.expectOk(c.recv_D_I_C(.{ .v1 = 27726, .v2 = 24024, .v3 = 99 }));
}
...
test "D_I_D" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_D_I_D(.{ .v1 = 30236, .v2 = 17480, .v3 = 11982 }));
}
...
test "D_I_F" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 12);
    try testing.expectOk(c.recv_D_I_F(.{ .v1 = 5029, .v2 = 26955, .v3 = 0.283459 }));
}
...
test "D_I_I" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 12);
    try testing.expectOk(c.recv_D_I_I(.{ .v1 = 13633, .v2 = 9829, .v3 = 9167 }));
}
...
test "D_I_Ip" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_D_I_Ip(.{ .v1 = 9051, .v2 = 32588, .v3 = null }));
}
...
test "D_I_L" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_D_I_L(.{ .v1 = 10995, .v2 = 18331, .v3 = 10784 }));
}
...
test "D_I_S" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 12);
    try testing.expectOk(c.recv_D_I_S(.{ .v1 = 1367, .v2 = 29861, .v3 = 13238 }));
}
...
test "D_I_Uc" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 12);
    try testing.expectOk(c.recv_D_I_Uc(.{ .v1 = 16193, .v2 = 19530, .v3 = 81 }));
}
...
test "D_I_Ui" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 12);
    try testing.expectOk(c.recv_D_I_Ui(.{ .v1 = 28901, .v2 = 31107, .v3 = 21469 }));
}
...
test "D_I_Ul" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_D_I_Ul(.{ .v1 = 32447, .v2 = 28274, .v3 = 28282 }));
}
...
test "D_I_Us" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 12);
    try testing.expectOk(c.recv_D_I_Us(.{ .v1 = 2743, .v2 = 14380, .v3 = 122 }));
}
...
test "D_I_Vp" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_D_I_Vp(.{ .v1 = 9870, .v2 = 9415, .v3 = null }));
}
...
test "D_Ip" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v1, 0);
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectOk(c.recv_D_Ip(.{ .v1 = 4776, .v2 = null }));
}
...
test "D_Ip_C" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_D_Ip_C(.{ .v1 = 23163, .v2 = null, .v3 = 55 }));
}
...
test "D_Ip_D" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_D_Ip_D(.{ .v1 = 23141, .v2 = null, .v3 = 10399 }));
}
...
test "D_Ip_F" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_D_Ip_F(.{ .v1 = 24184, .v2 = null, .v3 = 0.670757 }));
}
...
test "D_Ip_I" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_D_Ip_I(.{ .v1 = 11359, .v2 = null, .v3 = 25718 }));
}
...
test "D_Ip_Ip" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_D_Ip_Ip(.{ .v1 = 10301, .v2 = null, .v3 = null }));
}
...
test "D_Ip_L" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_D_Ip_L(.{ .v1 = 4292, .v2 = null, .v3 = 3369 }));
}
...
test "D_Ip_S" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_D_Ip_S(.{ .v1 = 3358, .v2 = null, .v3 = 14756 }));
}
...
test "D_Ip_Uc" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_D_Ip_Uc(.{ .v1 = 13220, .v2 = null, .v3 = 61 }));
}
...
test "D_Ip_Ui" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_D_Ip_Ui(.{ .v1 = 24999, .v2 = null, .v3 = 8332 }));
}
...
test "D_Ip_Ul" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_D_Ip_Ul(.{ .v1 = 15584, .v2 = null, .v3 = 22031 }));
}
...
test "D_Ip_Us" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_D_Ip_Us(.{ .v1 = 741, .v2 = null, .v3 = 15730 }));
}
...
test "D_Ip_Vp" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_D_Ip_Vp(.{ .v1 = 25818, .v2 = null, .v3 = null }));
}
...
test "D_L" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v1, 0);
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectOk(c.recv_D_L(.{ .v1 = 9582, .v2 = 17595 }));
}
...
test "D_L_C" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 16);
    try testing.expectOk(c.recv_D_L_C(.{ .v1 = 18867, .v2 = 19616, .v3 = 93 }));
}
...
test "D_L_D" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 16);
    try testing.expectOk(c.recv_D_L_D(.{ .v1 = 11130, .v2 = 21051, .v3 = 6384 }));
}
...
test "D_L_F" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 16);
    try testing.expectOk(c.recv_D_L_F(.{ .v1 = 31649, .v2 = 30914, .v3 = 0.445666 }));
}
...
test "D_L_I" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 16);
    try testing.expectOk(c.recv_D_L_I(.{ .v1 = 27973, .v2 = 14517, .v3 = 8201 }));
}
...
test "D_L_Ip" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 16);
    try testing.expectOk(c.recv_D_L_Ip(.{ .v1 = 2103, .v2 = 3359, .v3 = null }));
}
...
test "D_L_L" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 16);
    try testing.expectOk(c.recv_D_L_L(.{ .v1 = 10808, .v2 = 31346, .v3 = 3876 }));
}
...
test "D_L_S" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 16);
    try testing.expectOk(c.recv_D_L_S(.{ .v1 = 11502, .v2 = 16315, .v3 = 21858 }));
}
...
test "D_L_Uc" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 16);
    try testing.expectOk(c.recv_D_L_Uc(.{ .v1 = 22119, .v2 = 20559, .v3 = 102 }));
}
...
test "D_L_Ui" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 16);
    try testing.expectOk(c.recv_D_L_Ui(.{ .v1 = 17125, .v2 = 8313, .v3 = 3717 }));
}
...
test "D_L_Ul" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 16);
    try testing.expectOk(c.recv_D_L_Ul(.{ .v1 = 22788, .v2 = 1950, .v3 = 15311 }));
}
...
test "D_L_Us" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 16);
    try testing.expectOk(c.recv_D_L_Us(.{ .v1 = 14381, .v2 = 29145, .v3 = 11800 }));
}
...
test "D_L_Vp" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 16);
    try testing.expectOk(c.recv_D_L_Vp(.{ .v1 = 30929, .v2 = 1736, .v3 = null }));
}
...
test "D_S" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v1, 0);
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectOk(c.recv_D_S(.{ .v1 = 31554, .v2 = 18963 }));
}
...
test "D_S_C" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 10);
    try testing.expectOk(c.recv_D_S_C(.{ .v1 = 29555, .v2 = 111, .v3 = 38 }));
}
...
test "D_S_D" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_D_S_D(.{ .v1 = 32408, .v2 = 7651, .v3 = 14431 }));
}
...
test "D_S_F" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 12);
    try testing.expectOk(c.recv_D_S_F(.{ .v1 = 10925, .v2 = 3713, .v3 = 0.495561 }));
}
...
test "D_S_I" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 12);
    try testing.expectOk(c.recv_D_S_I(.{ .v1 = 6114, .v2 = 23805, .v3 = 4950 }));
}
...
test "D_S_Ip" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_D_S_Ip(.{ .v1 = 5572, .v2 = 18312, .v3 = null }));
}
...
test "D_S_L" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_D_S_L(.{ .v1 = 29169, .v2 = 11847, .v3 = 9943 }));
}
...
test "D_S_S" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 10);
    try testing.expectOk(c.recv_D_S_S(.{ .v1 = 1598, .v2 = 29071, .v3 = 28225 }));
}
...
test "D_S_Uc" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 10);
    try testing.expectOk(c.recv_D_S_Uc(.{ .v1 = 1535, .v2 = 5195, .v3 = 68 }));
}
...
test "D_S_Ui" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 12);
    try testing.expectOk(c.recv_D_S_Ui(.{ .v1 = 23406, .v2 = 7690, .v3 = 692 }));
}
...
test "D_S_Ul" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_D_S_Ul(.{ .v1 = 3705, .v2 = 27905, .v3 = 13576 }));
}
...
test "D_S_Us" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 10);
    try testing.expectOk(c.recv_D_S_Us(.{ .v1 = 23576, .v2 = 1855, .v3 = 309 }));
}
...
test "D_S_Vp" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_D_S_Vp(.{ .v1 = 16455, .v2 = 29327, .v3 = null }));
}
...
test "D_Uc" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v1, 0);
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectOk(c.recv_D_Uc(.{ .v1 = 20171, .v2 = 121 }));
}
...
test "D_Uc_C" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 9);
    try testing.expectOk(c.recv_D_Uc_C(.{ .v1 = 26480, .v2 = 68, .v3 = 42 }));
}
...
test "D_Uc_D" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_D_Uc_D(.{ .v1 = 15090, .v2 = 68, .v3 = 28405 }));
}
...
test "D_Uc_F" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 12);
    try testing.expectOk(c.recv_D_Uc_F(.{ .v1 = 10574, .v2 = 110, .v3 = 0.165293 }));
}
...
test "D_Uc_I" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 12);
    try testing.expectOk(c.recv_D_Uc_I(.{ .v1 = 24131, .v2 = 32, .v3 = 18397 }));
}
...
test "D_Uc_Ip" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_D_Uc_Ip(.{ .v1 = 27680, .v2 = 71, .v3 = null }));
}
...
test "D_Uc_L" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_D_Uc_L(.{ .v1 = 3138, .v2 = 108, .v3 = 2176 }));
}
...
test "D_Uc_S" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 10);
    try testing.expectOk(c.recv_D_Uc_S(.{ .v1 = 26227, .v2 = 48, .v3 = 3198 }));
}
...
test "D_Uc_Uc" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 9);
    try testing.expectOk(c.recv_D_Uc_Uc(.{ .v1 = 29666, .v2 = 90, .v3 = 80 }));
}
...
test "D_Uc_Ui" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 12);
    try testing.expectOk(c.recv_D_Uc_Ui(.{ .v1 = 30025, .v2 = 23, .v3 = 23558 }));
}
...
test "D_Uc_Ul" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_D_Uc_Ul(.{ .v1 = 14099, .v2 = 43, .v3 = 31285 }));
}
...
test "D_Uc_Us" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 10);
    try testing.expectOk(c.recv_D_Uc_Us(.{ .v1 = 30733, .v2 = 0, .v3 = 14643 }));
}
...
test "D_Uc_Vp" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_D_Uc_Vp(.{ .v1 = 13159, .v2 = 32, .v3 = null }));
}
...
test "D_Ui" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v1, 0);
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectOk(c.recv_D_Ui(.{ .v1 = 5341, .v2 = 26877 }));
}
...
test "D_Ui_C" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 12);
    try testing.expectOk(c.recv_D_Ui_C(.{ .v1 = 7695, .v2 = 24570, .v3 = 98 }));
}
...
test "D_Ui_D" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_D_Ui_D(.{ .v1 = 26745, .v2 = 9641, .v3 = 599 }));
}
...
test "D_Ui_F" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 12);
    try testing.expectOk(c.recv_D_Ui_F(.{ .v1 = 20010, .v2 = 12198, .v3 = 0.845972 }));
}
...
test "D_Ui_I" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 12);
    try testing.expectOk(c.recv_D_Ui_I(.{ .v1 = 12899, .v2 = 24900, .v3 = 31103 }));
}
...
test "D_Ui_Ip" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_D_Ui_Ip(.{ .v1 = 20869, .v2 = 12576, .v3 = null }));
}
...
test "D_Ui_L" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_D_Ui_L(.{ .v1 = 31648, .v2 = 6157, .v3 = 25399 }));
}
...
test "D_Ui_S" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 12);
    try testing.expectOk(c.recv_D_Ui_S(.{ .v1 = 13194, .v2 = 2768, .v3 = 15715 }));
}
...
test "D_Ui_Uc" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 12);
    try testing.expectOk(c.recv_D_Ui_Uc(.{ .v1 = 17150, .v2 = 15470, .v3 = 14 }));
}
...
test "D_Ui_Ui" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 12);
    try testing.expectOk(c.recv_D_Ui_Ui(.{ .v1 = 21485, .v2 = 25183, .v3 = 5118 }));
}
...
test "D_Ui_Ul" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_D_Ui_Ul(.{ .v1 = 11539, .v2 = 14606, .v3 = 16268 }));
}
...
test "D_Ui_Us" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 12);
    try testing.expectOk(c.recv_D_Ui_Us(.{ .v1 = 8347, .v2 = 5295, .v3 = 5718 }));
}
...
test "D_Ui_Vp" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_D_Ui_Vp(.{ .v1 = 12447, .v2 = 31290, .v3 = null }));
}
...
test "D_Ul" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v1, 0);
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectOk(c.recv_D_Ul(.{ .v1 = 4326, .v2 = 8168 }));
}
...
test "D_Ul_C" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 16);
    try testing.expectOk(c.recv_D_Ul_C(.{ .v1 = 1526, .v2 = 27350, .v3 = 87 }));
}
...
test "D_Ul_D" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 16);
    try testing.expectOk(c.recv_D_Ul_D(.{ .v1 = 587, .v2 = 8341, .v3 = 14333 }));
}
...
test "D_Ul_F" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 16);
    try testing.expectOk(c.recv_D_Ul_F(.{ .v1 = 28666, .v2 = 6850, .v3 = 0.364401 }));
}
...
test "D_Ul_I" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 16);
    try testing.expectOk(c.recv_D_Ul_I(.{ .v1 = 17316, .v2 = 27169, .v3 = 3839 }));
}
...
test "D_Ul_Ip" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 16);
    try testing.expectOk(c.recv_D_Ul_Ip(.{ .v1 = 30080, .v2 = 23667, .v3 = null }));
}
...
test "D_Ul_L" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 16);
    try testing.expectOk(c.recv_D_Ul_L(.{ .v1 = 2358, .v2 = 13997, .v3 = 5738 }));
}
...
test "D_Ul_S" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 16);
    try testing.expectOk(c.recv_D_Ul_S(.{ .v1 = 6465, .v2 = 8874, .v3 = 15227 }));
}
...
test "D_Ul_Uc" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 16);
    try testing.expectOk(c.recv_D_Ul_Uc(.{ .v1 = 3449, .v2 = 28411, .v3 = 19 }));
}
...
test "D_Ul_Ui" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 16);
    try testing.expectOk(c.recv_D_Ul_Ui(.{ .v1 = 3006, .v2 = 18969, .v3 = 19676 }));
}
...
test "D_Ul_Ul" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 16);
    try testing.expectOk(c.recv_D_Ul_Ul(.{ .v1 = 6844, .v2 = 30271, .v3 = 30455 }));
}
...
test "D_Ul_Us" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 16);
    try testing.expectOk(c.recv_D_Ul_Us(.{ .v1 = 27872, .v2 = 13199, .v3 = 7103 }));
}
...
test "D_Ul_Vp" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 16);
    try testing.expectOk(c.recv_D_Ul_Vp(.{ .v1 = 25571, .v2 = 12549, .v3 = null }));
}
...
test "D_Us" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v1, 0);
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectOk(c.recv_D_Us(.{ .v1 = 335, .v2 = 12975 }));
}
...
test "D_Us_C" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 10);
    try testing.expectOk(c.recv_D_Us_C(.{ .v1 = 5965, .v2 = 17159, .v3 = 57 }));
}
...
test "D_Us_D" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_D_Us_D(.{ .v1 = 11426, .v2 = 20555, .v3 = 17844 }));
}
...
test "D_Us_F" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 12);
    try testing.expectOk(c.recv_D_Us_F(.{ .v1 = 27988, .v2 = 4636, .v3 = 0.000951 }));
}
...
test "D_Us_I" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 12);
    try testing.expectOk(c.recv_D_Us_I(.{ .v1 = 13392, .v2 = 24377, .v3 = 30464 }));
}
...
test "D_Us_Ip" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_D_Us_Ip(.{ .v1 = 8479, .v2 = 5590, .v3 = null }));
}
...
test "D_Us_L" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_D_Us_L(.{ .v1 = 15583, .v2 = 10458, .v3 = 4437 }));
}
...
test "D_Us_S" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 10);
    try testing.expectOk(c.recv_D_Us_S(.{ .v1 = 18238, .v2 = 13155, .v3 = 13661 }));
}
...
test "D_Us_Uc" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 10);
    try testing.expectOk(c.recv_D_Us_Uc(.{ .v1 = 21067, .v2 = 2760, .v3 = 85 }));
}
...
test "D_Us_Ui" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 12);
    try testing.expectOk(c.recv_D_Us_Ui(.{ .v1 = 28382, .v2 = 27699, .v3 = 17975 }));
}
...
test "D_Us_Ul" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_D_Us_Ul(.{ .v1 = 14224, .v2 = 23309, .v3 = 10756 }));
}
...
test "D_Us_Us" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 10);
    try testing.expectOk(c.recv_D_Us_Us(.{ .v1 = 21486, .v2 = 21806, .v3 = 21300 }));
}
...
test "D_Us_Vp" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_D_Us_Vp(.{ .v1 = 32544, .v2 = 5932, .v3 = null }));
}
...
test "D_Vp" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v1, 0);
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectOk(c.recv_D_Vp(.{ .v1 = 1062, .v2 = null }));
}
...
test "D_Vp_C" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_D_Vp_C(.{ .v1 = 5177, .v2 = null, .v3 = 83 }));
}
...
test "D_Vp_D" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_D_Vp_D(.{ .v1 = 16667, .v2 = null, .v3 = 21736 }));
}
...
test "D_Vp_F" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_D_Vp_F(.{ .v1 = 2895, .v2 = null, .v3 = 0.993388 }));
}
...
test "D_Vp_I" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_D_Vp_I(.{ .v1 = 16435, .v2 = null, .v3 = 6491 }));
}
...
test "D_Vp_Ip" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_D_Vp_Ip(.{ .v1 = 21051, .v2 = null, .v3 = null }));
}
...
test "D_Vp_L" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_D_Vp_L(.{ .v1 = 32159, .v2 = null, .v3 = 18766 }));
}
...
test "D_Vp_S" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_D_Vp_S(.{ .v1 = 4705, .v2 = null, .v3 = 29007 }));
}
...
test "D_Vp_Uc" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_D_Vp_Uc(.{ .v1 = 16970, .v2 = null, .v3 = 103 }));
}
...
test "D_Vp_Ui" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_D_Vp_Ui(.{ .v1 = 30501, .v2 = null, .v3 = 21260 }));
}
...
test "D_Vp_Ul" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_D_Vp_Ul(.{ .v1 = 14614, .v2 = null, .v3 = 29514 }));
}
...
test "D_Vp_Us" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_D_Vp_Us(.{ .v1 = 26190, .v2 = null, .v3 = 19406 }));
}
...
test "D_Vp_Vp" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_D_Vp_Vp(.{ .v1 = 1077, .v2 = null, .v3 = null }));
}
...
test "F" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v1, 0);
    try testing.expectOk(c.recv_F(.{ .v1 = 0.687009 }));
}
