...
test "Sf_C: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_C(c.ret_Sf_C()));
}
...
test "Sf_C_C: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_C_C(c.ret_Sf_C_C()));
}
...
test "Sf_C_D: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_C_D(c.ret_Sf_C_D()));
}
...
test "Sf_C_F: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_C_F(c.ret_Sf_C_F()));
}
...
test "Sf_C_I: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_C_I(c.ret_Sf_C_I()));
}
...
test "Sf_C_Ip: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_C_Ip(c.ret_Sf_C_Ip()));
}
...
test "Sf_C_L: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_C_L(c.ret_Sf_C_L()));
}
...
test "Sf_C_S: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_C_S(c.ret_Sf_C_S()));
}
...
test "Sf_C_Sf: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_C_Sf(c.ret_Sf_C_Sf()));
}
...
test "Sf_C_Uc: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_C_Uc(c.ret_Sf_C_Uc()));
}
...
test "Sf_C_Ui: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_C_Ui(c.ret_Sf_C_Ui()));
}
...
test "Sf_C_Ul: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_C_Ul(c.ret_Sf_C_Ul()));
}
...
test "Sf_C_Us: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_C_Us(c.ret_Sf_C_Us()));
}
...
test "Sf_C_Vp: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_C_Vp(c.ret_Sf_C_Vp()));
}
...
test "Sf_D: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_D(c.ret_Sf_D()));
}
...
test "Sf_D_C: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_D_C(c.ret_Sf_D_C()));
}
...
test "Sf_D_D: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_D_D(c.ret_Sf_D_D()));
}
...
test "Sf_D_F: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_D_F(c.ret_Sf_D_F()));
}
...
test "Sf_D_I: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_D_I(c.ret_Sf_D_I()));
}
...
test "Sf_D_Ip: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_D_Ip(c.ret_Sf_D_Ip()));
}
...
test "Sf_D_L: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_D_L(c.ret_Sf_D_L()));
}
...
test "Sf_D_S: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_D_S(c.ret_Sf_D_S()));
}
...
test "Sf_D_Sf: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_D_Sf(c.ret_Sf_D_Sf()));
}
...
test "Sf_D_Uc: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_D_Uc(c.ret_Sf_D_Uc()));
}
...
test "Sf_D_Ui: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_D_Ui(c.ret_Sf_D_Ui()));
}
...
test "Sf_D_Ul: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_D_Ul(c.ret_Sf_D_Ul()));
}
...
test "Sf_D_Us: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_D_Us(c.ret_Sf_D_Us()));
}
...
test "Sf_D_Vp: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_D_Vp(c.ret_Sf_D_Vp()));
}
...
test "Sf_F: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_F(c.ret_Sf_F()));
}
...
test "Sf_F_C: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_F_C(c.ret_Sf_F_C()));
}
...
test "Sf_F_D: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_F_D(c.ret_Sf_F_D()));
}
...
test "Sf_F_F: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_F_F(c.ret_Sf_F_F()));
}
...
test "Sf_F_I: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_F_I(c.ret_Sf_F_I()));
}
...
test "Sf_F_Ip: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_F_Ip(c.ret_Sf_F_Ip()));
}
...
test "Sf_F_L: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_F_L(c.ret_Sf_F_L()));
}
...
test "Sf_F_S: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_F_S(c.ret_Sf_F_S()));
}
...
test "Sf_F_Sf: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_F_Sf(c.ret_Sf_F_Sf()));
}
...
test "Sf_F_Uc: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_F_Uc(c.ret_Sf_F_Uc()));
}
...
test "Sf_F_Ui: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_F_Ui(c.ret_Sf_F_Ui()));
}
...
test "Sf_F_Ul: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_F_Ul(c.ret_Sf_F_Ul()));
}
...
test "Sf_F_Us: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_F_Us(c.ret_Sf_F_Us()));
}
...
test "Sf_F_Vp: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_F_Vp(c.ret_Sf_F_Vp()));
}
...
test "Sf_I: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_I(c.ret_Sf_I()));
}
...
test "Sf_I_C: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_I_C(c.ret_Sf_I_C()));
}
...
test "Sf_I_D: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_I_D(c.ret_Sf_I_D()));
}
...
test "Sf_I_F: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_I_F(c.ret_Sf_I_F()));
}
...
test "Sf_I_I: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_I_I(c.ret_Sf_I_I()));
}
...
test "Sf_I_Ip: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_I_Ip(c.ret_Sf_I_Ip()));
}
...
test "Sf_I_L: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_I_L(c.ret_Sf_I_L()));
}
...
test "Sf_I_S: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_I_S(c.ret_Sf_I_S()));
}
...
test "Sf_I_Sf: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_I_Sf(c.ret_Sf_I_Sf()));
}
...
test "Sf_I_Uc: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_I_Uc(c.ret_Sf_I_Uc()));
}
...
test "Sf_I_Ui: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_I_Ui(c.ret_Sf_I_Ui()));
}
...
test "Sf_I_Ul: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_I_Ul(c.ret_Sf_I_Ul()));
}
...
test "Sf_I_Us: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_I_Us(c.ret_Sf_I_Us()));
}
...
test "Sf_I_Vp: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_I_Vp(c.ret_Sf_I_Vp()));
}
...
test "Sf_Ip: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Ip(c.ret_Sf_Ip()));
}
...
test "Sf_Ip_C: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Ip_C(c.ret_Sf_Ip_C()));
}
...
test "Sf_Ip_D: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Ip_D(c.ret_Sf_Ip_D()));
}
...
test "Sf_Ip_F: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Ip_F(c.ret_Sf_Ip_F()));
}
...
test "Sf_Ip_I: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Ip_I(c.ret_Sf_Ip_I()));
}
...
test "Sf_Ip_Ip: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Ip_Ip(c.ret_Sf_Ip_Ip()));
}
...
test "Sf_Ip_L: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Ip_L(c.ret_Sf_Ip_L()));
}
...
test "Sf_Ip_S: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Ip_S(c.ret_Sf_Ip_S()));
}
...
test "Sf_Ip_Sf: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Ip_Sf(c.ret_Sf_Ip_Sf()));
}
...
test "Sf_Ip_Uc: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Ip_Uc(c.ret_Sf_Ip_Uc()));
}
...
test "Sf_Ip_Ui: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Ip_Ui(c.ret_Sf_Ip_Ui()));
}
...
test "Sf_Ip_Ul: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Ip_Ul(c.ret_Sf_Ip_Ul()));
}
...
test "Sf_Ip_Us: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Ip_Us(c.ret_Sf_Ip_Us()));
}
...
test "Sf_Ip_Vp: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Ip_Vp(c.ret_Sf_Ip_Vp()));
}
...
test "Sf_L: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_L(c.ret_Sf_L()));
}
...
test "Sf_L_C: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_L_C(c.ret_Sf_L_C()));
}
...
test "Sf_L_D: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_L_D(c.ret_Sf_L_D()));
}
...
test "Sf_L_F: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_L_F(c.ret_Sf_L_F()));
}
...
test "Sf_L_I: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_L_I(c.ret_Sf_L_I()));
}
...
test "Sf_L_Ip: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_L_Ip(c.ret_Sf_L_Ip()));
}
...
test "Sf_L_L: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_L_L(c.ret_Sf_L_L()));
}
...
test "Sf_L_S: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_L_S(c.ret_Sf_L_S()));
}
...
test "Sf_L_Sf: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_L_Sf(c.ret_Sf_L_Sf()));
}
...
test "Sf_L_Uc: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_L_Uc(c.ret_Sf_L_Uc()));
}
...
test "Sf_L_Ui: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_L_Ui(c.ret_Sf_L_Ui()));
}
...
test "Sf_L_Ul: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_L_Ul(c.ret_Sf_L_Ul()));
}
...
test "Sf_L_Us: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_L_Us(c.ret_Sf_L_Us()));
}
...
test "Sf_L_Vp: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_L_Vp(c.ret_Sf_L_Vp()));
}
...
test "Sf_S: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_S(c.ret_Sf_S()));
}
...
test "Sf_S_C: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_S_C(c.ret_Sf_S_C()));
}
...
test "Sf_S_D: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_S_D(c.ret_Sf_S_D()));
}
...
test "Sf_S_F: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_S_F(c.ret_Sf_S_F()));
}
...
test "Sf_S_I: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_S_I(c.ret_Sf_S_I()));
}
...
test "Sf_S_Ip: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_S_Ip(c.ret_Sf_S_Ip()));
}
...
test "Sf_S_L: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_S_L(c.ret_Sf_S_L()));
}
...
test "Sf_S_S: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_S_S(c.ret_Sf_S_S()));
}
...
test "Sf_S_Sf: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_S_Sf(c.ret_Sf_S_Sf()));
}
...
test "Sf_S_Uc: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_S_Uc(c.ret_Sf_S_Uc()));
}
...
test "Sf_S_Ui: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_S_Ui(c.ret_Sf_S_Ui()));
}
...
test "Sf_S_Ul: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_S_Ul(c.ret_Sf_S_Ul()));
}
...
test "Sf_S_Us: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_S_Us(c.ret_Sf_S_Us()));
}
...
test "Sf_S_Vp: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_S_Vp(c.ret_Sf_S_Vp()));
}
...
test "Sf_Sf: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Sf(c.ret_Sf_Sf()));
}
...
test "Sf_Sf_C: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Sf_C(c.ret_Sf_Sf_C()));
}
...
test "Sf_Sf_D: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Sf_D(c.ret_Sf_Sf_D()));
}
...
test "Sf_Sf_F: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Sf_F(c.ret_Sf_Sf_F()));
}
...
test "Sf_Sf_I: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Sf_I(c.ret_Sf_Sf_I()));
}
...
test "Sf_Sf_Ip: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Sf_Ip(c.ret_Sf_Sf_Ip()));
}
...
test "Sf_Sf_L: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Sf_L(c.ret_Sf_Sf_L()));
}
...
test "Sf_Sf_S: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Sf_S(c.ret_Sf_Sf_S()));
}
...
test "Sf_Sf_Sf: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Sf_Sf(c.ret_Sf_Sf_Sf()));
}
...
test "Sf_Sf_Uc: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Sf_Uc(c.ret_Sf_Sf_Uc()));
}
...
test "Sf_Sf_Ui: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Sf_Ui(c.ret_Sf_Sf_Ui()));
}
...
test "Sf_Sf_Ul: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Sf_Ul(c.ret_Sf_Sf_Ul()));
}
...
test "Sf_Sf_Us: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Sf_Us(c.ret_Sf_Sf_Us()));
}
...
test "Sf_Sf_Vp: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Sf_Vp(c.ret_Sf_Sf_Vp()));
}
...
test "Sf_Uc: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Uc(c.ret_Sf_Uc()));
}
...
test "Sf_Uc_C: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Uc_C(c.ret_Sf_Uc_C()));
}
...
test "Sf_Uc_D: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Uc_D(c.ret_Sf_Uc_D()));
}
...
test "Sf_Uc_F: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Uc_F(c.ret_Sf_Uc_F()));
}
...
test "Sf_Uc_I: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Uc_I(c.ret_Sf_Uc_I()));
}
...
test "Sf_Uc_Ip: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Uc_Ip(c.ret_Sf_Uc_Ip()));
}
...
test "Sf_Uc_L: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Uc_L(c.ret_Sf_Uc_L()));
}
...
test "Sf_Uc_S: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Uc_S(c.ret_Sf_Uc_S()));
}
...
test "Sf_Uc_Sf: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Uc_Sf(c.ret_Sf_Uc_Sf()));
}
...
test "Sf_Uc_Uc: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Uc_Uc(c.ret_Sf_Uc_Uc()));
}
...
test "Sf_Uc_Ui: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Uc_Ui(c.ret_Sf_Uc_Ui()));
}
...
test "Sf_Uc_Ul: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Uc_Ul(c.ret_Sf_Uc_Ul()));
}
...
test "Sf_Uc_Us: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Uc_Us(c.ret_Sf_Uc_Us()));
}
...
test "Sf_Uc_Vp: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Uc_Vp(c.ret_Sf_Uc_Vp()));
}
...
test "Sf_Ui: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Ui(c.ret_Sf_Ui()));
}
...
test "Sf_Ui_C: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Ui_C(c.ret_Sf_Ui_C()));
}
...
test "Sf_Ui_D: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Ui_D(c.ret_Sf_Ui_D()));
}
...
test "Sf_Ui_F: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Ui_F(c.ret_Sf_Ui_F()));
}
...
test "Sf_Ui_I: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Ui_I(c.ret_Sf_Ui_I()));
}
...
test "Sf_Ui_Ip: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Ui_Ip(c.ret_Sf_Ui_Ip()));
}
...
test "Sf_Ui_L: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Ui_L(c.ret_Sf_Ui_L()));
}
...
test "Sf_Ui_S: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Ui_S(c.ret_Sf_Ui_S()));
}
...
test "Sf_Ui_Sf: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Ui_Sf(c.ret_Sf_Ui_Sf()));
}
...
test "Sf_Ui_Uc: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Ui_Uc(c.ret_Sf_Ui_Uc()));
}
...
test "Sf_Ui_Ui: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Ui_Ui(c.ret_Sf_Ui_Ui()));
}
...
test "Sf_Ui_Ul: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Ui_Ul(c.ret_Sf_Ui_Ul()));
}
...
test "Sf_Ui_Us: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Ui_Us(c.ret_Sf_Ui_Us()));
}
...
test "Sf_Ui_Vp: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Ui_Vp(c.ret_Sf_Ui_Vp()));
}
...
test "Sf_Ul: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Ul(c.ret_Sf_Ul()));
}
...
test "Sf_Ul_C: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Ul_C(c.ret_Sf_Ul_C()));
}
...
test "Sf_Ul_D: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Ul_D(c.ret_Sf_Ul_D()));
}
...
test "Sf_Ul_F: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Ul_F(c.ret_Sf_Ul_F()));
}
...
test "Sf_Ul_I: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Ul_I(c.ret_Sf_Ul_I()));
}
...
test "Sf_Ul_Ip: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Ul_Ip(c.ret_Sf_Ul_Ip()));
}
...
test "Sf_Ul_L: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Ul_L(c.ret_Sf_Ul_L()));
}
...
test "Sf_Ul_S: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Ul_S(c.ret_Sf_Ul_S()));
}
...
test "Sf_Ul_Sf: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Ul_Sf(c.ret_Sf_Ul_Sf()));
}
...
test "Sf_Ul_Uc: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Ul_Uc(c.ret_Sf_Ul_Uc()));
}
...
test "Sf_Ul_Ui: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Ul_Ui(c.ret_Sf_Ul_Ui()));
}
...
test "Sf_Ul_Ul: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Ul_Ul(c.ret_Sf_Ul_Ul()));
}
...
test "Sf_Ul_Us: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Ul_Us(c.ret_Sf_Ul_Us()));
}
...
test "Sf_Ul_Vp: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Ul_Vp(c.ret_Sf_Ul_Vp()));
}
...
test "Sf_Us: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Us(c.ret_Sf_Us()));
}
...
test "Sf_Us_C: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Us_C(c.ret_Sf_Us_C()));
}
...
test "Sf_Us_D: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Us_D(c.ret_Sf_Us_D()));
}
...
test "Sf_Us_F: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Us_F(c.ret_Sf_Us_F()));
}
...
test "Sf_Us_I: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Us_I(c.ret_Sf_Us_I()));
}
...
test "Sf_Us_Ip: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Us_Ip(c.ret_Sf_Us_Ip()));
}
...
test "Sf_Us_L: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Us_L(c.ret_Sf_Us_L()));
}
...
test "Sf_Us_S: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Us_S(c.ret_Sf_Us_S()));
}
...
test "Sf_Us_Sf: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Us_Sf(c.ret_Sf_Us_Sf()));
}
...
test "Sf_Us_Uc: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Us_Uc(c.ret_Sf_Us_Uc()));
}
...
test "Sf_Us_Ui: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Us_Ui(c.ret_Sf_Us_Ui()));
}
...
test "Sf_Us_Ul: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Us_Ul(c.ret_Sf_Us_Ul()));
}
...
test "Sf_Us_Us: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Us_Us(c.ret_Sf_Us_Us()));
}
...
test "Sf_Us_Vp: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Us_Vp(c.ret_Sf_Us_Vp()));
}
...
test "Sf_Vp: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Vp(c.ret_Sf_Vp()));
}
...
test "Sf_Vp_C: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Vp_C(c.ret_Sf_Vp_C()));
}
...
test "Sf_Vp_D: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Vp_D(c.ret_Sf_Vp_D()));
}
...
test "Sf_Vp_F: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Vp_F(c.ret_Sf_Vp_F()));
}
...
test "Sf_Vp_I: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Vp_I(c.ret_Sf_Vp_I()));
}
...
test "Sf_Vp_Ip: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Vp_Ip(c.ret_Sf_Vp_Ip()));
}
...
test "Sf_Vp_L: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Vp_L(c.ret_Sf_Vp_L()));
}
...
test "Sf_Vp_S: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Vp_S(c.ret_Sf_Vp_S()));
}
...
test "Sf_Vp_Sf: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Vp_Sf(c.ret_Sf_Vp_Sf()));
}
...
test "Sf_Vp_Uc: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Vp_Uc(c.ret_Sf_Vp_Uc()));
}
...
test "Sf_Vp_Ui: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Vp_Ui(c.ret_Sf_Vp_Ui()));
}
...
test "Sf_Vp_Ul: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Vp_Ul(c.ret_Sf_Vp_Ul()));
}
...
test "Sf_Vp_Us: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Vp_Us(c.ret_Sf_Vp_Us()));
}
...
test "Sf_Vp_Vp: C returns to Zig" {
    try testing.expectOk(zig_assert_Sf_Vp_Vp(c.ret_Sf_Vp_Vp()));
}
...
test "Uc_C_Sf: C returns to Zig" {
    try testing.expectOk(zig_assert_Uc_C_Sf(c.ret_Uc_C_Sf()));
}
...
test "Uc_D_Sf: C returns to Zig" {
    try testing.expectOk(zig_assert_Uc_D_Sf(c.ret_Uc_D_Sf()));
}
...
test "Uc_F_Sf: C returns to Zig" {
    try testing.expectOk(zig_assert_Uc_F_Sf(c.ret_Uc_F_Sf()));
}
...
test "Uc_I_Sf: C returns to Zig" {
    try testing.expectOk(zig_assert_Uc_I_Sf(c.ret_Uc_I_Sf()));
}
...
test "Uc_Ip_Sf: C returns to Zig" {
    try testing.expectOk(zig_assert_Uc_Ip_Sf(c.ret_Uc_Ip_Sf()));
}
...
test "Uc_L_Sf: C returns to Zig" {
    try testing.expectOk(zig_assert_Uc_L_Sf(c.ret_Uc_L_Sf()));
}
...
test "Uc_S_Sf: C returns to Zig" {
    try testing.expectOk(zig_assert_Uc_S_Sf(c.ret_Uc_S_Sf()));
}
...
test "Uc_Sf: C returns to Zig" {
    try testing.expectOk(zig_assert_Uc_Sf(c.ret_Uc_Sf()));
}
...
test "Uc_Sf_C: C returns to Zig" {
    try testing.expectOk(zig_assert_Uc_Sf_C(c.ret_Uc_Sf_C()));
}
...
test "Uc_Sf_D: C returns to Zig" {
    try testing.expectOk(zig_assert_Uc_Sf_D(c.ret_Uc_Sf_D()));
}
...
test "Uc_Sf_F: C returns to Zig" {
    try testing.expectOk(zig_assert_Uc_Sf_F(c.ret_Uc_Sf_F()));
}
...
test "Uc_Sf_I: C returns to Zig" {
    try testing.expectOk(zig_assert_Uc_Sf_I(c.ret_Uc_Sf_I()));
}
...
test "Uc_Sf_Ip: C returns to Zig" {
    try testing.expectOk(zig_assert_Uc_Sf_Ip(c.ret_Uc_Sf_Ip()));
}
...
test "Uc_Sf_L: C returns to Zig" {
    try testing.expectOk(zig_assert_Uc_Sf_L(c.ret_Uc_Sf_L()));
}
...
test "Uc_Sf_S: C returns to Zig" {
    try testing.expectOk(zig_assert_Uc_Sf_S(c.ret_Uc_Sf_S()));
}
...
test "Uc_Sf_Sf: C returns to Zig" {
    try testing.expectOk(zig_assert_Uc_Sf_Sf(c.ret_Uc_Sf_Sf()));
}
...
test "Uc_Sf_Uc: C returns to Zig" {
    try testing.expectOk(zig_assert_Uc_Sf_Uc(c.ret_Uc_Sf_Uc()));
}
...
test "Uc_Sf_Ui: C returns to Zig" {
    try testing.expectOk(zig_assert_Uc_Sf_Ui(c.ret_Uc_Sf_Ui()));
}
...
test "Uc_Sf_Ul: C returns to Zig" {
    try testing.expectOk(zig_assert_Uc_Sf_Ul(c.ret_Uc_Sf_Ul()));
}
...
test "Uc_Sf_Us: C returns to Zig" {
    try testing.expectOk(zig_assert_Uc_Sf_Us(c.ret_Uc_Sf_Us()));
}
...
test "Uc_Sf_Vp: C returns to Zig" {
    try testing.expectOk(zig_assert_Uc_Sf_Vp(c.ret_Uc_Sf_Vp()));
}
...
test "Uc_Uc_Sf: C returns to Zig" {
    try testing.expectOk(zig_assert_Uc_Uc_Sf(c.ret_Uc_Uc_Sf()));
}
...
test "Uc_Ui_Sf: C returns to Zig" {
    try testing.expectOk(zig_assert_Uc_Ui_Sf(c.ret_Uc_Ui_Sf()));
}
...
test "Uc_Ul_Sf: C returns to Zig" {
    try testing.expectOk(zig_assert_Uc_Ul_Sf(c.ret_Uc_Ul_Sf()));
}
...
test "Uc_Us_Sf: C returns to Zig" {
    try testing.expectOk(zig_assert_Uc_Us_Sf(c.ret_Uc_Us_Sf()));
}
...
test "Uc_Vp_Sf: C returns to Zig" {
    try testing.expectOk(zig_assert_Uc_Vp_Sf(c.ret_Uc_Vp_Sf()));
}
...
test "Ui_C_Sf: C returns to Zig" {
    try testing.expectOk(zig_assert_Ui_C_Sf(c.ret_Ui_C_Sf()));
}
...
test "Ui_D_Sf: C returns to Zig" {
    try testing.expectOk(zig_assert_Ui_D_Sf(c.ret_Ui_D_Sf()));
}
...
test "Ui_F_Sf: C returns to Zig" {
    try testing.expectOk(zig_assert_Ui_F_Sf(c.ret_Ui_F_Sf()));
}
...
test "Ui_I_Sf: C returns to Zig" {
    try testing.expectOk(zig_assert_Ui_I_Sf(c.ret_Ui_I_Sf()));
}
...
test "Ui_Ip_Sf: C returns to Zig" {
    try testing.expectOk(zig_assert_Ui_Ip_Sf(c.ret_Ui_Ip_Sf()));
}
...
test "Ui_L_Sf: C returns to Zig" {
    try testing.expectOk(zig_assert_Ui_L_Sf(c.ret_Ui_L_Sf()));
}
...
test "Ui_S_Sf: C returns to Zig" {
    try testing.expectOk(zig_assert_Ui_S_Sf(c.ret_Ui_S_Sf()));
}
...
test "Ui_Sf: C returns to Zig" {
    try testing.expectOk(zig_assert_Ui_Sf(c.ret_Ui_Sf()));
}
...
test "Ui_Sf_C: C returns to Zig" {
    try testing.expectOk(zig_assert_Ui_Sf_C(c.ret_Ui_Sf_C()));
}
...
test "Ui_Sf_D: C returns to Zig" {
    try testing.expectOk(zig_assert_Ui_Sf_D(c.ret_Ui_Sf_D()));
}
...
test "Ui_Sf_F: C returns to Zig" {
    try testing.expectOk(zig_assert_Ui_Sf_F(c.ret_Ui_Sf_F()));
}
...
test "Ui_Sf_I: C returns to Zig" {
    try testing.expectOk(zig_assert_Ui_Sf_I(c.ret_Ui_Sf_I()));
}
...
test "Ui_Sf_Ip: C returns to Zig" {
    try testing.expectOk(zig_assert_Ui_Sf_Ip(c.ret_Ui_Sf_Ip()));
}
...
test "Ui_Sf_L: C returns to Zig" {
    try testing.expectOk(zig_assert_Ui_Sf_L(c.ret_Ui_Sf_L()));
}
...
test "Ui_Sf_S: C returns to Zig" {
    try testing.expectOk(zig_assert_Ui_Sf_S(c.ret_Ui_Sf_S()));
}
...
test "Ui_Sf_Sf: C returns to Zig" {
    try testing.expectOk(zig_assert_Ui_Sf_Sf(c.ret_Ui_Sf_Sf()));
}
...
test "Ui_Sf_Uc: C returns to Zig" {
    try testing.expectOk(zig_assert_Ui_Sf_Uc(c.ret_Ui_Sf_Uc()));
}
...
test "Ui_Sf_Ui: C returns to Zig" {
    try testing.expectOk(zig_assert_Ui_Sf_Ui(c.ret_Ui_Sf_Ui()));
}
...
test "Ui_Sf_Ul: C returns to Zig" {
    try testing.expectOk(zig_assert_Ui_Sf_Ul(c.ret_Ui_Sf_Ul()));
}
...
test "Ui_Sf_Us: C returns to Zig" {
    try testing.expectOk(zig_assert_Ui_Sf_Us(c.ret_Ui_Sf_Us()));
}
...
test "Ui_Sf_Vp: C returns to Zig" {
    try testing.expectOk(zig_assert_Ui_Sf_Vp(c.ret_Ui_Sf_Vp()));
}
...
test "Ui_Uc_Sf: C returns to Zig" {
    try testing.expectOk(zig_assert_Ui_Uc_Sf(c.ret_Ui_Uc_Sf()));
}
...
test "Ui_Ui_Sf: C returns to Zig" {
    try testing.expectOk(zig_assert_Ui_Ui_Sf(c.ret_Ui_Ui_Sf()));
}
...
test "Ui_Ul_Sf: C returns to Zig" {
    try testing.expectOk(zig_assert_Ui_Ul_Sf(c.ret_Ui_Ul_Sf()));
}
...
test "Ui_Us_Sf: C returns to Zig" {
    try testing.expectOk(zig_assert_Ui_Us_Sf(c.ret_Ui_Us_Sf()));
}
...
test "Ui_Vp_Sf: C returns to Zig" {
    try testing.expectOk(zig_assert_Ui_Vp_Sf(c.ret_Ui_Vp_Sf()));
}
...
test "Ul_C_Sf: C returns to Zig" {
    try testing.expectOk(zig_assert_Ul_C_Sf(c.ret_Ul_C_Sf()));
}
...
test "Ul_D_Sf: C returns to Zig" {
    try testing.expectOk(zig_assert_Ul_D_Sf(c.ret_Ul_D_Sf()));
}
...
test "Ul_F_Sf: C returns to Zig" {
    try testing.expectOk(zig_assert_Ul_F_Sf(c.ret_Ul_F_Sf()));
}
...
test "Ul_I_Sf: C returns to Zig" {
    try testing.expectOk(zig_assert_Ul_I_Sf(c.ret_Ul_I_Sf()));
}
...
test "Ul_Ip_Sf: C returns to Zig" {
    try testing.expectOk(zig_assert_Ul_Ip_Sf(c.ret_Ul_Ip_Sf()));
}
...
test "Ul_L_Sf: C returns to Zig" {
    try testing.expectOk(zig_assert_Ul_L_Sf(c.ret_Ul_L_Sf()));
}
...
test "Ul_S_Sf: C returns to Zig" {
    try testing.expectOk(zig_assert_Ul_S_Sf(c.ret_Ul_S_Sf()));
}
...
test "Ul_Sf: C returns to Zig" {
    try testing.expectOk(zig_assert_Ul_Sf(c.ret_Ul_Sf()));
}
...
test "Ul_Sf_C: C returns to Zig" {
    try testing.expectOk(zig_assert_Ul_Sf_C(c.ret_Ul_Sf_C()));
}
...
test "Ul_Sf_D: C returns to Zig" {
    try testing.expectOk(zig_assert_Ul_Sf_D(c.ret_Ul_Sf_D()));
}
...
test "Ul_Sf_F: C returns to Zig" {
    try testing.expectOk(zig_assert_Ul_Sf_F(c.ret_Ul_Sf_F()));
}
...
test "Ul_Sf_I: C returns to Zig" {
    try testing.expectOk(zig_assert_Ul_Sf_I(c.ret_Ul_Sf_I()));
}
...
test "Ul_Sf_Ip: C returns to Zig" {
    try testing.expectOk(zig_assert_Ul_Sf_Ip(c.ret_Ul_Sf_Ip()));
}
...
test "Ul_Sf_L: C returns to Zig" {
    try testing.expectOk(zig_assert_Ul_Sf_L(c.ret_Ul_Sf_L()));
}
...
test "Ul_Sf_S: C returns to Zig" {
    try testing.expectOk(zig_assert_Ul_Sf_S(c.ret_Ul_Sf_S()));
}
...
test "Ul_Sf_Sf: C returns to Zig" {
    try testing.expectOk(zig_assert_Ul_Sf_Sf(c.ret_Ul_Sf_Sf()));
}
...
test "Ul_Sf_Uc: C returns to Zig" {
    try testing.expectOk(zig_assert_Ul_Sf_Uc(c.ret_Ul_Sf_Uc()));
}
...
test "Ul_Sf_Ui: C returns to Zig" {
    try testing.expectOk(zig_assert_Ul_Sf_Ui(c.ret_Ul_Sf_Ui()));
}
...
test "Ul_Sf_Ul: C returns to Zig" {
    try testing.expectOk(zig_assert_Ul_Sf_Ul(c.ret_Ul_Sf_Ul()));
}
...
test "Ul_Sf_Us: C returns to Zig" {
    try testing.expectOk(zig_assert_Ul_Sf_Us(c.ret_Ul_Sf_Us()));
}
...
test "Ul_Sf_Vp: C returns to Zig" {
    try testing.expectOk(zig_assert_Ul_Sf_Vp(c.ret_Ul_Sf_Vp()));
}
...
test "Ul_Uc_Sf: C returns to Zig" {
    try testing.expectOk(zig_assert_Ul_Uc_Sf(c.ret_Ul_Uc_Sf()));
}
...
test "Ul_Ui_Sf: C returns to Zig" {
    try testing.expectOk(zig_assert_Ul_Ui_Sf(c.ret_Ul_Ui_Sf()));
}
...
test "Ul_Ul_Sf: C returns to Zig" {
    try testing.expectOk(zig_assert_Ul_Ul_Sf(c.ret_Ul_Ul_Sf()));
}
...
test "Ul_Us_Sf: C returns to Zig" {
    try testing.expectOk(zig_assert_Ul_Us_Sf(c.ret_Ul_Us_Sf()));
}
...
test "Ul_Vp_Sf: C returns to Zig" {
    try testing.expectOk(zig_assert_Ul_Vp_Sf(c.ret_Ul_Vp_Sf()));
}
...
test "Us_C_Sf: C returns to Zig" {
    try testing.expectOk(zig_assert_Us_C_Sf(c.ret_Us_C_Sf()));
}
...
test "Us_D_Sf: C returns to Zig" {
    try testing.expectOk(zig_assert_Us_D_Sf(c.ret_Us_D_Sf()));
}
...
test "Us_F_Sf: C returns to Zig" {
    try testing.expectOk(zig_assert_Us_F_Sf(c.ret_Us_F_Sf()));
}
...
test "Us_I_Sf: C returns to Zig" {
    try testing.expectOk(zig_assert_Us_I_Sf(c.ret_Us_I_Sf()));
}
...
test "Us_Ip_Sf: C returns to Zig" {
    try testing.expectOk(zig_assert_Us_Ip_Sf(c.ret_Us_Ip_Sf()));
}
...
test "Us_L_Sf: C returns to Zig" {
    try testing.expectOk(zig_assert_Us_L_Sf(c.ret_Us_L_Sf()));
}
...
test "Us_S_Sf: C returns to Zig" {
    try testing.expectOk(zig_assert_Us_S_Sf(c.ret_Us_S_Sf()));
}
...
test "Us_Sf: C returns to Zig" {
    try testing.expectOk(zig_assert_Us_Sf(c.ret_Us_Sf()));
}
...
test "Us_Sf_C: C returns to Zig" {
    try testing.expectOk(zig_assert_Us_Sf_C(c.ret_Us_Sf_C()));
}
...
test "Us_Sf_D: C returns to Zig" {
    try testing.expectOk(zig_assert_Us_Sf_D(c.ret_Us_Sf_D()));
}
...
test "Us_Sf_F: C returns to Zig" {
    try testing.expectOk(zig_assert_Us_Sf_F(c.ret_Us_Sf_F()));
}
...
test "Us_Sf_I: C returns to Zig" {
    try testing.expectOk(zig_assert_Us_Sf_I(c.ret_Us_Sf_I()));
}
...
test "Us_Sf_Ip: C returns to Zig" {
    try testing.expectOk(zig_assert_Us_Sf_Ip(c.ret_Us_Sf_Ip()));
}
...
test "Us_Sf_L: C returns to Zig" {
    try testing.expectOk(zig_assert_Us_Sf_L(c.ret_Us_Sf_L()));
}
...
test "Us_Sf_S: C returns to Zig" {
    try testing.expectOk(zig_assert_Us_Sf_S(c.ret_Us_Sf_S()));
}
...
test "Us_Sf_Sf: C returns to Zig" {
    try testing.expectOk(zig_assert_Us_Sf_Sf(c.ret_Us_Sf_Sf()));
}
...
test "Us_Sf_Uc: C returns to Zig" {
    try testing.expectOk(zig_assert_Us_Sf_Uc(c.ret_Us_Sf_Uc()));
}
...
test "Us_Sf_Ui: C returns to Zig" {
    try testing.expectOk(zig_assert_Us_Sf_Ui(c.ret_Us_Sf_Ui()));
}
...
test "Us_Sf_Ul: C returns to Zig" {
    try testing.expectOk(zig_assert_Us_Sf_Ul(c.ret_Us_Sf_Ul()));
}
...
test "Us_Sf_Us: C returns to Zig" {
    try testing.expectOk(zig_assert_Us_Sf_Us(c.ret_Us_Sf_Us()));
}
...
test "Us_Sf_Vp: C returns to Zig" {
    try testing.expectOk(zig_assert_Us_Sf_Vp(c.ret_Us_Sf_Vp()));
}
...
test "Us_Uc_Sf: C returns to Zig" {
    try testing.expectOk(zig_assert_Us_Uc_Sf(c.ret_Us_Uc_Sf()));
}
...
test "Us_Ui_Sf: C returns to Zig" {
    try testing.expectOk(zig_assert_Us_Ui_Sf(c.ret_Us_Ui_Sf()));
}
...
test "Us_Ul_Sf: C returns to Zig" {
    try testing.expectOk(zig_assert_Us_Ul_Sf(c.ret_Us_Ul_Sf()));
}
...
test "Us_Us_Sf: C returns to Zig" {
    try testing.expectOk(zig_assert_Us_Us_Sf(c.ret_Us_Us_Sf()));
}
...
test "Us_Vp_Sf: C returns to Zig" {
    try testing.expectOk(zig_assert_Us_Vp_Sf(c.ret_Us_Vp_Sf()));
}
...
test "Vp_C_Sf: C returns to Zig" {
    try testing.expectOk(zig_assert_Vp_C_Sf(c.ret_Vp_C_Sf()));
}
...
test "Vp_D_Sf: C returns to Zig" {
    try testing.expectOk(zig_assert_Vp_D_Sf(c.ret_Vp_D_Sf()));
}
...
test "Vp_F_Sf: C returns to Zig" {
    try testing.expectOk(zig_assert_Vp_F_Sf(c.ret_Vp_F_Sf()));
}
...
test "Vp_I_Sf: C returns to Zig" {
    try testing.expectOk(zig_assert_Vp_I_Sf(c.ret_Vp_I_Sf()));
}
...
test "Vp_Ip_Sf: C returns to Zig" {
    try testing.expectOk(zig_assert_Vp_Ip_Sf(c.ret_Vp_Ip_Sf()));
}
...
test "Vp_L_Sf: C returns to Zig" {
    try testing.expectOk(zig_assert_Vp_L_Sf(c.ret_Vp_L_Sf()));
}
...
test "Vp_S_Sf: C returns to Zig" {
    try testing.expectOk(zig_assert_Vp_S_Sf(c.ret_Vp_S_Sf()));
}
...
test "Vp_Sf: C returns to Zig" {
    try testing.expectOk(zig_assert_Vp_Sf(c.ret_Vp_Sf()));
}
...
test "Vp_Sf_C: C returns to Zig" {
    try testing.expectOk(zig_assert_Vp_Sf_C(c.ret_Vp_Sf_C()));
}
...
test "Vp_Sf_D: C returns to Zig" {
    try testing.expectOk(zig_assert_Vp_Sf_D(c.ret_Vp_Sf_D()));
}
...
test "Vp_Sf_F: C returns to Zig" {
    try testing.expectOk(zig_assert_Vp_Sf_F(c.ret_Vp_Sf_F()));
}
...
test "Vp_Sf_I: C returns to Zig" {
    try testing.expectOk(zig_assert_Vp_Sf_I(c.ret_Vp_Sf_I()));
}
...
test "Vp_Sf_Ip: C returns to Zig" {
    try testing.expectOk(zig_assert_Vp_Sf_Ip(c.ret_Vp_Sf_Ip()));
}
...
test "Vp_Sf_L: C returns to Zig" {
    try testing.expectOk(zig_assert_Vp_Sf_L(c.ret_Vp_Sf_L()));
}
...
test "Vp_Sf_S: C returns to Zig" {
    try testing.expectOk(zig_assert_Vp_Sf_S(c.ret_Vp_Sf_S()));
}
...
test "Vp_Sf_Sf: C returns to Zig" {
    try testing.expectOk(zig_assert_Vp_Sf_Sf(c.ret_Vp_Sf_Sf()));
}
...
test "Vp_Sf_Uc: C returns to Zig" {
    try testing.expectOk(zig_assert_Vp_Sf_Uc(c.ret_Vp_Sf_Uc()));
}
...
test "Vp_Sf_Ui: C returns to Zig" {
    try testing.expectOk(zig_assert_Vp_Sf_Ui(c.ret_Vp_Sf_Ui()));
}
...
test "Vp_Sf_Ul: C returns to Zig" {
    try testing.expectOk(zig_assert_Vp_Sf_Ul(c.ret_Vp_Sf_Ul()));
}
...
test "Vp_Sf_Us: C returns to Zig" {
    try testing.expectOk(zig_assert_Vp_Sf_Us(c.ret_Vp_Sf_Us()));
}
...
test "Vp_Sf_Vp: C returns to Zig" {
    try testing.expectOk(zig_assert_Vp_Sf_Vp(c.ret_Vp_Sf_Vp()));
}
...
test "Vp_Uc_Sf: C returns to Zig" {
    try testing.expectOk(zig_assert_Vp_Uc_Sf(c.ret_Vp_Uc_Sf()));
}
...
test "Vp_Ui_Sf: C returns to Zig" {
    try testing.expectOk(zig_assert_Vp_Ui_Sf(c.ret_Vp_Ui_Sf()));
}
...
test "Vp_Ul_Sf: C returns to Zig" {
    try testing.expectOk(zig_assert_Vp_Ul_Sf(c.ret_Vp_Ul_Sf()));
}
...
test "Vp_Us_Sf: C returns to Zig" {
    try testing.expectOk(zig_assert_Vp_Us_Sf(c.ret_Vp_Us_Sf()));
}
...
test "Vp_Vp_Sf: C returns to Zig" {
    try testing.expectOk(zig_assert_Vp_Vp_Sf(c.ret_Vp_Vp_Sf()));
}
