...
test "C_C_Sf" {
    ...
    try testing.expectOk(c.recv_C_C_Sf(.{ .v1 = 117, .v2 = 73, .v3 = .{} }));
}
...
test "C_D_Sf" {
    ...
    try testing.expectOk(c.recv_C_D_Sf(.{ .v1 = 118, .v2 = 0.450549, .v3 = .{} }));
}
...
test "C_F_Sf" {
    ...
    try testing.expectOk(c.recv_C_F_Sf(.{ .v1 = 74, .v2 = -2.125, .v3 = .{} }));
}
...
test "C_I_Sf" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 4);
    try testing.expectFieldOffset(&lv, &lv.v3, 8);
    try testing.expectOk(c.recv_C_I_Sf(.{ .v1 = 64, .v2 = 22728, .v3 = .{} }));
}
...
test "C_Ip_Sf" {
    ...
    try testing.expectOk(c.recv_C_Ip_Sf(.{ .v1 = 76, .v2 = null, .v3 = .{} }));
}
...
test "C_L_Sf" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, ABISELECT(8, 4));
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_C_L_Sf(.{ .v1 = 37, .v2 = 19332, .v3 = .{} }));
}
...
test "C_S_Sf" {
    ...
    try testing.expectOk(c.recv_C_S_Sf(.{ .v1 = 73, .v2 = 7184, .v3 = .{} }));
}
...
test "C_Sf" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v1, 0);
    try testing.expectFieldOffset(&lv, &lv.v2, 1);
    try testing.expectOk(c.recv_C_Sf(.{ .v1 = 12, .v2 = .{} }));
}
...
test "C_Sf_C" {
    ...
    try testing.expectOk(c.recv_C_Sf_C(.{ .v1 = 91, .v2 = .{}, .v3 = 3 }));
}
...
test "C_Sf_D" {
    ...
    try testing.expectOk(c.recv_C_Sf_D(.{ .v1 = 108, .v2 = .{}, .v3 = 0.668115 }));
}
...
test "C_Sf_F" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 1);
    try testing.expectFieldOffset(&lv, &lv.v3, 4);
    try testing.expectOk(c.recv_C_Sf_F(.{ .v1 = 115, .v2 = .{}, .v3 = 4.5 }));
}
...
test "C_Sf_I" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 1);
    try testing.expectFieldOffset(&lv, &lv.v3, 4);
    try testing.expectOk(c.recv_C_Sf_I(.{ .v1 = 95, .v2 = .{}, .v3 = 16729 }));
}
...
test "C_Sf_Ip" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 1);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(8, 4));
    try testing.expectOk(c.recv_C_Sf_Ip(.{ .v1 = 100, .v2 = .{}, .v3 = null }));
}
...
test "C_Sf_L" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 1);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(8, 4));
    try testing.expectOk(c.recv_C_Sf_L(.{ .v1 = 41, .v2 = .{}, .v3 = 23271 }));
}
...
test "C_Sf_S" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 1);
    try testing.expectFieldOffset(&lv, &lv.v3, 2);
    try testing.expectOk(c.recv_C_Sf_S(.{ .v1 = 106, .v2 = .{}, .v3 = 31129 }));
}
...
test "C_Sf_Sf" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 1);
    try testing.expectFieldOffset(&lv, &lv.v3, 1);
    try testing.expectOk(c.recv_C_Sf_Sf(.{ .v1 = 44, .v2 = .{}, .v3 = .{} }));
}
...
test "C_Sf_Uc" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 1);
    try testing.expectFieldOffset(&lv, &lv.v3, 1);
    try testing.expectOk(c.recv_C_Sf_Uc(.{ .v1 = 87, .v2 = .{}, .v3 = 33 }));
}
...
test "C_Sf_Ui" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 1);
    try testing.expectFieldOffset(&lv, &lv.v3, 4);
    try testing.expectOk(c.recv_C_Sf_Ui(.{ .v1 = 100, .v2 = .{}, .v3 = 26951 }));
}
...
test "C_Sf_Ul" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 1);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(8, 4));
    try testing.expectOk(c.recv_C_Sf_Ul(.{ .v1 = 75, .v2 = .{}, .v3 = 13468 }));
}
...
test "C_Sf_Us" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 1);
    try testing.expectFieldOffset(&lv, &lv.v3, 2);
    try testing.expectOk(c.recv_C_Sf_Us(.{ .v1 = 62, .v2 = .{}, .v3 = 19833 }));
}
...
test "C_Sf_Vp" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 1);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(8, 4));
    try testing.expectOk(c.recv_C_Sf_Vp(.{ .v1 = 43, .v2 = .{}, .v3 = null }));
}
...
test "C_Uc_Sf" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 1);
    try testing.expectFieldOffset(&lv, &lv.v3, 2);
    try testing.expectOk(c.recv_C_Uc_Sf(.{ .v1 = 75, .v2 = 105, .v3 = .{} }));
}
...
test "C_Ui_Sf" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 4);
    try testing.expectFieldOffset(&lv, &lv.v3, 8);
    try testing.expectOk(c.recv_C_Ui_Sf(.{ .v1 = 0, .v2 = 14996, .v3 = .{} }));
}
...
test "C_Ul_Sf" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, ABISELECT(8, 4));
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_C_Ul_Sf(.{ .v1 = 96, .v2 = 13786, .v3 = .{} }));
}
...
test "C_Us_Sf" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 2);
    try testing.expectFieldOffset(&lv, &lv.v3, 4);
    try testing.expectOk(c.recv_C_Us_Sf(.{ .v1 = 50, .v2 = 27235, .v3 = .{} }));
}
...
test "C_Vp_Sf" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, ABISELECT(8, 4));
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 8));
    try testing.expectOk(c.recv_C_Vp_Sf(.{ .v1 = 61, .v2 = null, .v3 = .{} }));
}
...
test "D_C_Sf" {
    ...
    try testing.expectOk(c.recv_D_C_Sf(.{ .v1 = 0.920064, .v2 = 18, .v3 = .{} }));
}
...
test "D_D_Sf" {
    ...
    try testing.expectOk(c.recv_D_D_Sf(.{ .v1 = 0.191033, .v2 = 0.084533, .v3 = .{} }));
}
...
test "D_F_Sf" {
    ...
    try testing.expectOk(c.recv_D_F_Sf(.{ .v1 = 0.584034, .v2 = 0.125, .v3 = .{} }));
}
...
test "D_I_Sf" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 12);
    try testing.expectOk(c.recv_D_I_Sf(.{ .v1 = 0.113764, .v2 = 5654, .v3 = .{} }));
}
...
test "D_Ip_Sf" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_D_Ip_Sf(.{ .v1 = 0.427315, .v2 = null, .v3 = .{} }));
}
...
test "D_L_Sf" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 16);
    try testing.expectOk(c.recv_D_L_Sf(.{ .v1 = 0.784215, .v2 = 17716, .v3 = .{} }));
}
...
test "D_S_Sf" {
    ...
    try testing.expectOk(c.recv_D_S_Sf(.{ .v1 = 0.234190, .v2 = 17156, .v3 = .{} }));
}
...
test "D_Sf" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v1, 0);
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectOk(c.recv_D_Sf(.{ .v1 = 0.036072, .v2 = .{} }));
}
...
test "D_Sf_C" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 8);
    try testing.expectOk(c.recv_D_Sf_C(.{ .v1 = 0.508145, .v2 = .{}, .v3 = 89 }));
}
...
test "D_Sf_D" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 8);
    try testing.expectOk(c.recv_D_Sf_D(.{ .v1 = 0.589251, .v2 = .{}, .v3 = 0.457317 }));
}
...
test "D_Sf_F" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 8);
    try testing.expectOk(c.recv_D_Sf_F(.{ .v1 = 0.794758, .v2 = .{}, .v3 = 1.0 }));
}
...
test "D_Sf_I" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 8);
    try testing.expectOk(c.recv_D_Sf_I(.{ .v1 = 0.230150, .v2 = .{}, .v3 = 23530 }));
}
...
test "D_Sf_Ip" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 8);
    try testing.expectOk(c.recv_D_Sf_Ip(.{ .v1 = 0.334664, .v2 = .{}, .v3 = null }));
}
...
test "D_Sf_L" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 8);
    try testing.expectOk(c.recv_D_Sf_L(.{ .v1 = 0.098671, .v2 = .{}, .v3 = 1247 }));
}
...
test "D_Sf_S" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 8);
    try testing.expectOk(c.recv_D_Sf_S(.{ .v1 = 0.182554, .v2 = .{}, .v3 = 8335 }));
}
...
test "D_Sf_Sf" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 8);
    try testing.expectOk(c.recv_D_Sf_Sf(.{ .v1 = 0.686635, .v2 = .{}, .v3 = .{} }));
}
...
test "D_Sf_Uc" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 8);
    try testing.expectOk(c.recv_D_Sf_Uc(.{ .v1 = 0.011819, .v2 = .{}, .v3 = 8 }));
}
...
test "D_Sf_Ui" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 8);
    try testing.expectOk(c.recv_D_Sf_Ui(.{ .v1 = 0.119915, .v2 = .{}, .v3 = 8958 }));
}
...
test "D_Sf_Ul" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 8);
    try testing.expectOk(c.recv_D_Sf_Ul(.{ .v1 = 0.295666, .v2 = .{}, .v3 = 13699 }));
}
...
test "D_Sf_Us" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 8);
    try testing.expectOk(c.recv_D_Sf_Us(.{ .v1 = 0.713780, .v2 = .{}, .v3 = 28590 }));
}
...
test "D_Sf_Vp" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 8);
    try testing.expectOk(c.recv_D_Sf_Vp(.{ .v1 = 0.617147, .v2 = .{}, .v3 = null }));
}
...
test "D_Uc_Sf" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 9);
    try testing.expectOk(c.recv_D_Uc_Sf(.{ .v1 = 0.409602, .v2 = 126, .v3 = .{} }));
}
...
test "D_Ui_Sf" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 12);
    try testing.expectOk(c.recv_D_Ui_Sf(.{ .v1 = 0.550221, .v2 = 16504, .v3 = .{} }));
}
...
test "D_Ul_Sf" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 16);
    try testing.expectOk(c.recv_D_Ul_Sf(.{ .v1 = 0.421901, .v2 = 4011, .v3 = .{} }));
}
...
test "D_Us_Sf" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 10);
    try testing.expectOk(c.recv_D_Us_Sf(.{ .v1 = 0.779822, .v2 = 29846, .v3 = .{} }));
}
...
test "D_Vp_Sf" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_D_Vp_Sf(.{ .v1 = 0.806602, .v2 = null, .v3 = .{} }));
}
...
test "F_C_Sf" {
    ...
    try testing.expectOk(c.recv_F_C_Sf(.{ .v1 = 0.5, .v2 = 36, .v3 = .{} }));
}
...
test "F_D_Sf" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, ABISELECT(8, 4));
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_F_D_Sf(.{ .v1 = 1.0, .v2 = 0.636011, .v3 = .{} }));
}
...
test "F_F_Sf" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 4);
    try testing.expectFieldOffset(&lv, &lv.v3, 8);
    try testing.expectOk(c.recv_F_F_Sf(.{ .v1 = -0.25, .v2 = 0.125, .v3 = .{} }));
}
...
test "F_I_Sf" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 4);
    try testing.expectFieldOffset(&lv, &lv.v3, 8);
    try testing.expectOk(c.recv_F_I_Sf(.{ .v1 = 4.5, .v2 = 23929, .v3 = .{} }));
}
...
test "F_Ip_Sf" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, ABISELECT(8, 4));
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 8));
    try testing.expectOk(c.recv_F_Ip_Sf(.{ .v1 = -2.125, .v2 = null, .v3 = .{} }));
}
...
test "F_L_Sf" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, ABISELECT(8, 4));
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_F_L_Sf(.{ .v1 = 0.5, .v2 = 32338, .v3 = .{} }));
}
...
test "F_S_Sf" {
    ...
    try testing.expectOk(c.recv_F_S_Sf(.{ .v1 = 1.0, .v2 = 20788, .v3 = .{} }));
}
...
test "F_Sf" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v1, 0);
    try testing.expectFieldOffset(&lv, &lv.v2, 4);
    try testing.expectOk(c.recv_F_Sf(.{ .v1 = -2.125, .v2 = .{} }));
}
...
test "F_Sf_C" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 4);
    try testing.expectFieldOffset(&lv, &lv.v3, 4);
    try testing.expectOk(c.recv_F_Sf_C(.{ .v1 = 4.5, .v2 = .{}, .v3 = 19 }));
}
...
test "F_Sf_D" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 4);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(8, 4));
    try testing.expectOk(c.recv_F_Sf_D(.{ .v1 = 0.125, .v2 = .{}, .v3 = 0.263958 }));
}
...
test "F_Sf_F" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 4);
    try testing.expectFieldOffset(&lv, &lv.v3, 4);
    try testing.expectOk(c.recv_F_Sf_F(.{ .v1 = 1.0, .v2 = .{}, .v3 = 0.125 }));
}
...
test "F_Sf_I" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 4);
    try testing.expectFieldOffset(&lv, &lv.v3, 4);
    try testing.expectOk(c.recv_F_Sf_I(.{ .v1 = 0.125, .v2 = .{}, .v3 = 26364 }));
}
...
test "F_Sf_Ip" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 4);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(8, 4));
    try testing.expectOk(c.recv_F_Sf_Ip(.{ .v1 = -0.25, .v2 = .{}, .v3 = null }));
}
...
test "F_Sf_L" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 4);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(8, 4));
    try testing.expectOk(c.recv_F_Sf_L(.{ .v1 = -0.25, .v2 = .{}, .v3 = 20871 }));
}
...
test "F_Sf_S" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 4);
    try testing.expectFieldOffset(&lv, &lv.v3, 4);
    try testing.expectOk(c.recv_F_Sf_S(.{ .v1 = -2.125, .v2 = .{}, .v3 = 23630 }));
}
...
test "F_Sf_Sf" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 4);
    try testing.expectFieldOffset(&lv, &lv.v3, 4);
    try testing.expectOk(c.recv_F_Sf_Sf(.{ .v1 = -2.125, .v2 = .{}, .v3 = .{} }));
}
...
test "F_Sf_Uc" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 4);
    try testing.expectFieldOffset(&lv, &lv.v3, 4);
    try testing.expectOk(c.recv_F_Sf_Uc(.{ .v1 = 0.125, .v2 = .{}, .v3 = 30 }));
}
...
test "F_Sf_Ui" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 4);
    try testing.expectFieldOffset(&lv, &lv.v3, 4);
    try testing.expectOk(c.recv_F_Sf_Ui(.{ .v1 = 4.5, .v2 = .{}, .v3 = 20433 }));
}
...
test "F_Sf_Ul" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 4);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(8, 4));
    try testing.expectOk(c.recv_F_Sf_Ul(.{ .v1 = 1.0, .v2 = .{}, .v3 = 30023 }));
}
...
test "F_Sf_Us" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 4);
    try testing.expectFieldOffset(&lv, &lv.v3, 4);
    try testing.expectOk(c.recv_F_Sf_Us(.{ .v1 = 1.0, .v2 = .{}, .v3 = 8279 }));
}
...
test "F_Sf_Vp" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 4);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(8, 4));
    try testing.expectOk(c.recv_F_Sf_Vp(.{ .v1 = 4.5, .v2 = .{}, .v3 = null }));
}
...
test "F_Uc_Sf" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 4);
    try testing.expectFieldOffset(&lv, &lv.v3, 5);
    try testing.expectOk(c.recv_F_Uc_Sf(.{ .v1 = 4.5, .v2 = 46, .v3 = .{} }));
}
...
test "F_Ui_Sf" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 4);
    try testing.expectFieldOffset(&lv, &lv.v3, 8);
    try testing.expectOk(c.recv_F_Ui_Sf(.{ .v1 = -2.125, .v2 = 19552, .v3 = .{} }));
}
...
test "F_Ul_Sf" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, ABISELECT(8, 4));
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_F_Ul_Sf(.{ .v1 = 0.5, .v2 = 14212, .v3 = .{} }));
}
...
test "F_Us_Sf" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 4);
    try testing.expectFieldOffset(&lv, &lv.v3, 6);
    try testing.expectOk(c.recv_F_Us_Sf(.{ .v1 = -2.125, .v2 = 11194, .v3 = .{} }));
}
...
test "F_Vp_Sf" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, ABISELECT(8, 4));
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 8));
    try testing.expectOk(c.recv_F_Vp_Sf(.{ .v1 = 0.5, .v2 = null, .v3 = .{} }));
}
...
test "I_C_Sf" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 4);
    try testing.expectFieldOffset(&lv, &lv.v3, 5);
    try testing.expectOk(c.recv_I_C_Sf(.{ .v1 = 29090, .v2 = 104, .v3 = .{} }));
}
...
test "I_D_Sf" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, ABISELECT(8, 4));
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_I_D_Sf(.{ .v1 = 10469, .v2 = 0.097234, .v3 = .{} }));
}
...
test "I_F_Sf" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 4);
    try testing.expectFieldOffset(&lv, &lv.v3, 8);
    try testing.expectOk(c.recv_I_F_Sf(.{ .v1 = 2480, .v2 = 1.0, .v3 = .{} }));
}
...
test "I_I_Sf" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 4);
    try testing.expectFieldOffset(&lv, &lv.v3, 8);
    try testing.expectOk(c.recv_I_I_Sf(.{ .v1 = 10439, .v2 = 25119, .v3 = .{} }));
}
...
test "I_Ip_Sf" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, ABISELECT(8, 4));
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 8));
    try testing.expectOk(c.recv_I_Ip_Sf(.{ .v1 = 21252, .v2 = null, .v3 = .{} }));
}
...
test "I_L_Sf" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, ABISELECT(8, 4));
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_I_L_Sf(.{ .v1 = 8675, .v2 = 13071, .v3 = .{} }));
}
...
test "I_S_Sf" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 4);
    try testing.expectFieldOffset(&lv, &lv.v3, 6);
    try testing.expectOk(c.recv_I_S_Sf(.{ .v1 = 22337, .v2 = 14437, .v3 = .{} }));
}
...
test "I_Sf" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v1, 0);
    try testing.expectFieldOffset(&lv, &lv.v2, 4);
    try testing.expectOk(c.recv_I_Sf(.{ .v1 = 31933, .v2 = .{} }));
}
...
test "I_Sf_C" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 4);
    try testing.expectFieldOffset(&lv, &lv.v3, 4);
    try testing.expectOk(c.recv_I_Sf_C(.{ .v1 = 2630, .v2 = .{}, .v3 = 95 }));
}
...
test "I_Sf_D" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 4);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(8, 4));
    try testing.expectOk(c.recv_I_Sf_D(.{ .v1 = 1334, .v2 = .{}, .v3 = 0.329760 }));
}
...
test "I_Sf_F" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 4);
    try testing.expectFieldOffset(&lv, &lv.v3, 4);
    try testing.expectOk(c.recv_I_Sf_F(.{ .v1 = 314, .v2 = .{}, .v3 = 1.0 }));
}
...
test "I_Sf_I" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 4);
    try testing.expectFieldOffset(&lv, &lv.v3, 4);
    try testing.expectOk(c.recv_I_Sf_I(.{ .v1 = 808, .v2 = .{}, .v3 = 10326 }));
}
...
test "I_Sf_Ip" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 4);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(8, 4));
    try testing.expectOk(c.recv_I_Sf_Ip(.{ .v1 = 22309, .v2 = .{}, .v3 = null }));
}
...
test "I_Sf_L" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 4);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(8, 4));
    try testing.expectOk(c.recv_I_Sf_L(.{ .v1 = 24772, .v2 = .{}, .v3 = 30102 }));
}
...
test "I_Sf_S" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 4);
    try testing.expectFieldOffset(&lv, &lv.v3, 4);
    try testing.expectOk(c.recv_I_Sf_S(.{ .v1 = 1763, .v2 = .{}, .v3 = 2191 }));
}
...
test "I_Sf_Sf" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 4);
    try testing.expectFieldOffset(&lv, &lv.v3, 4);
    try testing.expectOk(c.recv_I_Sf_Sf(.{ .v1 = 10536, .v2 = .{}, .v3 = .{} }));
}
...
test "I_Sf_Uc" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 4);
    try testing.expectFieldOffset(&lv, &lv.v3, 4);
    try testing.expectOk(c.recv_I_Sf_Uc(.{ .v1 = 4160, .v2 = .{}, .v3 = 45 }));
}
...
test "I_Sf_Ui" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 4);
    try testing.expectFieldOffset(&lv, &lv.v3, 4);
    try testing.expectOk(c.recv_I_Sf_Ui(.{ .v1 = 25993, .v2 = .{}, .v3 = 25987 }));
}
...
test "I_Sf_Ul" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 4);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(8, 4));
    try testing.expectOk(c.recv_I_Sf_Ul(.{ .v1 = 23895, .v2 = .{}, .v3 = 26777 }));
}
...
test "I_Sf_Us" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 4);
    try testing.expectFieldOffset(&lv, &lv.v3, 4);
    try testing.expectOk(c.recv_I_Sf_Us(.{ .v1 = 21715, .v2 = .{}, .v3 = 23581 }));
}
...
test "I_Sf_Vp" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 4);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(8, 4));
    try testing.expectOk(c.recv_I_Sf_Vp(.{ .v1 = 10308, .v2 = .{}, .v3 = null }));
}
...
test "I_Uc_Sf" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 4);
    try testing.expectFieldOffset(&lv, &lv.v3, 5);
    try testing.expectOk(c.recv_I_Uc_Sf(.{ .v1 = 1955, .v2 = 88, .v3 = .{} }));
}
...
test "I_Ui_Sf" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 4);
    try testing.expectFieldOffset(&lv, &lv.v3, 8);
    try testing.expectOk(c.recv_I_Ui_Sf(.{ .v1 = 18167, .v2 = 30153, .v3 = .{} }));
}
...
test "I_Ul_Sf" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, ABISELECT(8, 4));
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_I_Ul_Sf(.{ .v1 = 30828, .v2 = 18699, .v3 = .{} }));
}
...
test "I_Us_Sf" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 4);
    try testing.expectFieldOffset(&lv, &lv.v3, 6);
    try testing.expectOk(c.recv_I_Us_Sf(.{ .v1 = 9385, .v2 = 8777, .v3 = .{} }));
}
...
test "I_Vp_Sf" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, ABISELECT(8, 4));
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 8));
    try testing.expectOk(c.recv_I_Vp_Sf(.{ .v1 = 26440, .v2 = null, .v3 = .{} }));
}
...
test "Ip_C_Sf" {
    ...
    try testing.expectOk(c.recv_Ip_C_Sf(.{ .v1 = null, .v2 = 18, .v3 = .{} }));
}
...
test "Ip_D_Sf" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, ABISELECT(8, 4));
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_Ip_D_Sf(.{ .v1 = null, .v2 = 0.404276, .v3 = .{} }));
}
...
test "Ip_F_Sf" {
    ...
    try testing.expectOk(c.recv_Ip_F_Sf(.{ .v1 = null, .v2 = 0.5, .v3 = .{} }));
}
...
test "Ip_I_Sf" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, ABISELECT(8, 4));
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(12, 8));
    try testing.expectOk(c.recv_Ip_I_Sf(.{ .v1 = null, .v2 = 30260, .v3 = .{} }));
}
...
test "Ip_Ip_Sf" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, ABISELECT(8, 4));
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 8));
    try testing.expectOk(c.recv_Ip_Ip_Sf(.{ .v1 = null, .v2 = null, .v3 = .{} }));
}
...
test "Ip_L_Sf" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, ABISELECT(8, 4));
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_Ip_L_Sf(.{ .v1 = null, .v2 = 29776, .v3 = .{} }));
}
...
test "Ip_S_Sf" {
    ...
    try testing.expectOk(c.recv_Ip_S_Sf(.{ .v1 = null, .v2 = 27826, .v3 = .{} }));
}
...
test "Ip_Sf" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v1, 0);
    try testing.expectFieldOffset(&lv, &lv.v2, ABISELECT(8, 4));
    try testing.expectOk(c.recv_Ip_Sf(.{ .v1 = null, .v2 = .{} }));
}
...
test "Ip_Sf_C" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, ABISELECT(8, 4));
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(8, 4));
    try testing.expectOk(c.recv_Ip_Sf_C(.{ .v1 = null, .v2 = .{}, .v3 = 118 }));
}
...
test "Ip_Sf_D" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, ABISELECT(8, 4));
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(8, 4));
    try testing.expectOk(c.recv_Ip_Sf_D(.{ .v1 = null, .v2 = .{}, .v3 = 0.779082 }));
}
...
test "Ip_Sf_F" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, ABISELECT(8, 4));
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(8, 4));
    try testing.expectOk(c.recv_Ip_Sf_F(.{ .v1 = null, .v2 = .{}, .v3 = -0.25 }));
}
...
test "Ip_Sf_I" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, ABISELECT(8, 4));
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(8, 4));
    try testing.expectOk(c.recv_Ip_Sf_I(.{ .v1 = null, .v2 = .{}, .v3 = 30120 }));
}
...
test "Ip_Sf_Ip" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, ABISELECT(8, 4));
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(8, 4));
    try testing.expectOk(c.recv_Ip_Sf_Ip(.{ .v1 = null, .v2 = .{}, .v3 = null }));
}
...
test "Ip_Sf_L" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, ABISELECT(8, 4));
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(8, 4));
    try testing.expectOk(c.recv_Ip_Sf_L(.{ .v1 = null, .v2 = .{}, .v3 = 20716 }));
}
...
test "Ip_Sf_S" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, ABISELECT(8, 4));
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(8, 4));
    try testing.expectOk(c.recv_Ip_Sf_S(.{ .v1 = null, .v2 = .{}, .v3 = 8536 }));
}
...
test "Ip_Sf_Sf" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, ABISELECT(8, 4));
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(8, 4));
    try testing.expectOk(c.recv_Ip_Sf_Sf(.{ .v1 = null, .v2 = .{}, .v3 = .{} }));
}
...
test "Ip_Sf_Uc" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, ABISELECT(8, 4));
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(8, 4));
    try testing.expectOk(c.recv_Ip_Sf_Uc(.{ .v1 = null, .v2 = .{}, .v3 = 63 }));
}
...
test "Ip_Sf_Ui" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, ABISELECT(8, 4));
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(8, 4));
    try testing.expectOk(c.recv_Ip_Sf_Ui(.{ .v1 = null, .v2 = .{}, .v3 = 23923 }));
}
...
test "Ip_Sf_Ul" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, ABISELECT(8, 4));
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(8, 4));
    try testing.expectOk(c.recv_Ip_Sf_Ul(.{ .v1 = null, .v2 = .{}, .v3 = 8874 }));
}
...
test "Ip_Sf_Us" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, ABISELECT(8, 4));
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(8, 4));
    try testing.expectOk(c.recv_Ip_Sf_Us(.{ .v1 = null, .v2 = .{}, .v3 = 9079 }));
}
...
test "Ip_Sf_Vp" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, ABISELECT(8, 4));
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(8, 4));
    try testing.expectOk(c.recv_Ip_Sf_Vp(.{ .v1 = null, .v2 = .{}, .v3 = null }));
}
...
test "Ip_Uc_Sf" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, ABISELECT(8, 4));
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(9, 5));
    try testing.expectOk(c.recv_Ip_Uc_Sf(.{ .v1 = null, .v2 = 83, .v3 = .{} }));
}
...
test "Ip_Ui_Sf" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, ABISELECT(8, 4));
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(12, 8));
    try testing.expectOk(c.recv_Ip_Ui_Sf(.{ .v1 = null, .v2 = 20391, .v3 = .{} }));
}
...
test "Ip_Ul_Sf" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, ABISELECT(8, 4));
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_Ip_Ul_Sf(.{ .v1 = null, .v2 = 27381, .v3 = .{} }));
}
...
test "Ip_Us_Sf" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, ABISELECT(8, 4));
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(10, 6));
    try testing.expectOk(c.recv_Ip_Us_Sf(.{ .v1 = null, .v2 = 21215, .v3 = .{} }));
}
...
test "Ip_Vp_Sf" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, ABISELECT(8, 4));
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 8));
    try testing.expectOk(c.recv_Ip_Vp_Sf(.{ .v1 = null, .v2 = null, .v3 = .{} }));
}
...
test "L_C_Sf" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 9);
    try testing.expectOk(c.recv_L_C_Sf(.{ .v1 = 18919, .v2 = 41, .v3 = .{} }));
}
...
test "L_D_Sf" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 16);
    try testing.expectOk(c.recv_L_D_Sf(.{ .v1 = 802, .v2 = 0.402573, .v3 = .{} }));
}
...
test "L_F_Sf" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 12);
    try testing.expectOk(c.recv_L_F_Sf(.{ .v1 = 21753, .v2 = 4.5, .v3 = .{} }));
}
...
test "L_I_Sf" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 12);
    try testing.expectOk(c.recv_L_I_Sf(.{ .v1 = 2747, .v2 = 9211, .v3 = .{} }));
}
...
test "L_Ip_Sf" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_L_Ip_Sf(.{ .v1 = 16024, .v2 = null, .v3 = .{} }));
}
...
test "L_L_Sf" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 16);
    try testing.expectOk(c.recv_L_L_Sf(.{ .v1 = 13014, .v2 = 744, .v3 = .{} }));
}
...
test "L_S_Sf" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 10);
    try testing.expectOk(c.recv_L_S_Sf(.{ .v1 = 19091, .v2 = 7391, .v3 = .{} }));
}
...
test "L_Sf" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v1, 0);
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectOk(c.recv_L_Sf(.{ .v1 = 28899, .v2 = .{} }));
}
...
test "L_Sf_C" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 8);
    try testing.expectOk(c.recv_L_Sf_C(.{ .v1 = 31651, .v2 = .{}, .v3 = 0 }));
}
...
test "L_Sf_D" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 8);
    try testing.expectOk(c.recv_L_Sf_D(.{ .v1 = 21290, .v2 = .{}, .v3 = 0.534072 }));
}
...
test "L_Sf_F" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 8);
    try testing.expectOk(c.recv_L_Sf_F(.{ .v1 = 32580, .v2 = .{}, .v3 = -2.125 }));
}
...
test "L_Sf_I" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 8);
    try testing.expectOk(c.recv_L_Sf_I(.{ .v1 = 12214, .v2 = .{}, .v3 = 24205 }));
}
...
test "L_Sf_Ip" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 8);
    try testing.expectOk(c.recv_L_Sf_Ip(.{ .v1 = 24226, .v2 = .{}, .v3 = null }));
}
...
test "L_Sf_L" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 8);
    try testing.expectOk(c.recv_L_Sf_L(.{ .v1 = 32652, .v2 = .{}, .v3 = 3015 }));
}
...
test "L_Sf_S" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 8);
    try testing.expectOk(c.recv_L_Sf_S(.{ .v1 = 3737, .v2 = .{}, .v3 = 271 }));
}
...
test "L_Sf_Sf" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 8);
    try testing.expectOk(c.recv_L_Sf_Sf(.{ .v1 = 11079, .v2 = .{}, .v3 = .{} }));
}
...
test "L_Sf_Uc" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 8);
    try testing.expectOk(c.recv_L_Sf_Uc(.{ .v1 = 2888, .v2 = .{}, .v3 = 87 }));
}
...
test "L_Sf_Ui" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 8);
    try testing.expectOk(c.recv_L_Sf_Ui(.{ .v1 = 9544, .v2 = .{}, .v3 = 13995 }));
}
...
test "L_Sf_Ul" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 8);
    try testing.expectOk(c.recv_L_Sf_Ul(.{ .v1 = 15682, .v2 = .{}, .v3 = 27996 }));
}
...
test "L_Sf_Us" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 8);
    try testing.expectOk(c.recv_L_Sf_Us(.{ .v1 = 32055, .v2 = .{}, .v3 = 19892 }));
}
...
test "L_Sf_Vp" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 8);
    try testing.expectOk(c.recv_L_Sf_Vp(.{ .v1 = 29020, .v2 = .{}, .v3 = null }));
}
...
test "L_Uc_Sf" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 9);
    try testing.expectOk(c.recv_L_Uc_Sf(.{ .v1 = 2120, .v2 = 80, .v3 = .{} }));
}
...
test "L_Ui_Sf" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 12);
    try testing.expectOk(c.recv_L_Ui_Sf(.{ .v1 = 10030, .v2 = 29018, .v3 = .{} }));
}
...
test "L_Ul_Sf" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 16);
    try testing.expectOk(c.recv_L_Ul_Sf(.{ .v1 = 25686, .v2 = 21775, .v3 = .{} }));
}
...
test "L_Us_Sf" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, 10);
    try testing.expectOk(c.recv_L_Us_Sf(.{ .v1 = 1781, .v2 = 32501, .v3 = .{} }));
}
...
test "L_Vp_Sf" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 8);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_L_Vp_Sf(.{ .v1 = 12990, .v2 = null, .v3 = .{} }));
}
...
test "S_C_Sf" {
    ...
    try testing.expectOk(c.recv_S_C_Sf(.{ .v1 = 32241, .v2 = 46, .v3 = .{} }));
}
...
test "S_D_Sf" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, ABISELECT(8, 4));
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_S_D_Sf(.{ .v1 = 3514, .v2 = 0.543337, .v3 = .{} }));
}
...
test "S_F_Sf" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 4);
    try testing.expectFieldOffset(&lv, &lv.v3, 8);
    try testing.expectOk(c.recv_S_F_Sf(.{ .v1 = 2718, .v2 = 4.5, .v3 = .{} }));
}
...
test "S_I_Sf" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 4);
    try testing.expectFieldOffset(&lv, &lv.v3, 8);
    try testing.expectOk(c.recv_S_I_Sf(.{ .v1 = 27435, .v2 = 20889, .v3 = .{} }));
}
...
test "S_Ip_Sf" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, ABISELECT(8, 4));
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 8));
    try testing.expectOk(c.recv_S_Ip_Sf(.{ .v1 = 19504, .v2 = null, .v3 = .{} }));
}
...
test "S_L_Sf" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, ABISELECT(8, 4));
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_S_L_Sf(.{ .v1 = 4719, .v2 = 9687, .v3 = .{} }));
}
...
test "S_S_Sf" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 2);
    try testing.expectFieldOffset(&lv, &lv.v3, 4);
    try testing.expectOk(c.recv_S_S_Sf(.{ .v1 = 18705, .v2 = 28798, .v3 = .{} }));
}
...
test "S_Sf" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v1, 0);
    try testing.expectFieldOffset(&lv, &lv.v2, 2);
    try testing.expectOk(c.recv_S_Sf(.{ .v1 = 27824, .v2 = .{} }));
}
...
test "S_Sf_C" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 2);
    try testing.expectFieldOffset(&lv, &lv.v3, 2);
    try testing.expectOk(c.recv_S_Sf_C(.{ .v1 = 9398, .v2 = .{}, .v3 = 48 }));
}
...
test "S_Sf_D" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 2);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(8, 4));
    try testing.expectOk(c.recv_S_Sf_D(.{ .v1 = 21401, .v2 = .{}, .v3 = 0.122784 }));
}
...
test "S_Sf_F" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 2);
    try testing.expectFieldOffset(&lv, &lv.v3, 4);
    try testing.expectOk(c.recv_S_Sf_F(.{ .v1 = 16218, .v2 = .{}, .v3 = -0.25 }));
}
...
test "S_Sf_I" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 2);
    try testing.expectFieldOffset(&lv, &lv.v3, 4);
    try testing.expectOk(c.recv_S_Sf_I(.{ .v1 = 29562, .v2 = .{}, .v3 = 11826 }));
}
...
test "S_Sf_Ip" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 2);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(8, 4));
    try testing.expectOk(c.recv_S_Sf_Ip(.{ .v1 = 23539, .v2 = .{}, .v3 = null }));
}
...
test "S_Sf_L" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 2);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(8, 4));
    try testing.expectOk(c.recv_S_Sf_L(.{ .v1 = 27926, .v2 = .{}, .v3 = 27509 }));
}
...
test "S_Sf_S" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 2);
    try testing.expectFieldOffset(&lv, &lv.v3, 2);
    try testing.expectOk(c.recv_S_Sf_S(.{ .v1 = 11771, .v2 = .{}, .v3 = 4475 }));
}
...
test "S_Sf_Sf" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 2);
    try testing.expectFieldOffset(&lv, &lv.v3, 2);
    try testing.expectOk(c.recv_S_Sf_Sf(.{ .v1 = 379, .v2 = .{}, .v3 = .{} }));
}
...
test "S_Sf_Uc" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 2);
    try testing.expectFieldOffset(&lv, &lv.v3, 2);
    try testing.expectOk(c.recv_S_Sf_Uc(.{ .v1 = 17717, .v2 = .{}, .v3 = 122 }));
}
...
test "S_Sf_Ui" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 2);
    try testing.expectFieldOffset(&lv, &lv.v3, 4);
    try testing.expectOk(c.recv_S_Sf_Ui(.{ .v1 = 7976, .v2 = .{}, .v3 = 22498 }));
}
...
test "S_Sf_Ul" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 2);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(8, 4));
    try testing.expectOk(c.recv_S_Sf_Ul(.{ .v1 = 25701, .v2 = .{}, .v3 = 3715 }));
}
...
test "S_Sf_Us" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 2);
    try testing.expectFieldOffset(&lv, &lv.v3, 2);
    try testing.expectOk(c.recv_S_Sf_Us(.{ .v1 = 24018, .v2 = .{}, .v3 = 16059 }));
}
...
test "S_Sf_Vp" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 2);
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(8, 4));
    try testing.expectOk(c.recv_S_Sf_Vp(.{ .v1 = 18536, .v2 = .{}, .v3 = null }));
}
...
test "S_Uc_Sf" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 2);
    try testing.expectFieldOffset(&lv, &lv.v3, 3);
    try testing.expectOk(c.recv_S_Uc_Sf(.{ .v1 = 21409, .v2 = 76, .v3 = .{} }));
}
...
test "S_Ui_Sf" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 4);
    try testing.expectFieldOffset(&lv, &lv.v3, 8);
    try testing.expectOk(c.recv_S_Ui_Sf(.{ .v1 = 14752, .v2 = 12866, .v3 = .{} }));
}
...
test "S_Ul_Sf" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, ABISELECT(8, 4));
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 12));
    try testing.expectOk(c.recv_S_Ul_Sf(.{ .v1 = 408, .v2 = 2724, .v3 = .{} }));
}
...
test "S_Us_Sf" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, 2);
    try testing.expectFieldOffset(&lv, &lv.v3, 4);
    try testing.expectOk(c.recv_S_Us_Sf(.{ .v1 = 7348, .v2 = 12573, .v3 = .{} }));
}
...
test "S_Vp_Sf" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v2, ABISELECT(8, 4));
    try testing.expectFieldOffset(&lv, &lv.v3, ABISELECT(16, 8));
    try testing.expectOk(c.recv_S_Vp_Sf(.{ .v1 = 14709, .v2 = null, .v3 = .{} }));
}
...
test "Sf" {
    ...
    try testing.expectFieldOffset(&lv, &lv.v1, 0);
    try testing.expectOk(c.recv_Sf(.{ .v1 = .{} }));
}
