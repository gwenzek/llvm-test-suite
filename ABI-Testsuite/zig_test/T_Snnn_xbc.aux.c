...
int recv_Vp_D(struct Vp_D lv){
  int err = 0;
  if (lv.v1 != 0) err = 1;
  if (lv.v2 != 18145) err = 2;
  return err;
}
int recv_Vp_D_C(struct Vp_D_C lv){
  int err = 0;
  if (lv.v1 != 0) err = 1;
  if (lv.v2 != 14011) err = 2;
  if (lv.v3 != 3) err = 3;
  return err;
}
int recv_Vp_D_D(struct Vp_D_D lv){
  ...
  if (lv.v1 != 0) err = 1;
  if (lv.v2 != 5585) err = 2;
  if (lv.v3 != 22732) err = 3;
  return err;
}
int recv_Vp_D_F(struct Vp_D_F lv){
  int err = 0;
  if (lv.v1 != 0) err = 1;
  if (lv.v2 != 10230) err = 2;
  if (lv.v3 != 0.336638) err = 3;
  return err;
}
...
int recv_Vp_D_Ul(struct Vp_D_Ul lv){
  int err = 0;
  if (lv.v1 != 0) err = 1;
  if (lv.v2 != 18055) err = 2;
  if (lv.v3 != 15147) err = 3;
  return err;
}
int recv_Vp_D_Us(struct Vp_D_Us lv){
  int err = 0;
  if (lv.v1 != 0) err = 1;
  if (lv.v2 != 28989) err = 2;
...
int recv_Vp_F(struct Vp_F lv){
  int err = 0;
  if (lv.v1 != 0) err = 1;
  if (lv.v2 != 0.533414) err = 2;
  return err;
}
int recv_Vp_F_C(struct Vp_F_C lv){
  int err = 0;
  if (lv.v1 != 0) err = 1;
  if (lv.v2 != 0.011388) err = 2;
  if (lv.v3 != 35) err = 3;
  return err;
}
int recv_Vp_F_D(struct Vp_F_D lv){
  int err = 0;
  if (lv.v1 != 0) err = 1;
  if (lv.v2 != 0.599087) err = 2;
  if (lv.v3 != 11859) err = 3;
  return err;
}
int recv_Vp_F_F(struct Vp_F_F lv){
  int err = 0;
  if (lv.v1 != 0) err = 1;
  if (lv.v2 != 0.805429) err = 2;
  if (lv.v3 != 0.191817) err = 3;
  return err;
}
int recv_Vp_F_I(struct Vp_F_I lv){
  int err = 0;
  if (lv.v1 != 0) err = 1;
  if (lv.v2 != 0.482520) err = 2;
...
int recv_Vp_F_L(struct Vp_F_L lv){
  int err = 0;
  if (lv.v1 != 0) err = 1;
  if (lv.v2 != 0.091348) err = 2;
  if (lv.v3 != 13732) err = 3;
  return err;
}
int recv_Vp_F_S(struct Vp_F_S lv){
  int err = 0;
  if (lv.v1 != 0) err = 1;
  if (lv.v2 != 0.692628) err = 2;
...
int recv_Vp_F_Ul(struct Vp_F_Ul lv){
  int err = 0;
  if (lv.v1 != 0) err = 1;
  if (lv.v2 != 0.158487) err = 2;
  if (lv.v3 != 18628) err = 3;
  return err;
}
int recv_Vp_F_Us(struct Vp_F_Us lv){
  int err = 0;
  if (lv.v1 != 0) err = 1;
  if (lv.v2 != 0.003791) err = 2;
  if (lv.v3 != 6210) err = 3;
  return err;
}
